...
type font_renderer =
  | Bitmap of { fonts : font_set; char_width : int; char_height : int }
  | Freetype of font_set

val create_font_renderer : string option -> int -> font_renderer
(** [create_font_renderer font_path font_size] creates a font renderer. If
    [font_path] is None, uses built-in bitmap font. *)
...
val render_char :
  ...
  int ->
  unit
(** [render_char pixels width height x y char fg_color bg_color char_width
     char_height] renders a character at the given position *)
