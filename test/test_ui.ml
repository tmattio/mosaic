...
let test_padding () =
  let buffer = Render.create 10 5 in
  let element = Ui.hbox ~padding:(Ui.pad ~all:1 ()) [
    Ui.text "Test"
  ] in
  Ui.render buffer element;
  ...
  let buffer = Render.create 10 5 in
  let element = Ui.hbox ~padding:(Ui.pad ~left:2 ~top:1 ()) [
    Ui.text "X"
  ] in
  Ui.render buffer element;
...
let test_borders () =
  let buffer = Render.create 10 5 in
  let element = Ui.hbox ~border:(Ui.border ~style:Solid ()) ~width:10 ~height:5 [
    Ui.text "Hi"
  ] in
  Ui.render buffer element;
...
let test_alignment () =
  ...
  let buffer = Render.create 10 3 in
  let element = Ui.vbox ~align:Center ~width:10 [
    Ui.text "Hi"
  ] in
  Ui.render buffer element;
  ...
  (* Test End alignment *)
  let buffer = Render.create 10 1 in
  let element = Ui.vbox ~align:End ~width:10 [
    Ui.text "End"
  ] in
  Ui.render buffer element;
...
let test_justify () =
  ...
  let element = Ui.vbox ~justify:Center ~height:10 [
    Ui.text "A";
    Ui.text "B"
  ] in
  Ui.render buffer element;
...
let test_expand () =
  ...
  | (ch_a :: _), (ch_b :: _) when Uchar.to_char ch_a = 'A' && Uchar.to_char ch_b = 'B' -> ()
