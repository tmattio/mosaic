...
module Key : sig
  ...
  (** [equal a b] tests structural equality on keys.
      ...
      Unicode normalization is not performed; [U+00E9] (é) and [U+0065 U+0301]
  ...
  type event = {
    ...
    associated_text : string;
        (** UTF-8 encoded text to insert (Kitty protocol). Empty string for
            legacy terminals or non-text keys. *)
