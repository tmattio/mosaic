  ...
  run "Toffee block_padding_border_percentage_fixed_size Test"
    [
      ( "block_block_padding_border_percentage_fixed_size",
        [
          test_case "block_padding_border_percentage_fixed_size (border-box)"
            `Quick test_block_padding_border_percentage_fixed_size_border_box;
          test_case "block_padding_border_percentage_fixed_size (content-box)"
            `Quick test_block_padding_border_percentage_fixed_size_content_box;
        ] );
    ]
