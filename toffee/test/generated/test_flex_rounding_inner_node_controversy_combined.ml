...
let test_rounding_inner_node_controversy_combined_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 640.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 640.0 layout.size.width;
  assert_eq ~msg:"height of node1" 320.0 layout.size.height;
  assert_eq ~msg:"x of node1" 0.0 layout.location.x;
  assert_eq ~msg:"y of node1" 320.0 layout.location.y;
  let layout = Toffee.layout tree node2 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 640.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node3" 640.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 640.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node5" 640.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node6" 640.0 layout.size.width;
  assert_eq ~msg:"height of node6" 320.0 layout.size.height;
  assert_eq ~msg:"x of node6" 0.0 layout.location.x;
  assert_eq ~msg:"y of node6" 640.0 layout.location.y;
  ()
