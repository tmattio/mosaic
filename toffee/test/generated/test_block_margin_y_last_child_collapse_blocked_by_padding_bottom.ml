...
let tests =
  ...
  [
    test_case
      "margin_y_last_child_collapse_blocked_by_padding_bottom (border-box)"
      `Quick
      test_block_margin_y_last_child_collapse_blocked_by_padding_bottom_border_box;
    test_case
      "margin_y_last_child_collapse_blocked_by_padding_bottom (content-box)"
      `Quick
      test_block_margin_y_last_child_collapse_blocked_by_padding_bottom_content_box;
  ]
