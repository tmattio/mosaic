...
let test_grid_align_content_end_negative_space_gap_border_box () =
  ...
  let node1 =
    new_with_children tree
      (Style.make ~display:Style.Display.Grid
         ...
         ~justify_content:Center ~align_content:End
         ~size:
           {
  ...
  assert_eq ~msg:"y of node10" 80.0 (Layout.location layout_result).y;
...
let tests =
  let open Alcotest in
  [
    test_case "align_content_end_negative_space_gap (border-box)" `Quick
      test_grid_align_content_end_negative_space_gap_border_box;
    test_case "align_content_end_negative_space_gap (content-box)" `Quick
      test_grid_align_content_end_negative_space_gap_content_box;
  ]
