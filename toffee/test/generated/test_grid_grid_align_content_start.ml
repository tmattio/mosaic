...
(* Generated test for grid_align_content_start in grid layout *)
...
let test_grid_align_content_start_border_box () =
  (* Setup test helpers *)
...
let test_grid_align_content_start_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_align_content_start Test" [
    "grid_grid_align_content_start", [
      test_case "grid_align_content_start (border-box)" `Quick test_grid_align_content_start_border_box;
      test_case "grid_align_content_start (content-box)" `Quick test_grid_align_content_start_content_box;
    ];
  ]
