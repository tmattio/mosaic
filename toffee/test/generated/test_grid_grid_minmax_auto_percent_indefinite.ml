  ...
  run "Toffee grid_minmax_auto_percent_indefinite Test"
    [
      ( "grid_grid_minmax_auto_percent_indefinite",
        [
          test_case "grid_minmax_auto_percent_indefinite (border-box)" `Quick
            test_grid_minmax_auto_percent_indefinite_border_box;
          test_case "grid_minmax_auto_percent_indefinite (content-box)" `Quick
            test_grid_minmax_auto_percent_indefinite_content_box;
        ] );
    ]
