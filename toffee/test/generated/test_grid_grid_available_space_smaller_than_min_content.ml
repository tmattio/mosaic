...
(* Generated test for grid_available_space_smaller_than_min_content in grid layout *)
...
let test_grid_available_space_smaller_than_min_content_border_box () =
  (* Setup test helpers *)
  ...
  let _ = Toffee.set_node_context tree node0 (MeasureFunction.Fixed {width = 90.0; height = 10.0}) |> Result.get_ok in
...
let test_grid_available_space_smaller_than_min_content_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_available_space_smaller_than_min_content Test" [
    "grid_grid_available_space_smaller_than_min_content", [
      test_case "grid_available_space_smaller_than_min_content (border-box)" `Quick test_grid_available_space_smaller_than_min_content_border_box;
      test_case "grid_available_space_smaller_than_min_content (content-box)" `Quick test_grid_available_space_smaller_than_min_content_content_box;
    ];
  ]
