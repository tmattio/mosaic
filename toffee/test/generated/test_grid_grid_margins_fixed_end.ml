...
let () =
  ...
  run "Toffee grid_margins_fixed_end Test" [
    "grid_grid_margins_fixed_end", [
      test_case "grid_margins_fixed_end (border-box)" `Quick test_grid_margins_fixed_end_border_box;
      test_case "grid_margins_fixed_end (content-box)" `Quick test_grid_margins_fixed_end_content_box;
    ];
  ]
