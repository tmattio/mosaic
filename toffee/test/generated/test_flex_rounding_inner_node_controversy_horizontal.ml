...
let test_flex_rounding_inner_node_controversy_horizontal_border_box () =
  ...
  assert_eq ~msg:"width of node0" 107.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node1" 106.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node1" 10.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node1" 107.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"width of node3" 107.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 10.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node3" 213.0 (Layout.location layout_result).x;
