...
let test_rounding_inner_node_controversy_horizontal_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 320.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 320.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node3" 320.0 layout.size.width;
