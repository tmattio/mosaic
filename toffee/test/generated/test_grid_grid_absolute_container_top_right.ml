...
let test_grid_absolute_container_top_right_border_box () =
  ...
  assert_eq ~msg:"x of node0" 1016.0 layout.location.x;
  ...
  run "Toffee grid_absolute_container_top_right Test"
    [
      ( "grid_grid_absolute_container_top_right",
        [
          test_case "grid_absolute_container_top_right (border-box)" `Quick
            test_grid_absolute_container_top_right_border_box;
          test_case "grid_absolute_container_top_right (content-box)" `Quick
            test_grid_absolute_container_top_right_content_box;
        ] );
    ]
