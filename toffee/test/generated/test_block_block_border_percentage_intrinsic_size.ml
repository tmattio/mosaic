  ...
  run "Toffee block_border_percentage_intrinsic_size Test"
    [
      ( "block_block_border_percentage_intrinsic_size",
        [
          test_case "block_border_percentage_intrinsic_size (border-box)" `Quick
            test_block_border_percentage_intrinsic_size_border_box;
          test_case "block_border_percentage_intrinsic_size (content-box)"
            `Quick test_block_border_percentage_intrinsic_size_content_box;
        ] );
    ]
