...
let test_flex_percentage_flex_basis_cross_max_height_border_box () =
  (* Setup test helpers *)
         ...
         ~max_size:
           {
             ...
             height = Style.Dimension.percent 0.6;
           }
  ...
  assert_eq ~msg:"y of node2" 240.0 (Layout.location layout_result).y;
...
let test_flex_percentage_flex_basis_cross_max_height_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "percentage_flex_basis_cross_max_height (border-box)" `Quick
      test_flex_percentage_flex_basis_cross_max_height_border_box;
    test_case "percentage_flex_basis_cross_max_height (content-box)" `Quick
      test_flex_percentage_flex_basis_cross_max_height_content_box;
  ]
