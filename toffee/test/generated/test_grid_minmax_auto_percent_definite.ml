...
let tests =
  let open Alcotest in
  [
    test_case "minmax_auto_percent_definite (border-box)" `Quick
      test_grid_minmax_auto_percent_definite_border_box;
    test_case "minmax_auto_percent_definite (content-box)" `Quick
      test_grid_minmax_auto_percent_definite_content_box;
  ]
