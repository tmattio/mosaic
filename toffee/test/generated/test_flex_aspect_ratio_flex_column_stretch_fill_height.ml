...
let tests =
  [
    Windtrap.test "aspect_ratio_flex_column_stretch_fill_height (border-box)"
      test_flex_aspect_ratio_flex_column_stretch_fill_height_border_box;
    Windtrap.test "aspect_ratio_flex_column_stretch_fill_height (content-box)"
      test_flex_aspect_ratio_flex_column_stretch_fill_height_content_box;
  ]
