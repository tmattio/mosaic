(* Generated test for grid_span_2_max_content_fit_content_80px_indefinite in grid layout *)
...
let test_grid_span_2_max_content_fit_content_80px_indefinite_border_box
    measure_function () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"width of node2" 80.0 (Layout.size layout_result).width;
...
let test_grid_span_2_max_content_fit_content_80px_indefinite_content_box
    measure_function () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
...
let tests =
  let open Alcotest in
  [
    test_case "span_2_max_content_fit_content_80px_indefinite (border-box)"
      `Quick (fun () ->
        test_grid_span_2_max_content_fit_content_80px_indefinite_border_box
          measure_function ());
    test_case "span_2_max_content_fit_content_80px_indefinite (content-box)"
      `Quick (fun () ->
        test_grid_span_2_max_content_fit_content_80px_indefinite_content_box
          measure_function ());
  ]
