...
let test_block_absolute_layout_percentage_bottom_based_on_parent_height_border_box
        ...
        inset =
          {
            ...
            top = Toffee.Style.Length_percentage_auto.Percent 0.5;
  ...
  assert_eq ~msg:"y of node0" 376.0 layout.location.y;
  ...
  assert_eq ~msg:"y of node1" 366.0 layout.location.y;
  let layout = Toffee.layout tree node2 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 10.0 layout.size.width;
  assert_eq ~msg:"height of node2" 614.0 layout.size.height;
  assert_eq ~msg:"x of node2" 0.0 layout.location.x;
  assert_eq ~msg:"y of node2" 69.0 layout.location.y;
  ()
...
let () =
  let open Alcotest in
  run
    "Toffee block_absolute_layout_percentage_bottom_based_on_parent_height Test"
    [
      ( "block_block_absolute_layout_percentage_bottom_based_on_parent_height",
        [
          test_case
            "block_absolute_layout_percentage_bottom_based_on_parent_height \
             (border-box)"
            `Quick
