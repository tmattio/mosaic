...
(* Generated test for grid_absolute_container_left_right in grid layout *)
...
let test_grid_absolute_container_left_right_border_box () =
  (* Setup test helpers *)
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 173.0 layout.size.width;
...
let test_grid_absolute_container_left_right_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_absolute_container_left_right Test" [
    "grid_grid_absolute_container_left_right", [
      test_case "grid_absolute_container_left_right (border-box)" `Quick test_grid_absolute_container_left_right_border_box;
      test_case "grid_absolute_container_left_right (content-box)" `Quick test_grid_absolute_container_left_right_content_box;
    ];
  ]
