...
let test_grid_absolute_container_left_right_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 1017.0 layout.size.width;
  ...
  run "Toffee grid_absolute_container_left_right Test"
    [
      ( "grid_grid_absolute_container_left_right",
        [
          test_case "grid_absolute_container_left_right (border-box)" `Quick
            test_grid_absolute_container_left_right_border_box;
          test_case "grid_absolute_container_left_right (content-box)" `Quick
            test_grid_absolute_container_left_right_content_box;
        ] );
    ]
