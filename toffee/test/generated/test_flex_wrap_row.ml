...
let test_flex_wrap_row_border_box () =
  ...
  assert_eq ~msg:"width of node0" 31.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node1" 32.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"x of node2" 63.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node2" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node3 |> Result.get_ok in
  assert_eq ~msg:"width of node3" 34.0 (Layout.size layout_result).width;
