...
let test_flex_align_items_center_with_min_height_with_padding_border_border_box
  ...
  assert_eq ~msg:"x of node2" 25.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node4" 15.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node5" 25.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node5" 15.0 (Layout.location layout_result).y;
  ()
...
let test_flex_align_items_center_with_min_height_with_padding_border_content_box
  ...
  (* Verify layout *)
  let layout_result = layout tree node |> Result.get_ok in
  assert_eq ~msg:"width of node" 260.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node" 130.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node" 0.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node0 |> Result.get_ok in
  assert_eq ~msg:"width of node0" 130.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"height of node2" 20.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 25.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node2" 55.0 (Layout.location layout_result).y;
  let layout_result = layout tree node3 |> Result.get_ok in
  assert_eq ~msg:"width of node3" 130.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 130.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node3" 130.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node3" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node4 |> Result.get_ok in
  assert_eq ~msg:"width of node4" 10.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node4" 10.0 (Layout.size layout_result).height;
