...
let test_align_items_center_with_min_height_with_padding_border_border_box () =
  (* Setup test helpers *)
  ...
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Flex; align_items = Some (Toffee.Style.Alignment.Center); align_content = Some (Toffee.Style.Alignment.Flex_start); size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto }; min_size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 100.0 }; padding = { left = Toffee.Style.Length_percentage.Length (8.0); right = Toffee.Style.Length_percentage.Length (8.0); top = Toffee.Style.Length_percentage.Length (8.0); bottom = Toffee.Style.Length_percentage.Length (8.0) }; border = { left = Toffee.Style.Length_percentage.Length (7.0); right = Toffee.Style.Length_percentage.Length (7.0); top = Toffee.Style.Length_percentage.Length (7.0); bottom = Toffee.Style.Length_percentage.Length (7.0) } }) in
  ...
  assert_eq ~msg:"x of node2" 25.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node4" 15.0 layout.location.x;
  ...
  assert_eq ~msg:"y of node5" 15.0 layout.location.y;
  ()



let test_align_items_center_with_min_height_with_padding_border_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Flex; align_items = Some (Toffee.Style.Alignment.Center); align_content = Some (Toffee.Style.Alignment.Flex_start); size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto }; min_size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 100.0 }; padding = { left = Toffee.Style.Length_percentage.Length (8.0); right = Toffee.Style.Length_percentage.Length (8.0); top = Toffee.Style.Length_percentage.Length (8.0); bottom = Toffee.Style.Length_percentage.Length (8.0) }; border = { left = Toffee.Style.Length_percentage.Length (7.0); right = Toffee.Style.Length_percentage.Length (7.0); top = Toffee.Style.Length_percentage.Length (7.0); bottom = Toffee.Style.Length_percentage.Length (7.0) }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
  ...
  let layout = Toffee.layout tree node in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node" 260.0 layout.size.width;
  assert_eq ~msg:"height of node" 130.0 layout.size.height;
  assert_eq ~msg:"x of node" 0.0 layout.location.x;
  assert_eq ~msg:"y of node" 0.0 layout.location.y;
  let layout = Toffee.layout tree node0 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 130.0 layout.size.width;
  assert_eq ~msg:"height of node0" 130.0 layout.size.height;
  assert_eq ~msg:"x of node0" 0.0 layout.location.x;
  assert_eq ~msg:"y of node0" 0.0 layout.location.y;
  let layout = Toffee.layout tree node1 in
  let layout = layout |> Result.get_ok in
  ...
  let layout = Toffee.layout tree node3 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node3" 130.0 layout.size.width;
  assert_eq ~msg:"height of node3" 130.0 layout.size.height;
  assert_eq ~msg:"x of node3" 130.0 layout.location.x;
  assert_eq ~msg:"y of node3" 0.0 layout.location.y;
  let layout = Toffee.layout tree node4 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 10.0 layout.size.width;
...
let () =
  let open Alcotest in
  run "Toffee align_items_center_with_min_height_with_padding_border Test" [
    "flex_align_items_center_with_min_height_with_padding_border", [
      test_case "align_items_center_with_min_height_with_padding_border (border-box)" `Quick test_align_items_center_with_min_height_with_padding_border_border_box;
      test_case "align_items_center_with_min_height_with_padding_border (content-box)" `Quick test_align_items_center_with_min_height_with_padding_border_content_box;
    ];
  ]
