        ...
        border =
          {
            ...
            right = Toffee.Style.Length_percentage.Length 7.0;
            top = Toffee.Style.Length_percentage.Length 7.0;
            bottom = Toffee.Style.Length_percentage.Length 7.0;
          };
      }
  in
  ...
  run "Toffee align_items_center_with_min_height_with_padding_border Test"
    [
      ( "flex_align_items_center_with_min_height_with_padding_border",
        [
          test_case
            "align_items_center_with_min_height_with_padding_border \
             (border-box)"
            `Quick
            test_align_items_center_with_min_height_with_padding_border_border_box;
          test_case
            "align_items_center_with_min_height_with_padding_border \
             (content-box)"
            `Quick
            test_align_items_center_with_min_height_with_padding_border_content_box;
        ] );
    ]
