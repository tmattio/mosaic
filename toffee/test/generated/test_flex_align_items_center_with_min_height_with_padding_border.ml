...
let test_align_items_center_with_min_height_with_padding_border_border_box () =
  ...
  assert_eq ~msg:"height of node" 232.0 layout.size.height;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 116.0 layout.size.width;
  assert_eq ~msg:"height of node0" 116.0 layout.size.height;
  ...
  assert_eq ~msg:"y of node1" 53.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node2" 18.0 layout.location.x;
  assert_eq ~msg:"y of node2" 48.0 layout.location.y;
  let layout = Toffee.layout tree node3 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node3" 116.0 layout.size.width;
  assert_eq ~msg:"height of node3" 116.0 layout.size.height;
  assert_eq ~msg:"x of node3" 0.0 layout.location.x;
  assert_eq ~msg:"y of node3" 116.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node4" 8.0 layout.location.x;
  assert_eq ~msg:"y of node4" 13.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node5" 18.0 layout.location.x;
  assert_eq ~msg:"y of node5" 8.0 layout.location.y;
  ()
