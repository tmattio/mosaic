...
let test_block_absolute_margin_bottom_left_with_inset_border_box () =
  ...
  assert_eq ~msg:"x of node0" 22.0 layout.location.x;
  ...
  run "Toffee block_absolute_margin_bottom_left_with_inset Test"
    [
      ( "block_block_absolute_margin_bottom_left_with_inset",
        [
          test_case "block_absolute_margin_bottom_left_with_inset (border-box)"
            `Quick test_block_absolute_margin_bottom_left_with_inset_border_box;
          test_case "block_absolute_margin_bottom_left_with_inset (content-box)"
            `Quick test_block_absolute_margin_bottom_left_with_inset_content_box;
        ] );
    ]
