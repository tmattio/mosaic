...
let test_flex_aspect_ratio_flex_row_fill_width_flex_border_box () =
  (* Setup test helpers *)
  ...
  let node0 =
    new_with_children tree
      (Style.make ~display:Style.Display.Grid ~align_items:Start
         ~size:
           {
...
let test_flex_aspect_ratio_flex_row_fill_width_flex_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "aspect_ratio_flex_row_fill_width_flex (border-box)" `Quick
      test_flex_aspect_ratio_flex_row_fill_width_flex_border_box;
    test_case "aspect_ratio_flex_row_fill_width_flex (content-box)" `Quick
      test_flex_aspect_ratio_flex_row_fill_width_flex_content_box;
  ]
