...
let test_flex_justify_content_min_width_with_padding_child_width_lower_than_parent_border_box
  ...
  assert_eq ~msg:"width of node3" 199.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 100.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node3" 101.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node3" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node2 |> Result.get_ok in
  assert_eq ~msg:"width of node2" 400.0 (Layout.size layout_result).width;
...
let test_flex_justify_content_min_width_with_padding_child_width_lower_than_parent_content_box
  ...
  assert_eq ~msg:"width of node3" 199.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 100.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node3" 201.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node3" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node2 |> Result.get_ok in
