...
let test_flex_justify_content_min_width_with_padding_child_width_lower_than_parent_border_box
  ...
  assert_eq ~msg:"width of node2" 199.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node2" 100.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 101.0 (Layout.location layout_result).x;
...
let test_flex_justify_content_min_width_with_padding_child_width_lower_than_parent_content_box
  ...
  assert_eq ~msg:"width of node2" 199.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node2" 100.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 201.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node2" 0.0 (Layout.location layout_result).y;
  ()
