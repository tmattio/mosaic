...
let test_grid_percent_items_nested_with_margin_border_box () =
  ...
  assert_eq ~msg:"width of node1" 45.0 (Layout.size layout_result).width;
...
let tests =
  let open Alcotest in
  [
    test_case "percent_items_nested_with_margin (border-box)" `Quick
      test_grid_percent_items_nested_with_margin_border_box;
    test_case "percent_items_nested_with_margin (content-box)" `Quick
      test_grid_percent_items_nested_with_margin_content_box;
  ]
