...
let test_flex_rounding_fractial_input_3_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"height of node1" 64.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"y of node2" 64.0 (Layout.location layout_result).y;
...
let test_flex_rounding_fractial_input_3_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "rounding_fractial_input_3 (border-box)" `Quick
      test_flex_rounding_fractial_input_3_border_box;
    test_case "rounding_fractial_input_3 (content-box)" `Quick
      test_flex_rounding_fractial_input_3_content_box;
  ]
