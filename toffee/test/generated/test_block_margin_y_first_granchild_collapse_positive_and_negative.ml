...
let test_block_margin_y_first_granchild_collapse_positive_and_negative_border_box
  ...
  assert_eq ~msg:"y of node4" 5.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node8" 20.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node9" 0.0 (Layout.location layout_result).y;
