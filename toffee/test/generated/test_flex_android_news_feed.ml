...
let test_android_news_feed_border_box () =
  ...
  assert_eq ~msg:"height of node" 318.0 layout.size.height;
  ...
  assert_eq ~msg:"height of node0" 318.0 layout.size.height;
  ...
  assert_eq ~msg:"height of node1" 318.0 layout.size.height;
  ...
  assert_eq ~msg:"height of node2" 183.0 layout.size.height;
  ...
  assert_eq ~msg:"height of node3" 159.0 layout.size.height;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 1044.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node6" 1008.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node7" 936.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node8" 936.0 layout.size.width;
  ...
  assert_eq ~msg:"height of node9" 135.0 layout.size.height;
  assert_eq ~msg:"x of node9" 0.0 layout.location.x;
  assert_eq ~msg:"y of node9" 183.0 layout.location.y;
  let layout = Toffee.layout tree node10 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node10" 906.0 layout.size.width;
  assert_eq ~msg:"height of node10" 111.0 layout.size.height;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node11" 906.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node13" 870.0 layout.size.width;
  assert_eq ~msg:"height of node13" 39.0 layout.size.height;
  assert_eq ~msg:"x of node13" 0.0 layout.location.x;
  assert_eq ~msg:"y of node13" 72.0 layout.location.y;
  let layout = Toffee.layout tree node14 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node14" 798.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node15" 798.0 layout.size.width;
