...
(* Generated test for block_margin_y_first_granchild_collapse_positive_equal in block layout *)
...
let test_block_margin_y_first_granchild_collapse_positive_equal_border_box () =
  (* Setup test helpers *)
...
let test_block_margin_y_first_granchild_collapse_positive_equal_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee block_margin_y_first_granchild_collapse_positive_equal Test" [
    "block_block_margin_y_first_granchild_collapse_positive_equal", [
      test_case "block_margin_y_first_granchild_collapse_positive_equal (border-box)" `Quick test_block_margin_y_first_granchild_collapse_positive_equal_border_box;
      test_case "block_margin_y_first_granchild_collapse_positive_equal (content-box)" `Quick test_block_margin_y_first_granchild_collapse_positive_equal_content_box;
    ];
  ]
