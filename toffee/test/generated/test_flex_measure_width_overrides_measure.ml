...
let test_measure_width_overrides_measure_border_box () =
  ...
  let _ =
    Toffee.set_node_context tree node0
      (MeasureFunction.Fixed { width = 100.0; height = 10.0 })
    |> Result.get_ok
  in
  ...
  run "Toffee measure_width_overrides_measure Test"
    [
      ( "flex_measure_width_overrides_measure",
        [
          test_case "measure_width_overrides_measure (border-box)" `Quick
            test_measure_width_overrides_measure_border_box;
          test_case "measure_width_overrides_measure (content-box)" `Quick
            test_measure_width_overrides_measure_content_box;
        ] );
    ]
