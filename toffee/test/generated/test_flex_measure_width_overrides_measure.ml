...
(* Generated test for measure_width_overrides_measure in flex layout *)
...
let test_measure_width_overrides_measure_border_box () =
  (* Setup test helpers *)
...
let test_measure_width_overrides_measure_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee measure_width_overrides_measure Test" [
    "flex_measure_width_overrides_measure", [
      test_case "measure_width_overrides_measure (border-box)" `Quick test_measure_width_overrides_measure_border_box;
      test_case "measure_width_overrides_measure (content-box)" `Quick test_measure_width_overrides_measure_content_box;
    ];
  ]
