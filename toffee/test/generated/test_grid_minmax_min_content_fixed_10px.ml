...
let test_grid_minmax_min_content_fixed_10px_border_box measure_function () =
  (* Setup test helpers *)
           ...
           [
             Style.Grid.Template_component.single
               (Style.Grid.Track_sizing_function.minmax
                  ...
                  ~max:(Style.Length_percentage.length 10.0));
           ]
         ~grid_template_rows:
           [
             Style.Grid.Template_component.single
...
let test_grid_minmax_min_content_fixed_10px_content_box measure_function () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "minmax_min_content_fixed_10px (border-box)" `Quick (fun () ->
        test_grid_minmax_min_content_fixed_10px_border_box measure_function ());
    test_case "minmax_min_content_fixed_10px (content-box)" `Quick (fun () ->
        test_grid_minmax_min_content_fixed_10px_content_box measure_function ());
  ]
