           ...
           [
             Style.Grid.Template_component.single
               (Style.Grid.Track_sizing_function.minmax
                  ...
                  ~max:(Style.Compact_length.length 10.0));
           ]
         ~grid_template_rows:
           [
             Style.Grid.Template_component.single
...
let tests =
  let open Alcotest in
  [
    test_case "minmax_min_content_fixed_10px (border-box)" `Quick
      test_grid_minmax_min_content_fixed_10px_border_box;
    test_case "minmax_min_content_fixed_10px (content-box)" `Quick
      test_grid_minmax_min_content_fixed_10px_content_box;
  ]
