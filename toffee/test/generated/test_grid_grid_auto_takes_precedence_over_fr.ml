  ...
  run "Toffee grid_auto_takes_precedence_over_fr Test"
    [
      ( "grid_grid_auto_takes_precedence_over_fr",
        [
          test_case "grid_auto_takes_precedence_over_fr (border-box)" `Quick
            test_grid_auto_takes_precedence_over_fr_border_box;
          test_case "grid_auto_takes_precedence_over_fr (content-box)" `Quick
            test_grid_auto_takes_precedence_over_fr_content_box;
        ] );
    ]
