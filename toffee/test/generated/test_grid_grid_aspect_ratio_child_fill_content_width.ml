...
let test_grid_aspect_ratio_child_fill_content_width_border_box () =
  ...
  in
  let node0 =
    Toffee.new_leaf tree { Toffee.Style.default with aspect_ratio = Some 2.0 }
  in
  let _ =
    Toffee.set_node_context tree node0
      (MeasureFunction.Fixed { width = 40.0; height = 10.0 })
    |> Result.get_ok
  in
  ...
  assert_eq ~msg:"height of node" 524.0 layout.size.height;
  ...
  assert_eq ~msg:"height of node0" 504.0 layout.size.height;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 1008.0 layout.size.width;
  assert_eq ~msg:"height of node1" 20.0 layout.size.height;
  assert_eq ~msg:"x of node1" 0.0 layout.location.x;
  assert_eq ~msg:"y of node1" 504.0 layout.location.y;
  ()
  ...
  run "Toffee grid_aspect_ratio_child_fill_content_width Test"
    [
      ( "grid_grid_aspect_ratio_child_fill_content_width",
        [
          test_case "grid_aspect_ratio_child_fill_content_width (border-box)"
            `Quick test_grid_aspect_ratio_child_fill_content_width_border_box;
          test_case "grid_aspect_ratio_child_fill_content_width (content-box)"
            `Quick test_grid_aspect_ratio_child_fill_content_width_content_box;
        ] );
    ]
