...
let test_flex_wrapped_column_max_height_border_box () =
  ...
  assert_eq ~msg:"width of node" 700.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"x of node0" 250.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node1" 200.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node1" 250.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"x of node2" 420.0 (Layout.location layout_result).x;
