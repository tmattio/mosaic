  ...
  run "Toffee flex_basis_flex_shrink_row Test"
    [
      ( "flex_flex_basis_flex_shrink_row",
        [
          test_case "flex_basis_flex_shrink_row (border-box)" `Quick
            test_flex_basis_flex_shrink_row_border_box;
          test_case "flex_basis_flex_shrink_row (content-box)" `Quick
            test_flex_basis_flex_shrink_row_content_box;
        ] );
    ]
