...
let test_measure_child_constraint_padding_parent_border_box () =
  ...
  let _ = Toffee.set_node_context tree node0 (MeasureFunction.Fixed {width = 1090.0; height = 10.0}) |> Result.get_ok in
...
let () =
  ...
  run "Toffee measure_child_constraint_padding_parent Test" [
    "flex_measure_child_constraint_padding_parent", [
      test_case "measure_child_constraint_padding_parent (border-box)" `Quick test_measure_child_constraint_padding_parent_border_box;
      test_case "measure_child_constraint_padding_parent (content-box)" `Quick test_measure_child_constraint_padding_parent_content_box;
    ];
  ]
