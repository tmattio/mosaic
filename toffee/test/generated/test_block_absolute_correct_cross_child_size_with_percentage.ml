(* Generated test for absolute_correct_cross_child_size_with_percentage in block layout *)
...
let test_block_absolute_correct_cross_child_size_with_percentage_content_box ()
    =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    Windtrap.equal ~msg (Windtrap.Testable.float 0.001) expected actual
