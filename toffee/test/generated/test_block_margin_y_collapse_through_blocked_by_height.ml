...
let tests =
  let open Alcotest in
  [
    test_case "margin_y_collapse_through_blocked_by_height (border-box)" `Quick
      test_block_margin_y_collapse_through_blocked_by_height_border_box;
    test_case "margin_y_collapse_through_blocked_by_height (content-box)" `Quick
      test_block_margin_y_collapse_through_blocked_by_height_content_box;
  ]
