...
let tests =
  let open Alcotest in
  [
    test_case "margin_auto_left_fix_right_child_bigger_than_parent (border-box)"
      `Quick
      test_block_margin_auto_left_fix_right_child_bigger_than_parent_border_box;
    test_case
      "margin_auto_left_fix_right_child_bigger_than_parent (content-box)" `Quick
      test_block_margin_auto_left_fix_right_child_bigger_than_parent_content_box;
  ]
