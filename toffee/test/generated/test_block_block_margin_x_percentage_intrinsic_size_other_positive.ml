...
let test_block_margin_x_percentage_intrinsic_size_other_positive_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 705.0 layout.size.width;
  assert_eq ~msg:"height of node0" 10.0 layout.size.height;
  assert_eq ~msg:"x of node0" 202.0 layout.location.x;
  ...
  run "Toffee block_margin_x_percentage_intrinsic_size_other_positive Test"
    [
      ( "block_block_margin_x_percentage_intrinsic_size_other_positive",
        [
          test_case
            "block_margin_x_percentage_intrinsic_size_other_positive \
             (border-box)"
            `Quick
