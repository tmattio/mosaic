...
let test_grid_align_items_baseline_complex_border_box () =
  ...
  assert_eq ~msg:"y of node10" 95.0 (Layout.location layout_result).y;
  let layout_result = layout tree node11 |> Result.get_ok in
  assert_eq ~msg:"width of node11" 0.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node11" 5.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"width of node12" 20.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node12" 20.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node12" 80.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node12" 80.0 (Layout.location layout_result).y;
  ()
...
let tests =
  let open Alcotest in
  [
    test_case "align_items_baseline_complex (border-box)" `Quick
      test_grid_align_items_baseline_complex_border_box;
    test_case "align_items_baseline_complex (content-box)" `Quick
      test_grid_align_items_baseline_complex_content_box;
  ]
