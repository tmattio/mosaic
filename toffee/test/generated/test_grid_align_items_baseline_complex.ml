...
let test_grid_align_items_baseline_complex_border_box () =
  ...
  assert_eq ~msg:"height of node12" 5.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"width of node11" 20.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"y of node11" 95.0 (Layout.location layout_result).y;
  let layout_result = layout tree node13 |> Result.get_ok in
  assert_eq ~msg:"width of node13" 20.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node13" 20.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node13" 80.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node13" 80.0 (Layout.location layout_result).y;
