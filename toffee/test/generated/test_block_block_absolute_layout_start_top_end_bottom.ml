...
let test_block_absolute_layout_start_top_end_bottom_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 1004.0 layout.size.width;
  assert_eq ~msg:"height of node0" 748.0 layout.size.height;
  ...
  run "Toffee block_absolute_layout_start_top_end_bottom Test"
    [
      ( "block_block_absolute_layout_start_top_end_bottom",
        [
          test_case "block_absolute_layout_start_top_end_bottom (border-box)"
            `Quick test_block_absolute_layout_start_top_end_bottom_border_box;
          test_case "block_absolute_layout_start_top_end_bottom (content-box)"
            `Quick test_block_absolute_layout_start_top_end_bottom_content_box;
        ] );
    ]
