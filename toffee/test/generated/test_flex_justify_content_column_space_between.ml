...
let test_flex_justify_content_column_space_between_border_box () =
  (* Setup test helpers *)
...
let test_flex_justify_content_column_space_between_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "justify_content_column_space_between (border-box)" `Quick
      test_flex_justify_content_column_space_between_border_box;
    test_case "justify_content_column_space_between (content-box)" `Quick
      test_flex_justify_content_column_space_between_content_box;
  ]
