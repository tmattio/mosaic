...
let test_do_not_clamp_height_of_absolute_node_to_height_of_its_overflow_hidden_parent_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with flex_direction = Toffee.Style.Flex.Row; size = { width = Toffee.Style.Dimension.length 50.0; height = Toffee.Style.Dimension.length 50.0 } }) in
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with position = Toffee.Style.Absolute; flex_direction = Toffee.Style.Flex.Column; inset = { left = Toffee.Style.Length_percentage_auto.Length (0.0); right = Toffee.Style.Length_percentage_auto.Length (0.0); top = Toffee.Style.Length_percentage_auto.Length (0.0); bottom = Toffee.Style.Length_percentage_auto.Length (0.0) } }) in
...
let test_do_not_clamp_height_of_absolute_node_to_height_of_its_overflow_hidden_parent_content_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with flex_direction = Toffee.Style.Flex.Row; size = { width = Toffee.Style.Dimension.length 50.0; height = Toffee.Style.Dimension.length 50.0 }; box_sizing = Toffee.Style.Content_box }) in
...
let () =
  let open Alcotest in
  run "Toffee do_not_clamp_height_of_absolute_node_to_height_of_its_overflow_hidden_parent Test" [
    "flex_do_not_clamp_height_of_absolute_node_to_height_of_its_overflow_hidden_parent", [
      test_case "do_not_clamp_height_of_absolute_node_to_height_of_its_overflow_hidden_parent (border-box)" `Quick test_do_not_clamp_height_of_absolute_node_to_height_of_its_overflow_hidden_parent_border_box;
      test_case "do_not_clamp_height_of_absolute_node_to_height_of_its_overflow_hidden_parent (content-box)" `Quick test_do_not_clamp_height_of_absolute_node_to_height_of_its_overflow_hidden_parent_content_box;
    ];
  ]
