...
let test_flex_undefined_width_with_min_max_border_box () =
  (* Setup test helpers *)
...
let test_flex_undefined_width_with_min_max_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "undefined_width_with_min_max (border-box)" `Quick
      test_flex_undefined_width_with_min_max_border_box;
    test_case "undefined_width_with_min_max (content-box)" `Quick
      test_flex_undefined_width_with_min_max_content_box;
  ]
