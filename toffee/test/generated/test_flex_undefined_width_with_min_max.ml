  ...
  run "Toffee undefined_width_with_min_max Test"
    [
      ( "flex_undefined_width_with_min_max",
        [
          test_case "undefined_width_with_min_max (border-box)" `Quick
            test_undefined_width_with_min_max_border_box;
          test_case "undefined_width_with_min_max (content-box)" `Quick
            test_undefined_width_with_min_max_content_box;
        ] );
    ]
