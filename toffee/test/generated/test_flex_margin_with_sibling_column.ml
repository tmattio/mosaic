...
let test_flex_margin_with_sibling_column_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"height of node0" 45.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"height of node1" 45.0 (Layout.size layout_result).height;
...
let test_flex_margin_with_sibling_column_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "margin_with_sibling_column (border-box)" `Quick
      test_flex_margin_with_sibling_column_border_box;
    test_case "margin_with_sibling_column (content-box)" `Quick
      test_flex_margin_with_sibling_column_content_box;
  ]
