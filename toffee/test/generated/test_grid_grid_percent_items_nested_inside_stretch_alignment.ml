...
let test_grid_percent_items_nested_inside_stretch_alignment_border_box () =
  ...
  let node1 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; padding = { left = Toffee.Style.Length_percentage.Length (0.0); right = Toffee.Style.Length_percentage.Length (0.0); top = Toffee.Style.Length_percentage.Percent (0.2); bottom = Toffee.Style.Length_percentage.Length (0.0) } }) in
...
let test_grid_percent_items_nested_inside_stretch_alignment_content_box () =
  ...
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
  let node1 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; padding = { left = Toffee.Style.Length_percentage.Length (0.0); right = Toffee.Style.Length_percentage.Length (0.0); top = Toffee.Style.Length_percentage.Percent (0.2); bottom = Toffee.Style.Length_percentage.Length (0.0) }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node0 node1 |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee grid_percent_items_nested_inside_stretch_alignment Test" [
    "grid_grid_percent_items_nested_inside_stretch_alignment", [
      test_case "grid_percent_items_nested_inside_stretch_alignment (border-box)" `Quick test_grid_percent_items_nested_inside_stretch_alignment_border_box;
      test_case "grid_percent_items_nested_inside_stretch_alignment (content-box)" `Quick test_grid_percent_items_nested_inside_stretch_alignment_content_box;
    ];
  ]
