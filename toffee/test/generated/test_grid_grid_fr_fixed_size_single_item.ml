...
(* Generated test for grid_fr_fixed_size_single_item in grid layout *)
...
let test_grid_fr_fixed_size_single_item_border_box () =
  (* Setup test helpers *)
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (1.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (1.0) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (1.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (1.0) }]; size = { width = Toffee.Style.Dimension.length 200.0; height = Toffee.Style.Dimension.length 200.0 } }) in
  ...
  let node4 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto } }) in
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 60.0 layout.size.width;
  assert_eq ~msg:"height of node2" 40.0 layout.size.height;
  assert_eq ~msg:"x of node2" 140.0 layout.location.x;
  ...
  assert_eq ~msg:"height of node3" 80.0 layout.size.height;
  ...
  assert_eq ~msg:"x of node5" 140.0 layout.location.x;
  ...
  assert_eq ~msg:"height of node7" 80.0 layout.size.height;
  assert_eq ~msg:"x of node7" 40.0 layout.location.x;
  assert_eq ~msg:"y of node7" 120.0 layout.location.y;
  let layout = Toffee.layout tree node8 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node8" 60.0 layout.size.width;
  assert_eq ~msg:"height of node8" 80.0 layout.size.height;
  assert_eq ~msg:"x of node8" 140.0 layout.location.x;
  assert_eq ~msg:"y of node8" 120.0 layout.location.y;
  ()



let test_grid_fr_fixed_size_single_item_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  let _ = Toffee.add_child tree node node3 |> Result.get_ok in
  let node4 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node4 |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee grid_fr_fixed_size_single_item Test" [
    "grid_grid_fr_fixed_size_single_item", [
      test_case "grid_fr_fixed_size_single_item (border-box)" `Quick test_grid_fr_fixed_size_single_item_border_box;
      test_case "grid_fr_fixed_size_single_item (content-box)" `Quick test_grid_fr_fixed_size_single_item_content_box;
    ];
  ]
