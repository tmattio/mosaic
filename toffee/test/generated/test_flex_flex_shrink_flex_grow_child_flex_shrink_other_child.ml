  ...
  run "Toffee flex_shrink_flex_grow_child_flex_shrink_other_child Test"
    [
      ( "flex_flex_shrink_flex_grow_child_flex_shrink_other_child",
        [
          test_case
            "flex_shrink_flex_grow_child_flex_shrink_other_child (border-box)"
            `Quick
            test_flex_shrink_flex_grow_child_flex_shrink_other_child_border_box;
          test_case
            "flex_shrink_flex_grow_child_flex_shrink_other_child (content-box)"
            `Quick
            test_flex_shrink_flex_grow_child_flex_shrink_other_child_content_box;
        ] );
    ]
