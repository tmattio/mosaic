...
let test_flex_align_content_space_around_wrapped_border_box () =
  ...
  let node0 =
    new_with_children tree
      (Style.make ~flex_direction:Style.Flex_direction.Row
         ~flex_wrap:Style.Flex_wrap.Wrap ~align_content:Space_around
         ~size:
           {
  ...
  assert_eq ~msg:"y of node5" 78.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node6" 78.0 (Layout.location layout_result).y;
...
let tests =
  [
    Windtrap.test "align_content_space_around_wrapped (border-box)"
      test_flex_align_content_space_around_wrapped_border_box;
    Windtrap.test "align_content_space_around_wrapped (content-box)"
