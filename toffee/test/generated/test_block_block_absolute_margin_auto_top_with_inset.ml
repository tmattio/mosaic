...
let test_block_absolute_margin_auto_top_with_inset_border_box () =
  ...
  assert_eq ~msg:"y of node0" 700.0 layout.location.y;
  ()
  ...
  run "Toffee block_absolute_margin_auto_top_with_inset Test"
    [
      ( "block_block_absolute_margin_auto_top_with_inset",
        [
          test_case "block_absolute_margin_auto_top_with_inset (border-box)"
            `Quick test_block_absolute_margin_auto_top_with_inset_border_box;
          test_case "block_absolute_margin_auto_top_with_inset (content-box)"
            `Quick test_block_absolute_margin_auto_top_with_inset_content_box;
        ] );
    ]
