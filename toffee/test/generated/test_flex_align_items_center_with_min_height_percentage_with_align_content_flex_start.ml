...
let test_align_items_center_with_min_height_percentage_with_align_content_flex_start_border_box () =
  (* Setup test helpers *)
...
let test_align_items_center_with_min_height_percentage_with_align_content_flex_start_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee align_items_center_with_min_height_percentage_with_align_content_flex_start Test" [
    "flex_align_items_center_with_min_height_percentage_with_align_content_flex_start", [
      test_case "align_items_center_with_min_height_percentage_with_align_content_flex_start (border-box)" `Quick test_align_items_center_with_min_height_percentage_with_align_content_flex_start_border_box;
      test_case "align_items_center_with_min_height_percentage_with_align_content_flex_start (content-box)" `Quick test_align_items_center_with_min_height_percentage_with_align_content_flex_start_content_box;
    ];
  ]
