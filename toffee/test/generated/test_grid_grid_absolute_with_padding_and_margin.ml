...
(* Generated test for grid_absolute_with_padding_and_margin in grid layout *)
...
let test_grid_absolute_with_padding_and_margin_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"x of node0" 178.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node1" 14.0 layout.location.x;
  assert_eq ~msg:"y of node1" 147.0 layout.location.y;
...
let test_grid_absolute_with_padding_and_margin_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_absolute_with_padding_and_margin Test" [
    "grid_grid_absolute_with_padding_and_margin", [
      test_case "grid_absolute_with_padding_and_margin (border-box)" `Quick test_grid_absolute_with_padding_and_margin_border_box;
      test_case "grid_absolute_with_padding_and_margin (content-box)" `Quick test_grid_absolute_with_padding_and_margin_content_box;
    ];
  ]
