...
let test_grid_absolute_with_padding_and_margin_border_box () =
  ...
  assert_eq ~msg:"x of node1" 6.0 layout.location.x;
  assert_eq ~msg:"y of node1" 747.0 layout.location.y;
  ...
  run "Toffee grid_absolute_with_padding_and_margin Test"
    [
      ( "grid_grid_absolute_with_padding_and_margin",
        [
          test_case "grid_absolute_with_padding_and_margin (border-box)" `Quick
            test_grid_absolute_with_padding_and_margin_border_box;
          test_case "grid_absolute_with_padding_and_margin (content-box)" `Quick
            test_grid_absolute_with_padding_and_margin_content_box;
        ] );
    ]
