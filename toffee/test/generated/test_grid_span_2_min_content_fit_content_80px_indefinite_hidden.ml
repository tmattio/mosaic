...
let tests =
  ...
  [
    test_case
      "span_2_min_content_fit_content_80px_indefinite_hidden (border-box)"
      `Quick (fun () ->
        test_grid_span_2_min_content_fit_content_80px_indefinite_hidden_border_box
          measure_function ());
    test_case
      "span_2_min_content_fit_content_80px_indefinite_hidden (content-box)"
      `Quick (fun () ->
        test_grid_span_2_min_content_fit_content_80px_indefinite_hidden_content_box
          measure_function ());
  ]
