  ...
  run "Toffee margin_auto_left_fix_right_child_bigger_than_parent Test"
    [
      ( "flex_margin_auto_left_fix_right_child_bigger_than_parent",
        [
          test_case
            "margin_auto_left_fix_right_child_bigger_than_parent (border-box)"
            `Quick
            test_margin_auto_left_fix_right_child_bigger_than_parent_border_box;
          test_case
            "margin_auto_left_fix_right_child_bigger_than_parent (content-box)"
            `Quick
            test_margin_auto_left_fix_right_child_bigger_than_parent_content_box;
        ] );
    ]
