...
let () =
  ...
  run
    "Toffee \
     block_absolute_margin_auto_left_child_bigger_than_parent_without_inset \
     Test"
    [
        ...
        [
          test_case
            "block_absolute_margin_auto_left_child_bigger_than_parent_without_inset \
             (border-box)"
            `Quick
            test_block_absolute_margin_auto_left_child_bigger_than_parent_without_inset_border_box;
          test_case
            "block_absolute_margin_auto_left_child_bigger_than_parent_without_inset \
             (content-box)"
            `Quick
            test_block_absolute_margin_auto_left_child_bigger_than_parent_without_inset_content_box;
        ] );
    ]
