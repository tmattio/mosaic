...
let test_grid_auto_single_item_fixed_width_border_box () =
  ...
  let node1 = Toffee.new_leaf tree ({ Toffee.Style.default with min_size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto } }) in
...
let test_grid_auto_single_item_fixed_width_content_box () =
  ...
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
  let node1 = Toffee.new_leaf tree ({ Toffee.Style.default with min_size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node1 |> Result.get_ok in
...
let () =
  ...
  run "Toffee grid_auto_single_item_fixed_width Test" [
    "grid_grid_auto_single_item_fixed_width", [
      test_case "grid_auto_single_item_fixed_width (border-box)" `Quick test_grid_auto_single_item_fixed_width_border_box;
      test_case "grid_auto_single_item_fixed_width (content-box)" `Quick test_grid_auto_single_item_fixed_width_content_box;
    ];
  ]
