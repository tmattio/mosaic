...
(* Generated test for align_items_center_with_max_height_with_padding_border in flex layout *)
...
let test_align_items_center_with_max_height_with_padding_border_border_box () =
  ...
  let node2 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 150.0 } }) in
  ...
  let node5 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 150.0 } }) in
  ...
  assert_eq ~msg:"x of node2" 30.0 layout.location.x;
  ...
  assert_eq ~msg:"height of node5" 150.0 layout.size.height;
...
let test_align_items_center_with_max_height_with_padding_border_content_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with flex_direction = Toffee.Style.Flex.Column; box_sizing = Toffee.Style.Content_box }) in
  ...
  let _ = Toffee.add_child tree node0 node1 |> Result.get_ok in
  let node2 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 150.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node0 node2 |> Result.get_ok in
  let node3 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Flex; flex_wrap = Toffee.Style.Flex.Wrap; align_items = Some (Toffee.Style.Alignment.Center); align_content = Some (Toffee.Style.Alignment.Flex_start); size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto }; max_size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 100.0 }; padding = { left = Toffee.Style.Length_percentage.Length (10.0); right = Toffee.Style.Length_percentage.Length (10.0); top = Toffee.Style.Length_percentage.Length (10.0); bottom = Toffee.Style.Length_percentage.Length (10.0) }; border = { left = Toffee.Style.Length_percentage.Length (10.0); right = Toffee.Style.Length_percentage.Length (10.0); top = Toffee.Style.Length_percentage.Length (10.0); bottom = Toffee.Style.Length_percentage.Length (10.0) }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node3 |> Result.get_ok in
  ...
  let _ = Toffee.add_child tree node3 node4 |> Result.get_ok in
  let node5 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 150.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node3 node5 |> Result.get_ok in
  ...
  assert_eq ~msg:"height of node" 280.0 layout.size.height;
  assert_eq ~msg:"x of node" 0.0 layout.location.x;
  assert_eq ~msg:"y of node" 0.0 layout.location.y;
  let layout = Toffee.layout tree node0 in
  let layout = layout |> Result.get_ok in
  ...
  let layout = Toffee.layout tree node3 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node3" 140.0 layout.size.width;
  assert_eq ~msg:"height of node3" 140.0 layout.size.height;
  assert_eq ~msg:"x of node3" 0.0 layout.location.x;
  assert_eq ~msg:"y of node3" 140.0 layout.location.y;
  let layout = Toffee.layout tree node4 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 10.0 layout.size.width;
  assert_eq ~msg:"height of node4" 10.0 layout.size.height;
...
let () =
  ...
  run "Toffee align_items_center_with_max_height_with_padding_border Test" [
    "flex_align_items_center_with_max_height_with_padding_border", [
      test_case "align_items_center_with_max_height_with_padding_border (border-box)" `Quick test_align_items_center_with_max_height_with_padding_border_border_box;
      test_case "align_items_center_with_max_height_with_padding_border (content-box)" `Quick test_align_items_center_with_max_height_with_padding_border_content_box;
    ];
  ]
