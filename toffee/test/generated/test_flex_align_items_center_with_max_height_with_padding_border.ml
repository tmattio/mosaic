...
let test_flex_align_items_center_with_max_height_with_padding_border_border_box
  ...
  assert_eq ~msg:"height of node6" 150.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"y of node4" 100.0 (Layout.location layout_result).y;
...
let test_flex_align_items_center_with_max_height_with_padding_border_content_box
  ...
  assert_eq ~msg:"height of node2" 10.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 20.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node2" 65.0 (Layout.location layout_result).y;
  let layout_result = layout tree node3 |> Result.get_ok in
  assert_eq ~msg:"width of node3" 10.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 150.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node3" 30.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"y of node6" 20.0 (Layout.location layout_result).y;
  let layout_result = layout tree node4 |> Result.get_ok in
  assert_eq ~msg:"width of node4" 140.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node4" 140.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node4" 0.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node4" 140.0 (Layout.location layout_result).y;
  let layout_result = layout tree node0 |> Result.get_ok in
  assert_eq ~msg:"width of node0" 140.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node0" 280.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node0" 0.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node0" 0.0 (Layout.location layout_result).y;
  ()
