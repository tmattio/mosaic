...
let test_grid_auto_fit_definite_percentage_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 730.0; height = Toffee.Style.Dimension.length 300.0 } }) in
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Auto }]; size = { width = Toffee.Style.Dimension.percent 1.0; height = Toffee.Style.Dimension.percent 1.0 }; gap = { width = Toffee.Style.Length_percentage.Length (0.0); height = Toffee.Style.Length_percentage.Length (0.0) }; padding = { left = Toffee.Style.Length_percentage.Length (10.0); right = Toffee.Style.Length_percentage.Length (10.0); top = Toffee.Style.Length_percentage.Length (10.0); bottom = Toffee.Style.Length_percentage.Length (10.0) } }) in
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
  let node1 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block }) in
  let _ = Toffee.add_child tree node0 node1 |> Result.get_ok in
  let node2 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block }) in
  let _ = Toffee.add_child tree node0 node2 |> Result.get_ok in
  let node3 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block }) in
  let _ = Toffee.add_child tree node0 node3 |> Result.get_ok in
  let node4 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block }) in
  let _ = Toffee.add_child tree node0 node4 |> Result.get_ok in
  let node5 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block }) in
  let _ = Toffee.add_child tree node0 node5 |> Result.get_ok in
  let node6 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block }) in
  let _ = Toffee.add_child tree node0 node6 |> Result.get_ok in
  let node7 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block }) in
  let _ = Toffee.add_child tree node0 node7 |> Result.get_ok in
  let node8 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block }) in
...
let test_grid_auto_fit_definite_percentage_content_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 730.0; height = Toffee.Style.Dimension.length 300.0 }; box_sizing = Toffee.Style.Content_box }) in
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Auto }]; size = { width = Toffee.Style.Dimension.percent 1.0; height = Toffee.Style.Dimension.percent 1.0 }; gap = { width = Toffee.Style.Length_percentage.Length (0.0); height = Toffee.Style.Length_percentage.Length (0.0) }; padding = { left = Toffee.Style.Length_percentage.Length (10.0); right = Toffee.Style.Length_percentage.Length (10.0); top = Toffee.Style.Length_percentage.Length (10.0); bottom = Toffee.Style.Length_percentage.Length (10.0) }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
  let node1 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node0 node1 |> Result.get_ok in
  let node2 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node0 node2 |> Result.get_ok in
  let node3 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node0 node3 |> Result.get_ok in
  let node4 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node0 node4 |> Result.get_ok in
  let node5 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node0 node5 |> Result.get_ok in
  let node6 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node0 node6 |> Result.get_ok in
  let node7 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node0 node7 |> Result.get_ok in
  let node8 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node0 node8 |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee grid_auto_fit_definite_percentage Test" [
    "grid_grid_auto_fit_definite_percentage", [
      test_case "grid_auto_fit_definite_percentage (border-box)" `Quick test_grid_auto_fit_definite_percentage_border_box;
      test_case "grid_auto_fit_definite_percentage (content-box)" `Quick test_grid_auto_fit_definite_percentage_content_box;
    ];
  ]
