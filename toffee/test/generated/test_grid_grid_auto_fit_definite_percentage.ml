...
let test_grid_auto_fit_definite_percentage_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 750.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 175.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 175.0 layout.size.width;
  ...
  run "Toffee grid_auto_fit_definite_percentage Test"
    [
      ( "grid_grid_auto_fit_definite_percentage",
        [
          test_case "grid_auto_fit_definite_percentage (border-box)" `Quick
            test_grid_auto_fit_definite_percentage_border_box;
          test_case "grid_auto_fit_definite_percentage (content-box)" `Quick
