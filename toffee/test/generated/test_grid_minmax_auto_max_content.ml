...
let test_grid_minmax_auto_max_content_border_box measure_function () =
  (* Setup test helpers *)
...
let test_grid_minmax_auto_max_content_content_box measure_function () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "minmax_auto_max_content (border-box)" `Quick (fun () ->
        test_grid_minmax_auto_max_content_border_box measure_function ());
    test_case "minmax_auto_max_content (content-box)" `Quick (fun () ->
        test_grid_minmax_auto_max_content_content_box measure_function ());
  ]
