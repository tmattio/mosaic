...
let test_gap_column_gap_child_margins_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 76.0 layout.size.width;
  ...
  assert_eq ~msg:"x of node2" 15.0 layout.location.x;
      ...
      ( "flex_gap_column_gap_child_margins",
        [
          test_case "gap_column_gap_child_margins (border-box)" `Quick
            test_gap_column_gap_child_margins_border_box;
          test_case "gap_column_gap_child_margins (content-box)" `Quick
            test_gap_column_gap_child_margins_content_box;
        ] );
    ]
