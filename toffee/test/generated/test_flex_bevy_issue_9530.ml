...
let test_bevy_issue_9530_border_box () =
  ...
  assert_eq ~msg:"x of node" 354.0 layout.location.x;
  ...
  assert_eq ~msg:"height of node1" 612.0 layout.size.height;
  ...
  assert_eq ~msg:"height of node3" 432.0 layout.size.height;
  ...
  assert_eq ~msg:"y of node4" 542.0 layout.location.y;
  ()
