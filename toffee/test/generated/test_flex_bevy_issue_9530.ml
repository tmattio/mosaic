...
let test_bevy_issue_9530_border_box () =
    ...
    Toffee.new_leaf tree
      {
        ...
        margin =
          {
            left = Toffee.Style.Length_percentage_auto.Length 20.0;
            right = Toffee.Style.Length_percentage_auto.Length 20.0;
            top = Toffee.Style.Length_percentage_auto.Length 20.0;
            bottom = Toffee.Style.Length_percentage_auto.Length 20.0;
          };
        padding =
          {
  ...
  let _ =
    Toffee.set_node_context tree node3
      (MeasureFunction.Fixed { width = 5840.0; height = 10.0 })
    |> Result.get_ok
  in
      ...
      ( "flex_bevy_issue_9530",
        [
          test_case "bevy_issue_9530 (border-box)" `Quick
            test_bevy_issue_9530_border_box;
          test_case "bevy_issue_9530 (content-box)" `Quick
            test_bevy_issue_9530_content_box;
        ] );
    ]
