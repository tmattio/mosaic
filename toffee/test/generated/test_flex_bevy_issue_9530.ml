...
let test_flex_bevy_issue_9530_border_box measure_function () =
  ...
  assert_eq ~msg:"width of node" 300.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"height of node1" 420.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"width of node2" 260.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node3" 220.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 240.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"y of node4" 350.0 (Layout.location layout_result).y;
  ()
...
let test_flex_bevy_issue_9530_content_box measure_function () =
  ...
  assert_eq ~msg:"y of node0" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node1 |> Result.get_ok in
  assert_eq ~msg:"width of node1" 340.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node1" 380.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"y of node3" 90.0 (Layout.location layout_result).y;
  let layout_result = layout tree node4 |> Result.get_ok in
  assert_eq ~msg:"width of node4" 300.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node4" 50.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node4" 20.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node4" 310.0 (Layout.location layout_result).y;
  ()
