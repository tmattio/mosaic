...
let tests =
  let open Alcotest in
  [
    test_case "minmax_column_with_fr_fixed (border-box)" `Quick
      test_grid_minmax_column_with_fr_fixed_border_box;
    test_case "minmax_column_with_fr_fixed (content-box)" `Quick
      test_grid_minmax_column_with_fr_fixed_content_box;
  ]
