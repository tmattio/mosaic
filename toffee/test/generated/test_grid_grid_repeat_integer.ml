  ...
  run "Toffee grid_repeat_integer Test"
    [
      ( "grid_grid_repeat_integer",
        [
          test_case "grid_repeat_integer (border-box)" `Quick
            test_grid_repeat_integer_border_box;
          test_case "grid_repeat_integer (content-box)" `Quick
            test_grid_repeat_integer_content_box;
        ] );
    ]
