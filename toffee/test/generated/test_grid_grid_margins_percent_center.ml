...
let () =
  ...
  run "Toffee grid_margins_percent_center Test" [
    "grid_grid_margins_percent_center", [
      test_case "grid_margins_percent_center (border-box)" `Quick test_grid_margins_percent_center_border_box;
      test_case "grid_margins_percent_center (content-box)" `Quick test_grid_margins_percent_center_content_box;
    ];
  ]
