...
(* Generated test for grid_minmax_min_content_auto in grid layout *)
...
let test_grid_minmax_min_content_auto_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Min_content; max = Toffee.Style.Grid.Auto }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }] }) in
...
let () =
  let open Alcotest in
  run "Toffee grid_minmax_min_content_auto Test" [
    "grid_grid_minmax_min_content_auto", [
      test_case "grid_minmax_min_content_auto (border-box)" `Quick test_grid_minmax_min_content_auto_border_box;
      test_case "grid_minmax_min_content_auto (content-box)" `Quick test_grid_minmax_min_content_auto_content_box;
    ];
  ]
