...
let tests =
  let open Alcotest in
  [
    test_case "margin_y_first_child_collapse_positive_and_negative (border-box)"
      `Quick
      test_block_margin_y_first_child_collapse_positive_and_negative_border_box;
    test_case
      "margin_y_first_child_collapse_positive_and_negative (content-box)" `Quick
      test_block_margin_y_first_child_collapse_positive_and_negative_content_box;
  ]
