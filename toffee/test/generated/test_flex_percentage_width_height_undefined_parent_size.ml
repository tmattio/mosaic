...
let test_percentage_width_height_undefined_parent_size_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 504.0 layout.size.width;
      ...
      ( "flex_percentage_width_height_undefined_parent_size",
        [
          test_case "percentage_width_height_undefined_parent_size (border-box)"
            `Quick test_percentage_width_height_undefined_parent_size_border_box;
          test_case
            "percentage_width_height_undefined_parent_size (content-box)" `Quick
            test_percentage_width_height_undefined_parent_size_content_box;
        ] );
    ]
