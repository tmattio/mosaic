...
let test_flex_align_content_stretch_row_with_padding_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"width of node0" 150.0 (Layout.size layout_result).width;
...
let test_flex_align_content_stretch_row_with_padding_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  assert_eq ~msg:"y of node1" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node2 |> Result.get_ok in
  assert_eq ~msg:"width of node2" 70.0 (Layout.size layout_result).width;
  ...
  let layout_result = layout tree node4 |> Result.get_ok in
  assert_eq ~msg:"width of node4" 70.0 (Layout.size layout_result).width;
...
let tests =
  let open Alcotest in
  [
    test_case "align_content_stretch_row_with_padding (border-box)" `Quick
      test_flex_align_content_stretch_row_with_padding_border_box;
    test_case "align_content_stretch_row_with_padding (content-box)" `Quick
      test_flex_align_content_stretch_row_with_padding_content_box;
  ]
