      ...
      ( "flex_align_content_stretch_row_with_padding",
        [
          test_case "align_content_stretch_row_with_padding (border-box)" `Quick
            test_align_content_stretch_row_with_padding_border_box;
          test_case "align_content_stretch_row_with_padding (content-box)"
            `Quick test_align_content_stretch_row_with_padding_content_box;
        ] );
    ]
