...
let test_grid_percent_tracks_indefinite_with_content_underflow_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node6" 30.0 layout.size.width;
  assert_eq ~msg:"height of node6" 60.0 layout.size.height;
  assert_eq ~msg:"x of node6" 30.0 layout.location.x;
...
let test_grid_percent_tracks_indefinite_with_content_underflow_content_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.1); max = Toffee.Style.Grid.Percent (0.1) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.2); max = Toffee.Style.Grid.Percent (0.2) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.3); max = Toffee.Style.Grid.Percent (0.3) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.3); max = Toffee.Style.Grid.Percent (0.3) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.6); max = Toffee.Style.Grid.Percent (0.6) }]; box_sizing = Toffee.Style.Content_box }) in
...
let () =
  ...
  run "Toffee grid_percent_tracks_indefinite_with_content_underflow Test" [
    "grid_grid_percent_tracks_indefinite_with_content_underflow", [
      test_case "grid_percent_tracks_indefinite_with_content_underflow (border-box)" `Quick test_grid_percent_tracks_indefinite_with_content_underflow_border_box;
      test_case "grid_percent_tracks_indefinite_with_content_underflow (content-box)" `Quick test_grid_percent_tracks_indefinite_with_content_underflow_content_box;
    ];
  ]
