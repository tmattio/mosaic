...
let tests =
  let open Alcotest in
  [
    test_case "span_2_min_content_fit_content_80px_indefinite (border-box)"
      `Quick (fun () ->
        test_grid_span_2_min_content_fit_content_80px_indefinite_border_box
          measure_function ());
    test_case "span_2_min_content_fit_content_80px_indefinite (content-box)"
      `Quick (fun () ->
        test_grid_span_2_min_content_fit_content_80px_indefinite_content_box
          measure_function ());
  ]
