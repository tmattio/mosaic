...
(* Generated test for block_margin_y_collapse_through_blocked_by_line_box_with_height_zero in block layout *)
...
let test_block_margin_y_collapse_through_blocked_by_line_box_with_height_zero_border_box () =
  (* Setup test helpers *)
...
let test_block_margin_y_collapse_through_blocked_by_line_box_with_height_zero_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee block_margin_y_collapse_through_blocked_by_line_box_with_height_zero Test" [
    "block_block_margin_y_collapse_through_blocked_by_line_box_with_height_zero", [
      test_case "block_margin_y_collapse_through_blocked_by_line_box_with_height_zero (border-box)" `Quick test_block_margin_y_collapse_through_blocked_by_line_box_with_height_zero_border_box;
      test_case "block_margin_y_collapse_through_blocked_by_line_box_with_height_zero (content-box)" `Quick test_block_margin_y_collapse_through_blocked_by_line_box_with_height_zero_content_box;
    ];
  ]
