...
let test_flex_aspect_ratio_flex_row_fill_max_width_border_box measure_function
    () =
  (* Setup test helpers *)
...
let test_flex_aspect_ratio_flex_row_fill_max_width_content_box measure_function
    () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
...
let tests =
  ...
  [
    test_case "aspect_ratio_flex_row_fill_max_width (border-box)" `Quick
      (fun () ->
        test_flex_aspect_ratio_flex_row_fill_max_width_border_box
          measure_function ());
    test_case "aspect_ratio_flex_row_fill_max_width (content-box)" `Quick
      (fun () ->
        test_flex_aspect_ratio_flex_row_fill_max_width_content_box
          measure_function ());
  ]
