...
(* Generated test for grid_minmax_column_fixed_width_above_range in grid layout *)
...
let test_grid_minmax_column_fixed_width_above_range_border_box () =
  (* Setup test helpers *)
...
let test_grid_minmax_column_fixed_width_above_range_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_minmax_column_fixed_width_above_range Test" [
    "grid_grid_minmax_column_fixed_width_above_range", [
      test_case "grid_minmax_column_fixed_width_above_range (border-box)" `Quick test_grid_minmax_column_fixed_width_above_range_border_box;
      test_case "grid_minmax_column_fixed_width_above_range (content-box)" `Quick test_grid_minmax_column_fixed_width_above_range_content_box;
    ];
  ]
