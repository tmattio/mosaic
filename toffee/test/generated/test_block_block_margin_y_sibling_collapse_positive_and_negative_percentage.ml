...
(* Generated test for block_margin_y_sibling_collapse_positive_and_negative_percentage in block layout *)
...
let test_block_margin_y_sibling_collapse_positive_and_negative_percentage_border_box () =
  (* Setup test helpers *)
  ...
  let node4 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 10.0 }; margin = { left = Toffee.Style.Length_percentage_auto.Length (0.0); right = Toffee.Style.Length_percentage_auto.Length (0.0); top = Toffee.Style.Length_percentage_auto.Percent (0.1); bottom = Toffee.Style.Length_percentage_auto.Percent (-0.1) } }) in
  let _ = Toffee.add_child tree node node4 |> Result.get_ok in
  let node5 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 10.0 }; margin = { left = Toffee.Style.Length_percentage_auto.Length (0.0); right = Toffee.Style.Length_percentage_auto.Length (0.0); top = Toffee.Style.Length_percentage_auto.Percent (0.05); bottom = Toffee.Style.Length_percentage_auto.Percent (-0.05) } }) in
  let _ = Toffee.add_child tree node node5 |> Result.get_ok in
  let node6 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 10.0 }; margin = { left = Toffee.Style.Length_percentage_auto.Length (0.0); right = Toffee.Style.Length_percentage_auto.Length (0.0); top = Toffee.Style.Length_percentage_auto.Percent (0.1); bottom = Toffee.Style.Length_percentage_auto.Percent (0.1) } }) in
  ...
  assert_eq ~msg:"y of node2" 28.0 layout.location.y;
  ...
  assert_eq ~msg:"y of node3" 35.0 layout.location.y;
  ...
  assert_eq ~msg:"y of node5" 53.0 layout.location.y;
  ...
  assert_eq ~msg:"y of node6" 65.0 layout.location.y;
  ()



let test_block_margin_y_sibling_collapse_positive_and_negative_percentage_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee block_margin_y_sibling_collapse_positive_and_negative_percentage Test" [
    "block_block_margin_y_sibling_collapse_positive_and_negative_percentage", [
      test_case "block_margin_y_sibling_collapse_positive_and_negative_percentage (border-box)" `Quick test_block_margin_y_sibling_collapse_positive_and_negative_percentage_border_box;
      test_case "block_margin_y_sibling_collapse_positive_and_negative_percentage (content-box)" `Quick test_block_margin_y_sibling_collapse_positive_and_negative_percentage_content_box;
    ];
  ]
