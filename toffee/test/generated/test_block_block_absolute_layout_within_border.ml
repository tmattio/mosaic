...
let test_block_absolute_layout_within_border_border_box () =
  ...
  assert_eq ~msg:"x of node1" 966.0 layout.location.x;
  assert_eq ~msg:"y of node1" 710.0 layout.location.y;
  ...
  assert_eq ~msg:"y of node2" 2.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node3" 956.0 layout.location.x;
  assert_eq ~msg:"y of node3" 700.0 layout.location.y;
  ()
