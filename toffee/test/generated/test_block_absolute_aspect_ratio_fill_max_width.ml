...
let test_block_absolute_aspect_ratio_fill_max_width_border_box () =
  ...
  let node1 =
    new_leaf tree
      (Style.make ~position:Style.Position.Absolute
         ...
         ~aspect_ratio:0.5 ~box_sizing:Style.Box_sizing.Border_box ())
    |> Result.get_ok
  in
  let _ =
  ...
  assert_eq ~msg:"width of node1" 25.0 (Layout.size layout_result).width;
...
let tests =
  [
    Windtrap.test "absolute_aspect_ratio_fill_max_width (border-box)"
      test_block_absolute_aspect_ratio_fill_max_width_border_box;
    Windtrap.test "absolute_aspect_ratio_fill_max_width (content-box)"
      test_block_absolute_aspect_ratio_fill_max_width_content_box;
  ]
