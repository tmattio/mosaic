...
let test_block_absolute_aspect_ratio_fill_max_width_border_box measure_function
    () =
  (* Setup test helpers *)
...
let test_block_absolute_aspect_ratio_fill_max_width_content_box measure_function
    () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
