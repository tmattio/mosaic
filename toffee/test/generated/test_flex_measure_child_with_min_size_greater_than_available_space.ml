...
(* Generated test for measure_child_with_min_size_greater_than_available_space in flex layout *)
...
let test_measure_child_with_min_size_greater_than_available_space_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Flex; flex_direction = Toffee.Style.Flex.Column; size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto } }) in
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with min_size = { width = Toffee.Style.Dimension.length 200.0; height = Toffee.Style.Dimension.auto } }) in
...
let test_measure_child_with_min_size_greater_than_available_space_content_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Flex; flex_direction = Toffee.Style.Flex.Column; size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto }; box_sizing = Toffee.Style.Content_box }) in
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with min_size = { width = Toffee.Style.Dimension.length 200.0; height = Toffee.Style.Dimension.auto }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.set_node_context tree node0 (MeasureFunction.Fixed {width = 170.0; height = 10.0}) |> Result.get_ok in
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
...
let () =
  ...
  run "Toffee measure_child_with_min_size_greater_than_available_space Test" [
    "flex_measure_child_with_min_size_greater_than_available_space", [
      test_case "measure_child_with_min_size_greater_than_available_space (border-box)" `Quick test_measure_child_with_min_size_greater_than_available_space_border_box;
      test_case "measure_child_with_min_size_greater_than_available_space (content-box)" `Quick test_measure_child_with_min_size_greater_than_available_space_content_box;
    ];
  ]
