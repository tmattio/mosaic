...
let test_grid_span_2_max_content_fit_content_80px_indefinite_hidden_border_box
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 92.0 layout.size.width;
...
let () =
  let open Alcotest in
  run "Toffee grid_span_2_max_content_fit_content_80px_indefinite_hidden Test"
    [
      ( "grid_grid_span_2_max_content_fit_content_80px_indefinite_hidden",
        [
          test_case
            "grid_span_2_max_content_fit_content_80px_indefinite_hidden \
             (border-box)"
            `Quick
