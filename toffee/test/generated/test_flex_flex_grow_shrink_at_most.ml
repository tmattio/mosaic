...
(* Generated test for flex_grow_shrink_at_most in flex layout *)
...
let test_flex_grow_shrink_at_most_border_box () =
  (* Setup test helpers *)
...
let test_flex_grow_shrink_at_most_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee flex_grow_shrink_at_most Test" [
    "flex_flex_grow_shrink_at_most", [
      test_case "flex_grow_shrink_at_most (border-box)" `Quick test_flex_grow_shrink_at_most_border_box;
      test_case "flex_grow_shrink_at_most (content-box)" `Quick test_flex_grow_shrink_at_most_content_box;
    ];
  ]
