  ...
  run "Toffee measure_remeasure_child_after_stretching Test"
    [
      ( "flex_measure_remeasure_child_after_stretching",
        [
          test_case "measure_remeasure_child_after_stretching (border-box)"
            `Quick test_measure_remeasure_child_after_stretching_border_box;
          test_case "measure_remeasure_child_after_stretching (content-box)"
            `Quick test_measure_remeasure_child_after_stretching_content_box;
        ] );
    ]
