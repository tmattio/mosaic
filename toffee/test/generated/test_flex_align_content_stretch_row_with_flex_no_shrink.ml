      ...
      ( "flex_align_content_stretch_row_with_flex_no_shrink",
        [
          test_case "align_content_stretch_row_with_flex_no_shrink (border-box)"
            `Quick test_align_content_stretch_row_with_flex_no_shrink_border_box;
          test_case
            "align_content_stretch_row_with_flex_no_shrink (content-box)" `Quick
            test_align_content_stretch_row_with_flex_no_shrink_content_box;
        ] );
    ]
