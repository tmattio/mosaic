...
let tests =
  [
    Windtrap.test "align_content_stretch_row_with_flex_no_shrink (border-box)"
      test_flex_align_content_stretch_row_with_flex_no_shrink_border_box;
    Windtrap.test "align_content_stretch_row_with_flex_no_shrink (content-box)"
      test_flex_align_content_stretch_row_with_flex_no_shrink_content_box;
  ]
