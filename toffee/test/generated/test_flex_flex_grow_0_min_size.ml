...
let test_flex_grow_0_min_size_border_box () =
    ...
    Toffee.new_leaf tree
      {
        ...
        border =
          {
            left = Toffee.Style.Length_percentage.Length 1.0;
            right = Toffee.Style.Length_percentage.Length 1.0;
            top = Toffee.Style.Length_percentage.Length 1.0;
            bottom = Toffee.Style.Length_percentage.Length 1.0;
          };
      }
  in
  let node0 =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 32.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node3" 27.0 layout.size.width;
  ...
  run "Toffee flex_grow_0_min_size Test"
    [
      ( "flex_flex_grow_0_min_size",
        [
          test_case "flex_grow_0_min_size (border-box)" `Quick
            test_flex_grow_0_min_size_border_box;
          test_case "flex_grow_0_min_size (content-box)" `Quick
