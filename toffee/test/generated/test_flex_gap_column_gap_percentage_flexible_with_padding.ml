...
let test_flex_gap_column_gap_percentage_flexible_with_padding_border_box () =
  ...
  assert_eq ~msg:"width of node1" 21.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node2" 22.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node2" 80.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 39.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node2" 10.0 (Layout.location layout_result).y;
  let layout_result = layout tree node3 |> Result.get_ok in
  assert_eq ~msg:"width of node3" 21.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 80.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node3" 69.0 (Layout.location layout_result).x;
...
let test_flex_gap_column_gap_percentage_flexible_with_padding_content_box () =
  ...
  (* Verify layout *)
  let layout_result = layout tree node1 |> Result.get_ok in
  assert_eq ~msg:"width of node1" 27.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node1" 100.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node1" 10.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node1" 10.0 (Layout.location layout_result).y;
  let layout_result = layout tree node2 |> Result.get_ok in
  assert_eq ~msg:"width of node2" 26.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node2" 100.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 47.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node2" 10.0 (Layout.location layout_result).y;
  let layout_result = layout tree node3 |> Result.get_ok in
  assert_eq ~msg:"width of node3" 27.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 100.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node3" 83.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node3" 10.0 (Layout.location layout_result).y;
  let layout_result = layout tree node0 |> Result.get_ok in
