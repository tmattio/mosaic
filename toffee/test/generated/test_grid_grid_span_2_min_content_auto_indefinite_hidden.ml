(* Generated test for grid_span_2_min_content_auto_indefinite_hidden in grid layout *)
...
let test_grid_span_2_min_content_auto_indefinite_hidden_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 962.0 layout.size.width;
...
let () =
  let open Alcotest in
  run "Toffee grid_span_2_min_content_auto_indefinite_hidden Test"
    [
      ( "grid_grid_span_2_min_content_auto_indefinite_hidden",
        [
          test_case
            "grid_span_2_min_content_auto_indefinite_hidden (border-box)" `Quick
            test_grid_span_2_min_content_auto_indefinite_hidden_border_box;
          test_case
            "grid_span_2_min_content_auto_indefinite_hidden (content-box)"
            `Quick
            test_grid_span_2_min_content_auto_indefinite_hidden_content_box;
        ] );
    ]
