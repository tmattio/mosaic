...
let test_grid_align_content_space_evenly_with_padding_border_border_box () =
  ...
  assert_eq ~msg:"y of node9" 116.0 (Layout.location layout_result).y;
...
let test_grid_align_content_space_evenly_with_padding_border_content_box () =
  ...
  assert_eq ~msg:"height of node3" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node3" 128.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node3" 32.0 (Layout.location layout_result).y;
  let layout_result = layout tree node4 |> Result.get_ok in
  assert_eq ~msg:"width of node4" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node4" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node4" 48.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"height of node9" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node9" 128.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node9" 152.0 (Layout.location layout_result).y;
  let layout_result = layout tree node0 |> Result.get_ok in
...
let tests =
  [
    Windtrap.test "align_content_space_evenly_with_padding_border (border-box)"
      test_grid_align_content_space_evenly_with_padding_border_border_box;
    Windtrap.test "align_content_space_evenly_with_padding_border (content-box)"
