...
let test_grid_fr_span_2_proportion_zero_sum_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (0.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (0.0) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }] }) in
...
let () =
  let open Alcotest in
  run "Toffee grid_fr_span_2_proportion_zero_sum Test" [
    "grid_grid_fr_span_2_proportion_zero_sum", [
      test_case "grid_fr_span_2_proportion_zero_sum (border-box)" `Quick test_grid_fr_span_2_proportion_zero_sum_border_box;
      test_case "grid_fr_span_2_proportion_zero_sum (content-box)" `Quick test_grid_fr_span_2_proportion_zero_sum_content_box;
    ];
  ]
