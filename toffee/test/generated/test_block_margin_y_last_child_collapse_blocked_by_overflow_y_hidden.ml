...
let tests =
  ...
  [
    test_case
      "margin_y_last_child_collapse_blocked_by_overflow_y_hidden (border-box)"
      `Quick
      test_block_margin_y_last_child_collapse_blocked_by_overflow_y_hidden_border_box;
    test_case
      "margin_y_last_child_collapse_blocked_by_overflow_y_hidden (content-box)"
      `Quick
      test_block_margin_y_last_child_collapse_blocked_by_overflow_y_hidden_content_box;
  ]
