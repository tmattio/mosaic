...
let test_grid_fr_single_item_indefinite_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node8" 100.0 layout.size.width;
...
let () =
  let open Alcotest in
  run "Toffee grid_fr_single_item_indefinite Test" [
    "grid_grid_fr_single_item_indefinite", [
      test_case "grid_fr_single_item_indefinite (border-box)" `Quick test_grid_fr_single_item_indefinite_border_box;
      test_case "grid_fr_single_item_indefinite (content-box)" `Quick test_grid_fr_single_item_indefinite_content_box;
    ];
  ]
