...
let () =
  ...
  run "Toffee margin_should_not_be_part_of_max_width Test" [
    "flex_margin_should_not_be_part_of_max_width", [
      test_case "margin_should_not_be_part_of_max_width (border-box)" `Quick test_margin_should_not_be_part_of_max_width_border_box;
      test_case "margin_should_not_be_part_of_max_width (content-box)" `Quick test_margin_should_not_be_part_of_max_width_content_box;
    ];
  ]
