...
let tests =
  let open Alcotest in
  [
    test_case "minmax_auto_min_content (border-box)" `Quick
      test_grid_minmax_auto_min_content_border_box;
    test_case "minmax_auto_min_content (content-box)" `Quick
      test_grid_minmax_auto_min_content_content_box;
  ]
