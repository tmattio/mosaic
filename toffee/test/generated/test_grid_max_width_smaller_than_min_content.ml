...
let test_grid_max_width_smaller_than_min_content_border_box measure_function ()
    =
  (* Setup test helpers *)
...
let test_grid_max_width_smaller_than_min_content_content_box measure_function ()
    =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
...
let tests =
  ...
  [
    test_case "max_width_smaller_than_min_content (border-box)" `Quick
      (fun () ->
        test_grid_max_width_smaller_than_min_content_border_box measure_function
          ());
