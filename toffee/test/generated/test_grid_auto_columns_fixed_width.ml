...
let test_grid_auto_columns_fixed_width_border_box () =
  ...
  let node16 = new_leaf tree Style.default |> Result.get_ok in
  let node0 =
  ...
  assert_eq ~msg:"x of node3" 100.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node3" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node4 |> Result.get_ok in
  assert_eq ~msg:"width of node4" 60.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node4" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node4" 140.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"width of node6" 60.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node6" 60.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node6" 40.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node7" 100.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node7" 40.0 (Layout.location layout_result).y;
  let layout_result = layout tree node8 |> Result.get_ok in
  assert_eq ~msg:"width of node8" 60.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node8" 60.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"width of node10" 60.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"x of node11" 100.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node11" 100.0 (Layout.location layout_result).y;
  let layout_result = layout tree node12 |> Result.get_ok in
  assert_eq ~msg:"width of node12" 60.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node12" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node12" 140.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node12" 100.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"width of node14" 60.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"x of node15" 100.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node15" 140.0 (Layout.location layout_result).y;
  let layout_result = layout tree node16 |> Result.get_ok in
  assert_eq ~msg:"width of node16" 60.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node16" 60.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node16" 140.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node16" 140.0 (Layout.location layout_result).y;
