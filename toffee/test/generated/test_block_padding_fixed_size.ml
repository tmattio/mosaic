...
let test_block_padding_fixed_size_border_box () =
  ...
  assert_eq ~msg:"width of node2" 38.0 (Layout.size layout_result).width;
...
let test_block_padding_fixed_size_content_box () =
  ...
  assert_eq ~msg:"y of node2" 12.0 (Layout.location layout_result).y;
  let layout_result = layout tree node0 |> Result.get_ok in
  assert_eq ~msg:"width of node0" 62.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node0" 58.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node0" 0.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node0" 0.0 (Layout.location layout_result).y;
  ()
