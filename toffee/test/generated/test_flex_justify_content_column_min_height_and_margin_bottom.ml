...
(* Generated test for justify_content_column_min_height_and_margin_bottom in flex layout *)
...
let () =
  ...
  run "Toffee justify_content_column_min_height_and_margin_bottom Test" [
    "flex_justify_content_column_min_height_and_margin_bottom", [
      test_case "justify_content_column_min_height_and_margin_bottom (border-box)" `Quick test_justify_content_column_min_height_and_margin_bottom_border_box;
      test_case "justify_content_column_min_height_and_margin_bottom (content-box)" `Quick test_justify_content_column_min_height_and_margin_bottom_content_box;
    ];
  ]
