...
let tests =
  let open Alcotest in
  [
    test_case "available_space_smaller_than_min_content (border-box)" `Quick
      (fun () ->
        test_grid_available_space_smaller_than_min_content_border_box
          measure_function ());
    test_case "available_space_smaller_than_min_content (content-box)" `Quick
      (fun () ->
