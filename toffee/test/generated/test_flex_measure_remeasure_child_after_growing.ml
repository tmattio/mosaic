...
(* Generated test for measure_remeasure_child_after_growing in flex layout *)
...
let test_measure_remeasure_child_after_growing_border_box () =
  (* Setup test helpers *)
...
let test_measure_remeasure_child_after_growing_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee measure_remeasure_child_after_growing Test" [
    "flex_measure_remeasure_child_after_growing", [
      test_case "measure_remeasure_child_after_growing (border-box)" `Quick test_measure_remeasure_child_after_growing_border_box;
      test_case "measure_remeasure_child_after_growing (content-box)" `Quick test_measure_remeasure_child_after_growing_content_box;
    ];
  ]
