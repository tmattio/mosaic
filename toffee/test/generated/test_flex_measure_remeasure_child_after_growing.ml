...
let test_flex_measure_remeasure_child_after_growing_border_box measure_function
    () =
  (* Setup test helpers *)
...
let test_flex_measure_remeasure_child_after_growing_content_box measure_function
    () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
