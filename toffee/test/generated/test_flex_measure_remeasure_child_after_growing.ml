...
let test_flex_measure_remeasure_child_after_growing_border_box () =
  (* Setup test helpers *)
...
let test_flex_measure_remeasure_child_after_growing_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "measure_remeasure_child_after_growing (border-box)" `Quick
      test_flex_measure_remeasure_child_after_growing_border_box;
    test_case "measure_remeasure_child_after_growing (content-box)" `Quick
      test_flex_measure_remeasure_child_after_growing_content_box;
  ]
