...
let test_flex_align_content_spacebetween_border_box () =
  (* Setup test helpers *)
  ...
  let node0 =
    new_with_children tree
      (Style.make ~flex_direction:Style.Flex_direction.Row
         ...
         ~size:
           {
             width = Style.Dimension.length 130.0;
...
let test_flex_align_content_spacebetween_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "align_content_spacebetween (border-box)" `Quick
      test_flex_align_content_spacebetween_border_box;
    test_case "align_content_spacebetween (content-box)" `Quick
      test_flex_align_content_spacebetween_content_box;
  ]
