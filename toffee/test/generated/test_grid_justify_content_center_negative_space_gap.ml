...
let test_grid_justify_content_center_negative_space_gap_border_box () =
  ...
  assert_eq ~msg:"x of node4" 90.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node7" 90.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node10" 90.0 (Layout.location layout_result).x;
...
let tests =
  let open Alcotest in
  [
    test_case "justify_content_center_negative_space_gap (border-box)" `Quick
      test_grid_justify_content_center_negative_space_gap_border_box;
    test_case "justify_content_center_negative_space_gap (content-box)" `Quick
      test_grid_justify_content_center_negative_space_gap_content_box;
  ]
