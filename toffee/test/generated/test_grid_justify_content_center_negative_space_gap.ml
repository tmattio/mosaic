...
let test_grid_justify_content_center_negative_space_gap_border_box () =
  ...
  assert_eq ~msg:"x of node3" 90.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node4" (-10.0) (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node6" 90.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node9" 90.0 (Layout.location layout_result).x;
