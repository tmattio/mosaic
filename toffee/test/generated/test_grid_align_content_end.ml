...
let test_grid_align_content_end_border_box () =
  ...
  assert_eq ~msg:"y of node0" 80.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node3" 120.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node5" 120.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node6" 160.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node7" 160.0 (Layout.location layout_result).y;
...
let tests =
  ...
  [
    test_case "align_content_end (border-box)" `Quick
      test_grid_align_content_end_border_box;
    test_case "align_content_end (content-box)" `Quick
      test_grid_align_content_end_content_box;
  ]
