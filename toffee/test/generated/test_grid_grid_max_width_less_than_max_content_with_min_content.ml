...
(* Generated test for grid_max_width_less_than_max_content_with_min_content in grid layout *)
...
let test_grid_max_width_less_than_max_content_with_min_content_border_box () =
  (* Setup test helpers *)
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Min_content; max = Toffee.Style.Grid.Min_content }] }) in
...
let test_grid_max_width_less_than_max_content_with_min_content_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Min_content; max = Toffee.Style.Grid.Min_content }]; box_sizing = Toffee.Style.Content_box }) in
...
let () =
  let open Alcotest in
  run "Toffee grid_max_width_less_than_max_content_with_min_content Test" [
    "grid_grid_max_width_less_than_max_content_with_min_content", [
      test_case "grid_max_width_less_than_max_content_with_min_content (border-box)" `Quick test_grid_max_width_less_than_max_content_with_min_content_border_box;
      test_case "grid_max_width_less_than_max_content_with_min_content (content-box)" `Quick test_grid_max_width_less_than_max_content_with_min_content_content_box;
    ];
  ]
