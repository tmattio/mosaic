...
let test_grid_max_width_less_than_max_content_with_min_content_border_box () =
  ...
  assert_eq ~msg:"height of node" 72.0 layout.size.height;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 46.0 layout.size.width;
  ...
  assert_eq ~msg:"height of node1" 72.0 layout.size.height;
  ...
  assert_eq ~msg:"height of node2" 72.0 layout.size.height;
  assert_eq ~msg:"x of node2" 23.0 layout.location.x;
  ...
  run "Toffee grid_max_width_less_than_max_content_with_min_content Test"
    [
      ( "grid_grid_max_width_less_than_max_content_with_min_content",
        [
          test_case
            "grid_max_width_less_than_max_content_with_min_content (border-box)"
            `Quick
            test_grid_max_width_less_than_max_content_with_min_content_border_box;
          test_case
            "grid_max_width_less_than_max_content_with_min_content \
             (content-box)"
            `Quick
            test_grid_max_width_less_than_max_content_with_min_content_content_box;
        ] );
    ]
