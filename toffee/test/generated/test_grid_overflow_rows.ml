...
let test_grid_overflow_rows_border_box () =
  ...
  assert_eq ~msg:"width of node2" 43.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node3" 203.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node3" 43.0 (Layout.location layout_result).x;
...
let tests =
  let open Alcotest in
  [
    test_case "overflow_rows (border-box)" `Quick
      test_grid_overflow_rows_border_box;
    test_case "overflow_rows (content-box)" `Quick
