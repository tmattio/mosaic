...
let test_grid_overflow_rows_border_box measure_function () =
  (* Setup test helpers *)
...
let tests =
  let open Alcotest in
  [
    test_case "overflow_rows (border-box)" `Quick (fun () ->
        test_grid_overflow_rows_border_box measure_function ());
    test_case "overflow_rows (content-box)" `Quick (fun () ->
        test_grid_overflow_rows_content_box measure_function ());
  ]
