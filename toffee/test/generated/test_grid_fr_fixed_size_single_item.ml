...
let test_grid_fr_fixed_size_single_item_border_box () =
  ...
  assert_eq ~msg:"height of node4" 80.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"height of node5" 80.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"height of node6" 80.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node6" 140.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"height of node7" 80.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"height of node8" 80.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node8" 40.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node8" 120.0 (Layout.location layout_result).y;
  let layout_result = layout tree node9 |> Result.get_ok in
  assert_eq ~msg:"width of node9" 60.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node9" 80.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node9" 140.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node9" 120.0 (Layout.location layout_result).y;
...
let tests =
  let open Alcotest in
  [
    test_case "fr_fixed_size_single_item (border-box)" `Quick
      test_grid_fr_fixed_size_single_item_border_box;
    test_case "fr_fixed_size_single_item (content-box)" `Quick
      test_grid_fr_fixed_size_single_item_content_box;
  ]
