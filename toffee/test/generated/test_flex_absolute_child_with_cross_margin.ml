...
let test_flex_absolute_child_with_cross_margin_border_box measure_function () =
    ...
    Toffee.new_leaf tree
      {
        ...
        min_size =
          {
            width = Toffee.Style.Dimension.length 311.0;
            height = Toffee.Style.Dimension.length 0.0;
          };
        max_size =
          {
            width = Toffee.Style.Dimension.length 311.0;
            height = Toffee.Style.Dimension.length 36893500000000000000.0;
          };
      }
  in
  let node0 =
    Toffee.new_leaf tree
      {
        ...
        size =
          {
            width = Toffee.Style.Dimension.length 28.0;
            height = Toffee.Style.Dimension.length 27.0;
          };
      }
  in
        ...
        size =
          {
            ...
            height = Toffee.Style.Dimension.length 15.0;
          };
        margin =
          {
  ...
  in
  let _ =
    Toffee.set_node_context tree node1 (MeasureFunction.Text "\n  ")
    |> Result.get_ok
  in
