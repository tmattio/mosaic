  ...
  run "Toffee block_absolute_minmax_top_left_bottom_right_min_max Test"
    [
      ( "block_block_absolute_minmax_top_left_bottom_right_min_max",
        [
          test_case
            "block_absolute_minmax_top_left_bottom_right_min_max (border-box)"
            `Quick
            test_block_absolute_minmax_top_left_bottom_right_min_max_border_box;
          test_case
            "block_absolute_minmax_top_left_bottom_right_min_max (content-box)"
            `Quick
            test_block_absolute_minmax_top_left_bottom_right_min_max_content_box;
        ] );
    ]
