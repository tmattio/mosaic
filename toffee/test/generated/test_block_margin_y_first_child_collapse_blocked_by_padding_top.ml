...
let test_block_margin_y_first_child_collapse_blocked_by_padding_top_border_box
  ...
  assert_eq ~msg:"height of node1" 21.0 (Layout.size layout_result).height;
...
let tests =
  ...
  [
    test_case
      "margin_y_first_child_collapse_blocked_by_padding_top (border-box)" `Quick
      test_block_margin_y_first_child_collapse_blocked_by_padding_top_border_box;
    test_case
      "margin_y_first_child_collapse_blocked_by_padding_top (content-box)"
      `Quick
      test_block_margin_y_first_child_collapse_blocked_by_padding_top_content_box;
  ]
