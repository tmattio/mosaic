...
let test_flex_percentage_main_max_height_border_box () =
  (* Setup test helpers *)
  ...
  let node3 =
    new_leaf tree
      (Style.make
         ~flex_basis:(Style.Dimension.length 48.0)
         ~max_size:
           {
  ...
  assert_eq ~msg:"height of node1" 151.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"height of node0" 151.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node0" 0.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node0" 0.0 (Layout.location layout_result).y;
  ()

let test_flex_percentage_main_max_height_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "percentage_main_max_height (border-box)" `Quick
      test_flex_percentage_main_max_height_border_box;
    test_case "percentage_main_max_height (content-box)" `Quick
      test_flex_percentage_main_max_height_content_box;
  ]
