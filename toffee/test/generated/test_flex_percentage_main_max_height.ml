...
let test_flex_percentage_main_max_height_border_box () =
  ...
  assert_eq ~msg:"width of node" 71.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node" 151.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"height of node2" 48.0 (Layout.size layout_result).height;
