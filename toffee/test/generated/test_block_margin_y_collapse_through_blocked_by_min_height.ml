...
let test_block_margin_y_collapse_through_blocked_by_min_height_border_box () =
  ...
  let node2 =
    new_leaf tree
      (Style.make ~display:Style.Display.Block
         ~min_size:
           { width = Style.Dimension.auto; height = Style.Dimension.length 1.0 }
         ~margin:
           {
             left = Style.Length_percentage_auto.length 0.0;
             right = Style.Length_percentage_auto.length 0.0;
...
let tests =
  let open Alcotest in
  [
    test_case "margin_y_collapse_through_blocked_by_min_height (border-box)"
      `Quick
      test_block_margin_y_collapse_through_blocked_by_min_height_border_box;
    test_case "margin_y_collapse_through_blocked_by_min_height (content-box)"
      `Quick
      test_block_margin_y_collapse_through_blocked_by_min_height_content_box;
  ]
