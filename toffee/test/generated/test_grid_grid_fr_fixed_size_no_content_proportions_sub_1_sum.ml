...
let test_grid_fr_fixed_size_no_content_proportions_sub_1_sum_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (0.3) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (0.2) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }]; size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto } }) in
...
let () =
  ...
  run "Toffee grid_fr_fixed_size_no_content_proportions_sub_1_sum Test" [
    "grid_grid_fr_fixed_size_no_content_proportions_sub_1_sum", [
      test_case "grid_fr_fixed_size_no_content_proportions_sub_1_sum (border-box)" `Quick test_grid_fr_fixed_size_no_content_proportions_sub_1_sum_border_box;
      test_case "grid_fr_fixed_size_no_content_proportions_sub_1_sum (content-box)" `Quick test_grid_fr_fixed_size_no_content_proportions_sub_1_sum_content_box;
    ];
  ]
