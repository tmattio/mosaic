...
let test_grid_align_items_baseline_double_nested_child_border_box () =
  ...
  assert_eq ~msg:"height of node4" 15.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"y of node3" 65.0 (Layout.location layout_result).y;
...
let tests =
  let open Alcotest in
  [
    test_case "align_items_baseline_double_nested_child (border-box)" `Quick
      test_grid_align_items_baseline_double_nested_child_border_box;
    test_case "align_items_baseline_double_nested_child (content-box)" `Quick
      test_grid_align_items_baseline_double_nested_child_content_box;
  ]
