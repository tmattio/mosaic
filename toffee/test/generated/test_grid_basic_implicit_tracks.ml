...
let test_grid_basic_implicit_tracks_border_box () =
  ...
  assert_eq ~msg:"height of node" 75.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"width of node1" 35.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node1" 35.0 (Layout.size layout_result).height;
...
let tests =
  let open Alcotest in
  [
    test_case "basic_implicit_tracks (border-box)" `Quick
      test_grid_basic_implicit_tracks_border_box;
    test_case "basic_implicit_tracks (content-box)" `Quick
