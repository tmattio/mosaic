...
let test_flex_align_content_space_around_wrapped_negative_space_gap_border_box
    () =
  (* Setup test helpers *)
...
let test_flex_align_content_space_around_wrapped_negative_space_gap_content_box
    () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
