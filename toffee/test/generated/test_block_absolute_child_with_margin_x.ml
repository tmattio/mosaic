(* Generated test for block_absolute_child_with_margin_x in block layout *)
(* Do not edit this file directly. It is generated by gentest.js *)

open Toffee

let test_block_absolute_child_with_margin_x_border_box () =
  (* Setup test helpers *)
         ...
         ~size:
           {
             ...
             height = Style.Dimension.length 9.0;
           }
         ~margin:
           {
             left = Style.Length_percentage_auto.length 7.0;
         ...
         ~margin:
           {
             ...
             right = Style.Length_percentage_auto.length 7.0;
             top = Style.Length_percentage_auto.length 0.0;
             bottom = Style.Length_percentage_auto.length 0.0;
           }
         ~box_sizing:Style.Box_sizing.Border_box ())
         ...
         ~size:
           {
             ...
             height = Style.Dimension.length 37.0;
           }
         ~box_sizing:Style.Box_sizing.Border_box ())
      [| node1; node2; node3 |]
    |> Result.get_ok
  ...
  assert_eq ~msg:"height of node1" 9.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node1" 7.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node1" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node2 |> Result.get_ok in
  assert_eq ~msg:"width of node2" 9.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node2" 9.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"width of node3" 9.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 9.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"height of node0" 37.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node0" 0.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node0" 0.0 (Layout.location layout_result).y;
  ()

let test_block_absolute_child_with_margin_x_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "absolute_child_with_margin_x (border-box)" `Quick
      test_block_absolute_child_with_margin_x_border_box;
    test_case "absolute_child_with_margin_x (content-box)" `Quick
      test_block_absolute_child_with_margin_x_content_box;
  ]
