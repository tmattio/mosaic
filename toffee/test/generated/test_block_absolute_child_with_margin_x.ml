...
let test_block_absolute_child_with_margin_x_border_box () =
  ...
  assert_eq ~msg:"height of node" 37.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"width of node0" 9.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node0" 9.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node0" 7.0 (Layout.location layout_result).x;
