  ...
  run "Toffee absolute_minmax_top_left_bottom_right_min_max Test"
    [
      ( "flex_absolute_minmax_top_left_bottom_right_min_max",
        [
          test_case "absolute_minmax_top_left_bottom_right_min_max (border-box)"
            `Quick test_absolute_minmax_top_left_bottom_right_min_max_border_box;
          test_case
            "absolute_minmax_top_left_bottom_right_min_max (content-box)" `Quick
            test_absolute_minmax_top_left_bottom_right_min_max_content_box;
        ] );
    ]
