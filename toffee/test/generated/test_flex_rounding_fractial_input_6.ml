...
let test_flex_rounding_fractial_input_6_border_box () =
  ...
  assert_eq ~msg:"width of node1" 4.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node5" 2.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node6" 2.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node4" 3.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node4" 20.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node4" 4.0 (Layout.location layout_result).x;
...
let tests =
  [
    Windtrap.test "rounding_fractial_input_6 (border-box)"
      test_flex_rounding_fractial_input_6_border_box;
    Windtrap.test "rounding_fractial_input_6 (content-box)"
