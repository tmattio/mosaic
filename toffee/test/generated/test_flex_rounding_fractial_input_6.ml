...
let test_flex_rounding_fractial_input_6_border_box () =
  ...
  assert_eq ~msg:"width of node0" 4.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node3" 3.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 20.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node3" 4.0 (Layout.location layout_result).x;
