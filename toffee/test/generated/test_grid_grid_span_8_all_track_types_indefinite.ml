...
let test_grid_span_8_all_track_types_indefinite_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node7" 265.0 layout.size.width;
  assert_eq ~msg:"height of node7" 40.0 layout.size.height;
  assert_eq ~msg:"x of node7" 212.0 layout.location.x;
  assert_eq ~msg:"y of node7" 40.0 layout.location.y;
  let layout = Toffee.layout tree node8 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node8" 531.0 layout.size.width;
  assert_eq ~msg:"height of node8" 40.0 layout.size.height;
  assert_eq ~msg:"x of node8" 477.0 layout.location.x;
  ...
  run "Toffee grid_span_8_all_track_types_indefinite Test"
    [
      ( "grid_grid_span_8_all_track_types_indefinite",
        [
          test_case "grid_span_8_all_track_types_indefinite (border-box)" `Quick
            test_grid_span_8_all_track_types_indefinite_border_box;
          test_case "grid_span_8_all_track_types_indefinite (content-box)"
            `Quick test_grid_span_8_all_track_types_indefinite_content_box;
        ] );
    ]
