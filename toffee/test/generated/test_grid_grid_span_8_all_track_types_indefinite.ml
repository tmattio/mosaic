...
let test_grid_span_8_all_track_types_indefinite_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Min_content; max = Toffee.Style.Grid.Min_content }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Max_content; max = Toffee.Style.Grid.Max_content }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Auto }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Auto }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (10.0); max = Toffee.Style.Grid.Length (10.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.2); max = Toffee.Style.Grid.Percent (0.2) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (1.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (2.0) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }] }) in
  let node0 = Toffee.new_leaf tree (Toffee.Style.default) in
  let _ = Toffee.set_node_context tree node0 (MeasureFunction.Fixed {width = 170.0; height = 10.0}) |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee grid_span_8_all_track_types_indefinite Test" [
    "grid_grid_span_8_all_track_types_indefinite", [
      test_case "grid_span_8_all_track_types_indefinite (border-box)" `Quick test_grid_span_8_all_track_types_indefinite_border_box;
      test_case "grid_span_8_all_track_types_indefinite (content-box)" `Quick test_grid_span_8_all_track_types_indefinite_content_box;
    ];
  ]
