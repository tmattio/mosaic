...
let tests =
  ...
  [
    test_case
      "margin_y_first_child_collapse_blocked_by_overflow_y_scroll (border-box)"
      `Quick
      test_block_margin_y_first_child_collapse_blocked_by_overflow_y_scroll_border_box;
    test_case
      "margin_y_first_child_collapse_blocked_by_overflow_y_scroll (content-box)"
      `Quick
      test_block_margin_y_first_child_collapse_blocked_by_overflow_y_scroll_content_box;
  ]
