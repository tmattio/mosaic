...
let test_grid_fit_content_percent_indefinite_argument_border_box
  ...
  let _ =
    set_node_context tree node0 (Some (MeasureFunction.Text "HH​HH​HH"))
    |> Result.get_ok
  in
...
let tests =
  let open Alcotest in
  [
    test_case "fit_content_percent_indefinite_argument (border-box)" `Quick
      (fun () ->
        test_grid_fit_content_percent_indefinite_argument_border_box
          measure_function ());
    test_case "fit_content_percent_indefinite_argument (content-box)" `Quick
      (fun () ->
        test_grid_fit_content_percent_indefinite_argument_content_box
          measure_function ());
  ]
