...
let test_flex_gap_row_gap_align_items_end_border_box () =
  (* Setup test helpers *)
  ...
  let node0 =
    new_with_children tree
      (Style.make ~flex_direction:Style.Flex_direction.Row
         ~flex_wrap:Style.Flex_wrap.Wrap ~align_items:Flex_end
         ~size:
           {
  ...
  assert_eq ~msg:"y of node4" 200.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node5" 200.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node6" 200.0 (Layout.location layout_result).y;
...
let test_flex_gap_row_gap_align_items_end_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "gap_row_gap_align_items_end (border-box)" `Quick
      test_flex_gap_row_gap_align_items_end_border_box;
    test_case "gap_row_gap_align_items_end (content-box)" `Quick
      test_flex_gap_row_gap_align_items_end_content_box;
  ]
