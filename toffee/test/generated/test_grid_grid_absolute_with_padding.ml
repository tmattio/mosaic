...
let test_grid_absolute_with_padding_border_box () =
  ...
  assert_eq ~msg:"x of node0" 180.0 layout.location.x;
  ...
  assert_eq ~msg:"y of node1" 150.0 layout.location.y;
...
let () =
  let open Alcotest in
  run "Toffee grid_absolute_with_padding Test" [
    "grid_grid_absolute_with_padding", [
      test_case "grid_absolute_with_padding (border-box)" `Quick test_grid_absolute_with_padding_border_box;
      test_case "grid_absolute_with_padding (content-box)" `Quick test_grid_absolute_with_padding_content_box;
    ];
  ]
