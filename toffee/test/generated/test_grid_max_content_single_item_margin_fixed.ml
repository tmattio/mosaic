...
let test_grid_max_content_single_item_margin_fixed_border_box measure_function
  ...
  assert_eq ~msg:"x of node2" 110.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node5" 110.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"width of node7" 70.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"x of node8" 110.0 (Layout.location layout_result).x;
