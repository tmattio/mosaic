...
let test_grid_max_content_single_item_margin_fixed_border_box measure_function
  ...
  assert_eq ~msg:"x of node3" 110.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"width of node5" 70.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"x of node6" 110.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"width of node8" 70.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"x of node9" 110.0 (Layout.location layout_result).x;
