...
let test_flex_percentage_flex_basis_cross_min_width_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"height of node2" 300.0 (Layout.size layout_result).height;
...
let test_flex_percentage_flex_basis_cross_min_width_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "percentage_flex_basis_cross_min_width (border-box)" `Quick
      test_flex_percentage_flex_basis_cross_min_width_border_box;
    test_case "percentage_flex_basis_cross_min_width (content-box)" `Quick
      test_flex_percentage_flex_basis_cross_min_width_content_box;
  ]
