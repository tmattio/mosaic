...
let test_block_padding_border_percentage_intrinsic_size_border_box () =
    ...
    Toffee.new_leaf tree
      {
        ...
        padding =
          {
            left = Toffee.Style.Length_percentage.Percent 0.04;
            right = Toffee.Style.Length_percentage.Percent 0.02;
            top = Toffee.Style.Length_percentage.Percent 0.01;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 948.0 layout.size.width;
  ...
  run "Toffee block_padding_border_percentage_intrinsic_size Test"
    [
      ( "block_block_padding_border_percentage_intrinsic_size",
        [
          test_case
            "block_padding_border_percentage_intrinsic_size (border-box)" `Quick
            test_block_padding_border_percentage_intrinsic_size_border_box;
          test_case
            "block_padding_border_percentage_intrinsic_size (content-box)"
            `Quick
