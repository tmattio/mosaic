...
let test_grid_fit_content_percent_definite_argument_border_box measure_function
    () =
  (* Setup test helpers *)
...
let test_grid_fit_content_percent_definite_argument_content_box measure_function
    () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
...
let tests =
  let open Alcotest in
  [
    test_case "fit_content_percent_definite_argument (border-box)" `Quick
      (fun () ->
        test_grid_fit_content_percent_definite_argument_border_box
          measure_function ());
    test_case "fit_content_percent_definite_argument (content-box)" `Quick
      (fun () ->
        test_grid_fit_content_percent_definite_argument_content_box
          measure_function ());
  ]
