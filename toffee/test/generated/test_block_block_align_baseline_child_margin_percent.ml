  ...
  run "Toffee block_align_baseline_child_margin_percent Test"
    [
      ( "block_block_align_baseline_child_margin_percent",
        [
          test_case "block_align_baseline_child_margin_percent (border-box)"
            `Quick test_block_align_baseline_child_margin_percent_border_box;
          test_case "block_align_baseline_child_margin_percent (content-box)"
            `Quick test_block_align_baseline_child_margin_percent_content_box;
        ] );
    ]
