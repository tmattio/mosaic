...
let test_flex_align_baseline_child_margin_percent_border_box () =
  (* Setup test helpers *)
...
let test_flex_align_baseline_child_margin_percent_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "align_baseline_child_margin_percent (border-box)" `Quick
      test_flex_align_baseline_child_margin_percent_border_box;
    test_case "align_baseline_child_margin_percent (content-box)" `Quick
      test_flex_align_baseline_child_margin_percent_content_box;
  ]
