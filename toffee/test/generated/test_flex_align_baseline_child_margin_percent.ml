  ...
  run "Toffee align_baseline_child_margin_percent Test"
    [
      ( "flex_align_baseline_child_margin_percent",
        [
          test_case "align_baseline_child_margin_percent (border-box)" `Quick
            test_align_baseline_child_margin_percent_border_box;
          test_case "align_baseline_child_margin_percent (content-box)" `Quick
            test_align_baseline_child_margin_percent_content_box;
        ] );
    ]
