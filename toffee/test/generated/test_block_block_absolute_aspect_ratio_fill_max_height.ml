...
let test_block_absolute_aspect_ratio_fill_max_height_border_box () =
  ...
  let _ =
    Toffee.set_node_context tree node0
      (MeasureFunction.Text "HHHH​HHHH​HHHH​HHHH​HHHH​HHHH​HHHH​HHHH​HHHH")
    |> Result.get_ok
  in
  ...
  run "Toffee block_absolute_aspect_ratio_fill_max_height Test"
    [
      ( "block_block_absolute_aspect_ratio_fill_max_height",
        [
          test_case "block_absolute_aspect_ratio_fill_max_height (border-box)"
            `Quick test_block_absolute_aspect_ratio_fill_max_height_border_box;
          test_case "block_absolute_aspect_ratio_fill_max_height (content-box)"
            `Quick test_block_absolute_aspect_ratio_fill_max_height_content_box;
        ] );
    ]
