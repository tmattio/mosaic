...
let test_flex_align_baseline_child_multiline_border_box () =
  (* Setup test helpers *)
  ...
  let node =
    new_leaf tree
      (Style.make ~display:Style.Display.Flex ~align_items:Baseline
         ~size:
           {
...
let test_flex_align_baseline_child_multiline_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "align_baseline_child_multiline (border-box)" `Quick
      test_flex_align_baseline_child_multiline_border_box;
    test_case "align_baseline_child_multiline (content-box)" `Quick
      test_flex_align_baseline_child_multiline_content_box;
  ]
