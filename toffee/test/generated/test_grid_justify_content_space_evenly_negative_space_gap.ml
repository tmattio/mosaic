  ...
  let node1 =
    new_with_children tree
      (Style.make ~display:Style.Display.Grid
         ...
         ~justify_content:Space_evenly ~align_content:Center
         ~size:
           {
...
let tests =
  let open Alcotest in
  [
    test_case "justify_content_space_evenly_negative_space_gap (border-box)"
      `Quick
      test_grid_justify_content_space_evenly_negative_space_gap_border_box;
    test_case "justify_content_space_evenly_negative_space_gap (content-box)"
      `Quick
      test_grid_justify_content_space_evenly_negative_space_gap_content_box;
  ]
