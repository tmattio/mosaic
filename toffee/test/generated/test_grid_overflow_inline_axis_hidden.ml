...
let tests =
  let open Alcotest in
  [
    test_case "overflow_inline_axis_hidden (border-box)" `Quick
      test_grid_overflow_inline_axis_hidden_border_box;
    test_case "overflow_inline_axis_hidden (content-box)" `Quick
      test_grid_overflow_inline_axis_hidden_content_box;
  ]
