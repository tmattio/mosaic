...
(* Generated test for grid_fr_span_2_proportion_sub_1_sum in grid layout *)
...
let test_grid_fr_span_2_proportion_sub_1_sum_border_box () =
  (* Setup test helpers *)
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (0.2) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (0.3) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }] }) in
  ...
  assert_eq ~msg:"x of node2" 24.0 layout.location.x;
  assert_eq ~msg:"y of node2" 40.0 layout.location.y;
  ()



let test_grid_fr_span_2_proportion_sub_1_sum_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_fr_span_2_proportion_sub_1_sum Test" [
    "grid_grid_fr_span_2_proportion_sub_1_sum", [
      test_case "grid_fr_span_2_proportion_sub_1_sum (border-box)" `Quick test_grid_fr_span_2_proportion_sub_1_sum_border_box;
      test_case "grid_fr_span_2_proportion_sub_1_sum (content-box)" `Quick test_grid_fr_span_2_proportion_sub_1_sum_content_box;
    ];
  ]
