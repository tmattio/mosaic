...
let test_grid_fr_span_2_proportion_sub_1_sum_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 202.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 302.0 layout.size.width;
  assert_eq ~msg:"height of node2" 40.0 layout.size.height;
  assert_eq ~msg:"x of node2" 202.0 layout.location.x;
  ...
  run "Toffee grid_fr_span_2_proportion_sub_1_sum Test"
    [
      ( "grid_grid_fr_span_2_proportion_sub_1_sum",
        [
          test_case "grid_fr_span_2_proportion_sub_1_sum (border-box)" `Quick
            test_grid_fr_span_2_proportion_sub_1_sum_border_box;
          test_case "grid_fr_span_2_proportion_sub_1_sum (content-box)" `Quick
            test_grid_fr_span_2_proportion_sub_1_sum_content_box;
        ] );
    ]
