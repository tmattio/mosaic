...
let test_grid_max_content_single_item_span_2_gap_percent_indefinite_border_box
  ...
  assert_eq ~msg:"x of node1" 242.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node3" 242.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node4" 443.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node6" 242.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node7" 443.0 layout.location.x;
  ...
  run "Toffee grid_max_content_single_item_span_2_gap_percent_indefinite Test"
    [
      ( "grid_grid_max_content_single_item_span_2_gap_percent_indefinite",
        [
          test_case
            "grid_max_content_single_item_span_2_gap_percent_indefinite \
             (border-box)"
            `Quick
