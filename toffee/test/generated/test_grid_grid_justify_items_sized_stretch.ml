    ...
    Toffee.new_leaf tree
      {
        ...
        justify_items = Some Toffee.Style.Alignment.Stretch;
        size =
          {
  ...
  run "Toffee grid_justify_items_sized_stretch Test"
    [
      ( "grid_grid_justify_items_sized_stretch",
        [
          test_case "grid_justify_items_sized_stretch (border-box)" `Quick
            test_grid_justify_items_sized_stretch_border_box;
          test_case "grid_justify_items_sized_stretch (content-box)" `Quick
