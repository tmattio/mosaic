...
let test_flex_gap_row_gap_column_child_margins_border_box () =
  (* Setup test helpers *)
...
let test_flex_gap_row_gap_column_child_margins_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "gap_row_gap_column_child_margins (border-box)" `Quick
      test_flex_gap_row_gap_column_child_margins_border_box;
    test_case "gap_row_gap_column_child_margins (content-box)" `Quick
      test_flex_gap_row_gap_column_child_margins_content_box;
  ]
