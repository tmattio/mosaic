...
let test_grid_overflow_inline_axis_scroll_border_box measure_function () =
  (* Setup test helpers *)
...
let test_grid_overflow_inline_axis_scroll_content_box measure_function () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "overflow_inline_axis_scroll (border-box)" `Quick (fun () ->
        test_grid_overflow_inline_axis_scroll_border_box measure_function ());
    test_case "overflow_inline_axis_scroll (content-box)" `Quick (fun () ->
        test_grid_overflow_inline_axis_scroll_content_box measure_function ());
  ]
