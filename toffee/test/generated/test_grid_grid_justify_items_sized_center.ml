    ...
    Toffee.new_leaf tree
      {
        ...
        justify_items = Some Toffee.Style.Alignment.Center;
        size =
          {
  ...
  run "Toffee grid_justify_items_sized_center Test"
    [
      ( "grid_grid_justify_items_sized_center",
        [
          test_case "grid_justify_items_sized_center (border-box)" `Quick
            test_grid_justify_items_sized_center_border_box;
          test_case "grid_justify_items_sized_center (content-box)" `Quick
