...
(* Generated test for grid_absolute_container_left_overrides_right in grid layout *)
...
let test_grid_absolute_container_left_overrides_right_border_box () =
  (* Setup test helpers *)
...
let test_grid_absolute_container_left_overrides_right_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_absolute_container_left_overrides_right Test" [
    "grid_grid_absolute_container_left_overrides_right", [
      test_case "grid_absolute_container_left_overrides_right (border-box)" `Quick test_grid_absolute_container_left_overrides_right_border_box;
      test_case "grid_absolute_container_left_overrides_right (content-box)" `Quick test_grid_absolute_container_left_overrides_right_content_box;
    ];
  ]
