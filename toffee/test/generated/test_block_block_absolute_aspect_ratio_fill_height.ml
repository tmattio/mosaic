...
let test_block_absolute_aspect_ratio_fill_height_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 512.0 layout.size.width;
  assert_eq ~msg:"height of node0" 171.0 layout.size.height;
  ...
  run "Toffee block_absolute_aspect_ratio_fill_height Test"
    [
      ( "block_block_absolute_aspect_ratio_fill_height",
        [
          test_case "block_absolute_aspect_ratio_fill_height (border-box)"
            `Quick test_block_absolute_aspect_ratio_fill_height_border_box;
          test_case "block_absolute_aspect_ratio_fill_height (content-box)"
            `Quick test_block_absolute_aspect_ratio_fill_height_content_box;
        ] );
    ]
