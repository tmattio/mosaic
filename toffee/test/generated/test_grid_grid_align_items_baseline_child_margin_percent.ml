    ...
    Toffee.new_leaf tree
      {
        ...
        margin =
          {
            left = Toffee.Style.Length_percentage_auto.Percent 0.01;
            right = Toffee.Style.Length_percentage_auto.Percent 0.01;
            top = Toffee.Style.Length_percentage_auto.Percent 0.01;
            bottom = Toffee.Style.Length_percentage_auto.Percent 0.01;
          };
      }
  in
  ...
  run "Toffee grid_align_items_baseline_child_margin_percent Test"
    [
      ( "grid_grid_align_items_baseline_child_margin_percent",
        [
          test_case
            "grid_align_items_baseline_child_margin_percent (border-box)" `Quick
            test_grid_align_items_baseline_child_margin_percent_border_box;
          test_case
            "grid_align_items_baseline_child_margin_percent (content-box)"
            `Quick
