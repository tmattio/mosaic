...
let tests =
  ...
  [
    test_case
      "margin_y_last_child_collapse_positive_parent_smaller (border-box)" `Quick
      test_block_margin_y_last_child_collapse_positive_parent_smaller_border_box;
    test_case
      "margin_y_last_child_collapse_positive_parent_smaller (content-box)"
      `Quick
      test_block_margin_y_last_child_collapse_positive_parent_smaller_content_box;
  ]
