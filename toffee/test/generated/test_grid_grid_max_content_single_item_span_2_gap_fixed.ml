...
(* Generated test for grid_max_content_single_item_span_2_gap_fixed in grid layout *)
...
let test_grid_max_content_single_item_span_2_gap_fixed_border_box () =
  (* Setup test helpers *)
...
let test_grid_max_content_single_item_span_2_gap_fixed_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_max_content_single_item_span_2_gap_fixed Test" [
    "grid_grid_max_content_single_item_span_2_gap_fixed", [
      test_case "grid_max_content_single_item_span_2_gap_fixed (border-box)" `Quick test_grid_max_content_single_item_span_2_gap_fixed_border_box;
      test_case "grid_max_content_single_item_span_2_gap_fixed (content-box)" `Quick test_grid_max_content_single_item_span_2_gap_fixed_content_box;
    ];
  ]
