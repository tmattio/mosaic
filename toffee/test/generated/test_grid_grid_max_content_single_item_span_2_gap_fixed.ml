...
let test_grid_max_content_single_item_span_2_gap_fixed_border_box () =
  ...
  let _ =
    Toffee.set_node_context tree node1
      (MeasureFunction.Fixed { width = 80.0; height = 10.0 })
    |> Result.get_ok
  in
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 69.0 layout.size.width;
  ...
  assert_eq ~msg:"x of node4" 105.0 layout.location.x;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node6" 25.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node7" 24.0 layout.size.width;
  assert_eq ~msg:"height of node7" 40.0 layout.size.height;
  assert_eq ~msg:"x of node7" 105.0 layout.location.x;
  ...
  run "Toffee grid_max_content_single_item_span_2_gap_fixed Test"
    [
      ( "grid_grid_max_content_single_item_span_2_gap_fixed",
        [
          test_case "grid_max_content_single_item_span_2_gap_fixed (border-box)"
            `Quick test_grid_max_content_single_item_span_2_gap_fixed_border_box;
          test_case
            "grid_max_content_single_item_span_2_gap_fixed (content-box)" `Quick
