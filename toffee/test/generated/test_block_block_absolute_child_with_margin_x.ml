...
let () =
  ...
  run "Toffee block_absolute_child_with_margin_x Test" [
    "block_block_absolute_child_with_margin_x", [
      test_case "block_absolute_child_with_margin_x (border-box)" `Quick test_block_absolute_child_with_margin_x_border_box;
      test_case "block_absolute_child_with_margin_x (content-box)" `Quick test_block_absolute_child_with_margin_x_content_box;
    ];
  ]
