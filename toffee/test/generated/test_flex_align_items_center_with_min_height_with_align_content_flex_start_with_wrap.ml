...
let test_align_items_center_with_min_height_with_align_content_flex_start_with_wrap_border_box () =
  (* Setup test helpers *)
  ...
  let node3 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Flex; flex_wrap = Toffee.Style.Flex.Wrap; align_items = Some (Toffee.Style.Alignment.Center); size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto }; min_size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 100.0 } }) in
  ...
  let node6 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Flex; align_items = Some (Toffee.Style.Alignment.Center); size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto }; min_size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 100.0 } }) in
  let _ = Toffee.add_child tree node node6 |> Result.get_ok in
  let node7 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 } }) in
  let _ = Toffee.add_child tree node6 node7 |> Result.get_ok in
  let node8 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 20.0 } }) in
  let _ = Toffee.add_child tree node6 node8 |> Result.get_ok in
  let node9 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Flex; align_items = Some (Toffee.Style.Alignment.Center); align_content = Some (Toffee.Style.Alignment.Flex_start); size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto }; min_size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 100.0 } }) in
  let _ = Toffee.add_child tree node node9 |> Result.get_ok in
  let node10 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 } }) in
  let _ = Toffee.add_child tree node9 node10 |> Result.get_ok in
  let node11 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 20.0 } }) in
...
let test_align_items_center_with_min_height_with_align_content_flex_start_with_wrap_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  let _ = Toffee.add_child tree node3 node5 |> Result.get_ok in
  let node6 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Flex; align_items = Some (Toffee.Style.Alignment.Center); size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto }; min_size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 100.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node6 |> Result.get_ok in
  let node7 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node6 node7 |> Result.get_ok in
  let node8 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 20.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node6 node8 |> Result.get_ok in
  let node9 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Flex; align_items = Some (Toffee.Style.Alignment.Center); align_content = Some (Toffee.Style.Alignment.Flex_start); size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto }; min_size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 100.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node9 |> Result.get_ok in
  let node10 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node9 node10 |> Result.get_ok in
  let node11 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 20.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node9 node11 |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee align_items_center_with_min_height_with_align_content_flex_start_with_wrap Test" [
    "flex_align_items_center_with_min_height_with_align_content_flex_start_with_wrap", [
      test_case "align_items_center_with_min_height_with_align_content_flex_start_with_wrap (border-box)" `Quick test_align_items_center_with_min_height_with_align_content_flex_start_with_wrap_border_box;
      test_case "align_items_center_with_min_height_with_align_content_flex_start_with_wrap (content-box)" `Quick test_align_items_center_with_min_height_with_align_content_flex_start_with_wrap_content_box;
    ];
  ]
