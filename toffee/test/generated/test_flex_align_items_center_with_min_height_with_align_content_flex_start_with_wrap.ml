...
let test_align_items_center_with_min_height_with_align_content_flex_start_with_wrap_border_box
  ...
  assert_eq ~msg:"y of node6" 200.0 layout.location.y;
  ...
  assert_eq ~msg:"y of node9" 300.0 layout.location.y;
        ...
        [
          test_case
            "align_items_center_with_min_height_with_align_content_flex_start_with_wrap \
             (border-box)"
            `Quick
            test_align_items_center_with_min_height_with_align_content_flex_start_with_wrap_border_box;
          test_case
            "align_items_center_with_min_height_with_align_content_flex_start_with_wrap \
             (content-box)"
            `Quick
            test_align_items_center_with_min_height_with_align_content_flex_start_with_wrap_content_box;
        ] );
    ]
