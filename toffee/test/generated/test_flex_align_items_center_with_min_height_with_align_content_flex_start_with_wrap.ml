...
let test_flex_align_items_center_with_min_height_with_align_content_flex_start_with_wrap_border_box
  ...
  in
  let node0 =
    new_with_children tree Style.default [| node1; node4; node7; node10 |]
    |> Result.get_ok
  in
  ...
  assert_eq ~msg:"y of node8" 45.0 (Layout.location layout_result).y;
  let layout_result = layout tree node9 |> Result.get_ok in
  assert_eq ~msg:"width of node9" 10.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node9" 20.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node9" 10.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"y of node11" 45.0 (Layout.location layout_result).y;
  let layout_result = layout tree node12 |> Result.get_ok in
  assert_eq ~msg:"width of node12" 10.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node12" 20.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node12" 10.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node12" 40.0 (Layout.location layout_result).y;
  let layout_result = layout tree node10 |> Result.get_ok in
  assert_eq ~msg:"width of node10" 100.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node10" 100.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node10" 300.0 (Layout.location layout_result).x;
