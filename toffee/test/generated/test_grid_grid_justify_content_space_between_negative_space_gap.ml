...
(* Generated test for grid_justify_content_space_between_negative_space_gap in grid layout *)
...
let test_grid_justify_content_space_between_negative_space_gap_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"x of node9" 100.0 layout.location.x;
  assert_eq ~msg:"y of node9" 80.0 layout.location.y;
  ()



let test_grid_justify_content_space_between_negative_space_gap_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_justify_content_space_between_negative_space_gap Test" [
    "grid_grid_justify_content_space_between_negative_space_gap", [
      test_case "grid_justify_content_space_between_negative_space_gap (border-box)" `Quick test_grid_justify_content_space_between_negative_space_gap_border_box;
      test_case "grid_justify_content_space_between_negative_space_gap (content-box)" `Quick test_grid_justify_content_space_between_negative_space_gap_content_box;
    ];
  ]
