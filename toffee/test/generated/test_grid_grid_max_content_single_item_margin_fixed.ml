...
(* Generated test for grid_max_content_single_item_margin_fixed in grid layout *)
...
let test_grid_max_content_single_item_margin_fixed_border_box () =
  (* Setup test helpers *)
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Max_content; max = Toffee.Style.Grid.Max_content }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }] }) in
  let node0 = Toffee.new_leaf tree (Toffee.Style.default) in
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
  let node1 = Toffee.new_leaf tree ({ Toffee.Style.default with margin = { left = Toffee.Style.Length_percentage_auto.Length (20.0); right = Toffee.Style.Length_percentage_auto.Length (10.0); top = Toffee.Style.Length_percentage_auto.Length (5.0); bottom = Toffee.Style.Length_percentage_auto.Length (15.0) } }) in
  let _ = Toffee.set_node_context tree node1 (MeasureFunction.Fixed {width = 50.0; height = 10.0}) |> Result.get_ok in
  ...
  assert_eq ~msg:"x of node2" 110.0 layout.location.x;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 70.0 layout.size.width;
  ...
  assert_eq ~msg:"x of node5" 110.0 layout.location.x;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node7" 70.0 layout.size.width;
  ...
  assert_eq ~msg:"x of node8" 110.0 layout.location.x;
  assert_eq ~msg:"y of node8" 80.0 layout.location.y;
  ()



let test_grid_max_content_single_item_margin_fixed_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_max_content_single_item_margin_fixed Test" [
    "grid_grid_max_content_single_item_margin_fixed", [
      test_case "grid_max_content_single_item_margin_fixed (border-box)" `Quick test_grid_max_content_single_item_margin_fixed_border_box;
      test_case "grid_max_content_single_item_margin_fixed (content-box)" `Quick test_grid_max_content_single_item_margin_fixed_content_box;
    ];
  ]
