...
let test_grid_max_content_single_item_margin_fixed_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 46.0 layout.size.width;
  ...
  assert_eq ~msg:"x of node2" 116.0 layout.location.x;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 76.0 layout.size.width;
  ...
  assert_eq ~msg:"x of node5" 116.0 layout.location.x;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node7" 76.0 layout.size.width;
  ...
  assert_eq ~msg:"x of node8" 116.0 layout.location.x;
  ...
  run "Toffee grid_max_content_single_item_margin_fixed Test"
    [
      ( "grid_grid_max_content_single_item_margin_fixed",
        [
          test_case "grid_max_content_single_item_margin_fixed (border-box)"
            `Quick test_grid_max_content_single_item_margin_fixed_border_box;
          test_case "grid_max_content_single_item_margin_fixed (content-box)"
            `Quick test_grid_max_content_single_item_margin_fixed_content_box;
        ] );
    ]
