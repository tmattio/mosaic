...
let test_grid_max_content_single_item_margin_percent_border_box () =
  ...
  assert_eq ~msg:"height of node1" 31.0 layout.size.height;
  assert_eq ~msg:"x of node1" 49.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node2" 86.0 layout.location.x;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 46.0 layout.size.width;
  ...
  assert_eq ~msg:"x of node5" 86.0 layout.location.x;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node7" 46.0 layout.size.width;
  ...
  assert_eq ~msg:"x of node8" 86.0 layout.location.x;
  ...
  run "Toffee grid_max_content_single_item_margin_percent Test"
    [
      ( "grid_grid_max_content_single_item_margin_percent",
        [
          test_case "grid_max_content_single_item_margin_percent (border-box)"
            `Quick test_grid_max_content_single_item_margin_percent_border_box;
          test_case "grid_max_content_single_item_margin_percent (content-box)"
            `Quick test_grid_max_content_single_item_margin_percent_content_box;
        ] );
    ]
