...
let test_grid_max_content_single_item_margin_percent_border_box () =
  (* Setup test helpers *)
  ...
  let node1 = Toffee.new_leaf tree ({ Toffee.Style.default with margin = { left = Toffee.Style.Length_percentage_auto.Percent (0.2); right = Toffee.Style.Length_percentage_auto.Percent (0.1); top = Toffee.Style.Length_percentage_auto.Percent (0.05); bottom = Toffee.Style.Length_percentage_auto.Percent (0.15) } }) in
...
let () =
  let open Alcotest in
  run "Toffee grid_max_content_single_item_margin_percent Test" [
    "grid_grid_max_content_single_item_margin_percent", [
      test_case "grid_max_content_single_item_margin_percent (border-box)" `Quick test_grid_max_content_single_item_margin_percent_border_box;
      test_case "grid_max_content_single_item_margin_percent (content-box)" `Quick test_grid_max_content_single_item_margin_percent_content_box;
    ];
  ]
