  ...
  run "Toffee block_item_min_width_overrides_max_width Test"
    [
      ( "block_block_item_min_width_overrides_max_width",
        [
          test_case "block_item_min_width_overrides_max_width (border-box)"
            `Quick test_block_item_min_width_overrides_max_width_border_box;
          test_case "block_item_min_width_overrides_max_width (content-box)"
            `Quick test_block_item_min_width_overrides_max_width_content_box;
        ] );
    ]
