...
let test_flex_rounding_flex_basis_flex_grow_row_prime_number_width_border_box ()
  ...
  let node5 = new_leaf tree (Style.make ~flex_grow:1.0 ()) |> Result.get_ok in
  let node0 =
  ...
  assert_eq ~msg:"width of node1" 23.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node5" 23.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node5" 100.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node5" 90.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node5" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node0 |> Result.get_ok in
  assert_eq ~msg:"width of node0" 113.0 (Layout.size layout_result).width;
