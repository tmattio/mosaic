...
let test_grid_absolute_container_top_right_margin_border_box () =
  ...
  assert_eq ~msg:"x of node0" 1014.0 layout.location.x;
  ...
  run "Toffee grid_absolute_container_top_right_margin Test"
    [
      ( "grid_grid_absolute_container_top_right_margin",
        [
          test_case "grid_absolute_container_top_right_margin (border-box)"
            `Quick test_grid_absolute_container_top_right_margin_border_box;
          test_case "grid_absolute_container_top_right_margin (content-box)"
            `Quick test_grid_absolute_container_top_right_margin_content_box;
        ] );
    ]
