...
let () =
  ...
  run "Toffee intrinsic_sizing_main_size_row_nested Test" [
    "flex_intrinsic_sizing_main_size_row_nested", [
      test_case "intrinsic_sizing_main_size_row_nested (border-box)" `Quick test_intrinsic_sizing_main_size_row_nested_border_box;
      test_case "intrinsic_sizing_main_size_row_nested (content-box)" `Quick test_intrinsic_sizing_main_size_row_nested_content_box;
    ];
  ]
