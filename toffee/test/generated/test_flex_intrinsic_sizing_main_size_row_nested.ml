...
let test_intrinsic_sizing_main_size_row_nested_border_box () =
  (* Setup test helpers *)
...
let test_intrinsic_sizing_main_size_row_nested_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee intrinsic_sizing_main_size_row_nested Test"
    [
      ( "flex_intrinsic_sizing_main_size_row_nested",
        [
          test_case "intrinsic_sizing_main_size_row_nested (border-box)" `Quick
            test_intrinsic_sizing_main_size_row_nested_border_box;
          test_case "intrinsic_sizing_main_size_row_nested (content-box)" `Quick
            test_intrinsic_sizing_main_size_row_nested_content_box;
        ] );
    ]
