...
let test_grid_max_width_smaller_than_min_content_border_box () =
  ...
  let _ =
    Toffee.set_node_context tree node1
      (MeasureFunction.Fixed { width = 90.0; height = 10.0 })
    |> Result.get_ok
  in
  ...
  assert_eq ~msg:"height of node" 36.0 layout.size.height;
  ...
  assert_eq ~msg:"x of node2" 46.0 layout.location.x;
  ...
  run "Toffee grid_max_width_smaller_than_min_content Test"
    [
      ( "grid_grid_max_width_smaller_than_min_content",
        [
          test_case "grid_max_width_smaller_than_min_content (border-box)"
            `Quick test_grid_max_width_smaller_than_min_content_border_box;
          test_case "grid_max_width_smaller_than_min_content (content-box)"
            `Quick test_grid_max_width_smaller_than_min_content_content_box;
        ] );
    ]
