...
let test_flex_percentage_different_width_height_border_box () =
  (* Setup test helpers *)
...
let test_flex_percentage_different_width_height_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "percentage_different_width_height (border-box)" `Quick
      test_flex_percentage_different_width_height_border_box;
    test_case "percentage_different_width_height (content-box)" `Quick
      test_flex_percentage_different_width_height_content_box;
  ]
