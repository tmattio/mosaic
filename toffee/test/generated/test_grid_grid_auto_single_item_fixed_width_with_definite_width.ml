...
(* Generated test for grid_auto_single_item_fixed_width_with_definite_width in grid layout *)
...
let test_grid_auto_single_item_fixed_width_with_definite_width_border_box () =
  (* Setup test helpers *)
...
let test_grid_auto_single_item_fixed_width_with_definite_width_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
  let node1 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node1 |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee grid_auto_single_item_fixed_width_with_definite_width Test" [
    "grid_grid_auto_single_item_fixed_width_with_definite_width", [
      test_case "grid_auto_single_item_fixed_width_with_definite_width (border-box)" `Quick test_grid_auto_single_item_fixed_width_with_definite_width_border_box;
      test_case "grid_auto_single_item_fixed_width_with_definite_width (content-box)" `Quick test_grid_auto_single_item_fixed_width_with_definite_width_content_box;
    ];
  ]
