  ...
  run "Toffee grid_auto_single_item_fixed_width_with_definite_width Test"
    [
      ( "grid_grid_auto_single_item_fixed_width_with_definite_width",
        [
          test_case
            "grid_auto_single_item_fixed_width_with_definite_width (border-box)"
            `Quick
            test_grid_auto_single_item_fixed_width_with_definite_width_border_box;
          test_case
            "grid_auto_single_item_fixed_width_with_definite_width \
             (content-box)"
            `Quick
            test_grid_auto_single_item_fixed_width_with_definite_width_content_box;
        ] );
    ]
