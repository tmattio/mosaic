    ...
    Toffee.new_leaf tree
      {
        ...
        padding =
          {
            left = Toffee.Style.Length_percentage.Length 16.0;
            right = Toffee.Style.Length_percentage.Length 16.0;
    ...
    Toffee.new_leaf tree
      {
        ...
        min_size =
          {
            width = Toffee.Style.Dimension.auto;
            height = Toffee.Style.Dimension.length 28.0;
          };
        margin =
          {
  ...
  run "Toffee min_height_with_nested_fixed_height Test"
    [
      ( "flex_min_height_with_nested_fixed_height",
        [
          test_case "min_height_with_nested_fixed_height (border-box)" `Quick
            test_min_height_with_nested_fixed_height_border_box;
          test_case "min_height_with_nested_fixed_height (content-box)" `Quick
            test_min_height_with_nested_fixed_height_content_box;
        ] );
    ]
