...
let test_flex_min_height_with_nested_fixed_height_border_box () =
  ...
  assert_eq ~msg:"height of node" 57.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"x of node0" 16.0 (Layout.location layout_result).x;
...
let test_flex_min_height_with_nested_fixed_height_content_box () =
  ...
  (* Verify layout *)
  let layout_result = layout tree node |> Result.get_ok in
  assert_eq ~msg:"width of node" 352.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node" 57.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node" 0.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node0 |> Result.get_ok in
