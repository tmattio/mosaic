...
(* Generated test for grid_fr_span_2_proportion_with_non_spanned_track in grid layout *)
...
let test_grid_fr_span_2_proportion_with_non_spanned_track_border_box () =
  (* Setup test helpers *)
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (1.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (2.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (3.0) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }] }) in
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 60.0 layout.size.width;
...
let test_grid_fr_span_2_proportion_with_non_spanned_track_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_fr_span_2_proportion_with_non_spanned_track Test" [
    "grid_grid_fr_span_2_proportion_with_non_spanned_track", [
      test_case "grid_fr_span_2_proportion_with_non_spanned_track (border-box)" `Quick test_grid_fr_span_2_proportion_with_non_spanned_track_border_box;
      test_case "grid_fr_span_2_proportion_with_non_spanned_track (content-box)" `Quick test_grid_fr_span_2_proportion_with_non_spanned_track_content_box;
    ];
  ]
