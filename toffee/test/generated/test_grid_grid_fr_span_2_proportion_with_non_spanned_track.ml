...
let test_grid_fr_span_2_proportion_with_non_spanned_track_border_box () =
    ...
    Toffee.new_leaf tree
      {
        ...
        grid_template_columns =
          [
            ...
            Toffee.Style.Grid.Single
              { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr 2.0 };
            Toffee.Style.Grid.Single
              { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr 3.0 };
          ];
        grid_template_rows =
          [
            Toffee.Style.Grid.Single
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 504.0 layout.size.width;
  assert_eq ~msg:"height of node1" 40.0 layout.size.height;
  assert_eq ~msg:"x of node1" 504.0 layout.location.x;
  assert_eq ~msg:"y of node1" 0.0 layout.location.y;
  let layout = Toffee.layout tree node2 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 168.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node3" 336.0 layout.size.width;
  assert_eq ~msg:"height of node3" 40.0 layout.size.height;
  assert_eq ~msg:"x of node3" 168.0 layout.location.x;
  assert_eq ~msg:"y of node3" 40.0 layout.location.y;
  let layout = Toffee.layout tree node4 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 504.0 layout.size.width;
  assert_eq ~msg:"height of node4" 40.0 layout.size.height;
  assert_eq ~msg:"x of node4" 504.0 layout.location.x;
  ...
  run "Toffee grid_fr_span_2_proportion_with_non_spanned_track Test"
    [
      ( "grid_grid_fr_span_2_proportion_with_non_spanned_track",
        [
          test_case
            "grid_fr_span_2_proportion_with_non_spanned_track (border-box)"
            `Quick
            test_grid_fr_span_2_proportion_with_non_spanned_track_border_box;
          test_case
            "grid_fr_span_2_proportion_with_non_spanned_track (content-box)"
            `Quick
            test_grid_fr_span_2_proportion_with_non_spanned_track_content_box;
        ] );
    ]
