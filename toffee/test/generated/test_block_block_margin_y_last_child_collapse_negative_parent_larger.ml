  ...
  run "Toffee block_margin_y_last_child_collapse_negative_parent_larger Test"
    [
      ( "block_block_margin_y_last_child_collapse_negative_parent_larger",
        [
          test_case
            "block_margin_y_last_child_collapse_negative_parent_larger \
             (border-box)"
            `Quick
            test_block_margin_y_last_child_collapse_negative_parent_larger_border_box;
          test_case
            "block_margin_y_last_child_collapse_negative_parent_larger \
             (content-box)"
            `Quick
            test_block_margin_y_last_child_collapse_negative_parent_larger_content_box;
        ] );
    ]
