        ...
        size =
          {
            ...
            height = Toffee.Style.Dimension.length 240.0;
          };
        border =
          {
  ...
  run "Toffee grid_align_content_space_between_negative_space_gap Test"
    [
      ( "grid_grid_align_content_space_between_negative_space_gap",
        [
          test_case
            "grid_align_content_space_between_negative_space_gap (border-box)"
            `Quick
            test_grid_align_content_space_between_negative_space_gap_border_box;
          test_case
            "grid_align_content_space_between_negative_space_gap (content-box)"
            `Quick
