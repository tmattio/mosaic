...
let test_grid_chrome_issue_325928327_border_box () =
  ...
  let node2 =
    new_leaf tree
      (Style.make
         ...
         ~aspect_ratio:1.0 ~box_sizing:Style.Box_sizing.Border_box ())
    |> Result.get_ok
  in
  let node1 =
  ...
  let node0 =
    new_with_children tree
      (Style.make ~display:Style.Display.Grid ~justify_items:Center
         ~size:
           {
...
let tests =
  [
    Windtrap.test "chrome_issue_325928327 (border-box)"
      test_grid_chrome_issue_325928327_border_box;
    Windtrap.test "chrome_issue_325928327 (content-box)"
