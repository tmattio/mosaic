...
(* Generated test for block_margin_y_collapse_through_positive in block layout *)
...
let test_block_margin_y_collapse_through_positive_border_box () =
  (* Setup test helpers *)
...
let test_block_margin_y_collapse_through_positive_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee block_margin_y_collapse_through_positive Test" [
    "block_block_margin_y_collapse_through_positive", [
      test_case "block_margin_y_collapse_through_positive (border-box)" `Quick test_block_margin_y_collapse_through_positive_border_box;
      test_case "block_margin_y_collapse_through_positive (content-box)" `Quick test_block_margin_y_collapse_through_positive_content_box;
    ];
  ]
