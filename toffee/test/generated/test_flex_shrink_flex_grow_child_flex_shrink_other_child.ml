...
let test_flex_shrink_flex_grow_child_flex_shrink_other_child_border_box () =
  ...
  assert_eq ~msg:"width of node1" 250.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node2" 250.0 (Layout.size layout_result).width;
...
let tests =
  [
    Windtrap.test "shrink_flex_grow_child_flex_shrink_other_child (border-box)"
      test_flex_shrink_flex_grow_child_flex_shrink_other_child_border_box;
    Windtrap.test "shrink_flex_grow_child_flex_shrink_other_child (content-box)"
