...
let tests =
  let open Alcotest in
  [
    test_case "shrink_flex_grow_child_flex_shrink_other_child (border-box)"
      `Quick test_flex_shrink_flex_grow_child_flex_shrink_other_child_border_box;
    test_case "shrink_flex_grow_child_flex_shrink_other_child (content-box)"
      `Quick
