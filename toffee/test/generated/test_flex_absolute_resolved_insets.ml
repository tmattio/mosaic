...
let test_absolute_resolved_insets_border_box () =
  (* Setup test helpers *)
  ...
  let node7 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Flex; position = Toffee.Style.Relative; size = { width = Toffee.Style.Dimension.length 200.0; height = Toffee.Style.Dimension.length 200.0 }; padding = { left = Toffee.Style.Length_percentage.Length (15.0); right = Toffee.Style.Length_percentage.Length (15.0); top = Toffee.Style.Length_percentage.Length (15.0); bottom = Toffee.Style.Length_percentage.Length (15.0) }; border = { left = Toffee.Style.Length_percentage.Length (20.0); right = Toffee.Style.Length_percentage.Length (20.0); top = Toffee.Style.Length_percentage.Length (20.0); bottom = Toffee.Style.Length_percentage.Length (20.0) } }) in
...
let test_absolute_resolved_insets_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee absolute_resolved_insets Test" [
    "flex_absolute_resolved_insets", [
      test_case "absolute_resolved_insets (border-box)" `Quick test_absolute_resolved_insets_border_box;
      test_case "absolute_resolved_insets (content-box)" `Quick test_absolute_resolved_insets_content_box;
    ];
  ]
