...
let tests =
  [
    Windtrap.test "margin_y_sibling_collapse_positive_percentage (border-box)"
      test_block_margin_y_sibling_collapse_positive_percentage_border_box;
    Windtrap.test "margin_y_sibling_collapse_positive_percentage (content-box)"
      test_block_margin_y_sibling_collapse_positive_percentage_content_box;
  ]
