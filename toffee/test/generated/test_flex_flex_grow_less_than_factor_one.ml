    ...
    Toffee.new_leaf tree
      {
        ...
        flex_grow = 0.2;
        flex_shrink = 0.0;
        flex_basis = Toffee.Style.Dimension.length 40.0;
      }
  in
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
  let node1 =
    Toffee.new_leaf tree
      { Toffee.Style.default with flex_grow = 0.2; flex_shrink = 0.0 }
  in
  let _ = Toffee.add_child tree node node1 |> Result.get_ok in
  let node2 =
    Toffee.new_leaf tree
      { Toffee.Style.default with flex_grow = 0.4; flex_shrink = 0.0 }
  in
  ...
  run "Toffee flex_grow_less_than_factor_one Test"
    [
      ( "flex_flex_grow_less_than_factor_one",
        [
          test_case "flex_grow_less_than_factor_one (border-box)" `Quick
            test_flex_grow_less_than_factor_one_border_box;
          test_case "flex_grow_less_than_factor_one (content-box)" `Quick
