...
(* Generated test for grid_span_2_min_content_fit_content_30px_indefinite in grid layout *)
...
let () =
  let open Alcotest in
  run "Toffee grid_span_2_min_content_fit_content_30px_indefinite Test" [
    "grid_grid_span_2_min_content_fit_content_30px_indefinite", [
      test_case "grid_span_2_min_content_fit_content_30px_indefinite (border-box)" `Quick test_grid_span_2_min_content_fit_content_30px_indefinite_border_box;
      test_case "grid_span_2_min_content_fit_content_30px_indefinite (content-box)" `Quick test_grid_span_2_min_content_fit_content_30px_indefinite_content_box;
    ];
  ]
