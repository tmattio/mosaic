...
(* Generated test for min_max_percent_different_width_height in flex layout *)
...
let test_min_max_percent_different_width_height_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with flex_direction = Toffee.Style.Flex.Column; align_items = Some (Toffee.Style.Alignment.Flex_start); size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.length 200.0 } }) in
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with min_size = { width = Toffee.Style.Dimension.percent 0.1; height = Toffee.Style.Dimension.percent 0.1 }; max_size = { width = Toffee.Style.Dimension.percent 0.1; height = Toffee.Style.Dimension.percent 0.1 } }) in
...
let test_min_max_percent_different_width_height_content_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with flex_direction = Toffee.Style.Flex.Column; align_items = Some (Toffee.Style.Alignment.Flex_start); size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.length 200.0 }; box_sizing = Toffee.Style.Content_box }) in
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with min_size = { width = Toffee.Style.Dimension.percent 0.1; height = Toffee.Style.Dimension.percent 0.1 }; max_size = { width = Toffee.Style.Dimension.percent 0.1; height = Toffee.Style.Dimension.percent 0.1 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.set_node_context tree node0 (MeasureFunction.Fixed {width = 30.0; height = 10.0}) |> Result.get_ok in
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
...
let () =
  ...
  run "Toffee min_max_percent_different_width_height Test" [
    "flex_min_max_percent_different_width_height", [
      test_case "min_max_percent_different_width_height (border-box)" `Quick test_min_max_percent_different_width_height_border_box;
      test_case "min_max_percent_different_width_height (content-box)" `Quick test_min_max_percent_different_width_height_content_box;
    ];
  ]
