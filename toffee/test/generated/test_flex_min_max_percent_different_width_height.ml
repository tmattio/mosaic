...
let test_flex_min_max_percent_different_width_height_border_box () =
  (* Setup test helpers *)
...
let tests =
  [
    Windtrap.test "min_max_percent_different_width_height (border-box)"
      test_flex_min_max_percent_different_width_height_border_box;
    Windtrap.test "min_max_percent_different_width_height (content-box)"
