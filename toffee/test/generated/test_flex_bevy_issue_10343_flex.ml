...
(* Generated test for bevy_issue_10343_flex in flex layout *)
...
let () =
  ...
  run "Toffee bevy_issue_10343_flex Test" [
    "flex_bevy_issue_10343_flex", [
      test_case "bevy_issue_10343_flex (border-box)" `Quick test_bevy_issue_10343_flex_border_box;
      test_case "bevy_issue_10343_flex (content-box)" `Quick test_bevy_issue_10343_flex_content_box;
    ];
  ]
