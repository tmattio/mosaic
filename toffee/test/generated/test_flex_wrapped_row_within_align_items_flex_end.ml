...
let test_flex_wrapped_row_within_align_items_flex_end_border_box () =
  (* Setup test helpers *)
...
let test_flex_wrapped_row_within_align_items_flex_end_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "wrapped_row_within_align_items_flex_end (border-box)" `Quick
      test_flex_wrapped_row_within_align_items_flex_end_border_box;
    test_case "wrapped_row_within_align_items_flex_end (content-box)" `Quick
      test_flex_wrapped_row_within_align_items_flex_end_content_box;
  ]
