...
let tests =
  let open Alcotest in
  [
    test_case "padding_percentage_intrinsic_size (border-box)" `Quick
      test_block_padding_percentage_intrinsic_size_border_box;
    test_case "padding_percentage_intrinsic_size (content-box)" `Quick
      test_block_padding_percentage_intrinsic_size_content_box;
  ]
