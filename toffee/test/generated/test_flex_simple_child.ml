...
(* Generated test for simple_child in flex layout *)
...
let test_simple_child_border_box () =
  (* Setup test helpers *)
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.length 100.0 } }) in
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.percent 1.0; height = Toffee.Style.Dimension.percent 1.0 } }) in
  ...
  let node4 = Toffee.new_leaf tree ({ Toffee.Style.default with align_self = Some (Toffee.Style.Alignment.Center); size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 } }) in
  let _ = Toffee.add_child tree node3 node4 |> Result.get_ok in
  let node5 = Toffee.new_leaf tree ({ Toffee.Style.default with align_self = Some (Toffee.Style.Alignment.Center); size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 } }) in
  ...
  assert_eq ~msg:"x of node3" 10.0 layout.location.x;
...
let test_simple_child_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.length 100.0 }; box_sizing = Toffee.Style.Content_box }) in
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.percent 1.0; height = Toffee.Style.Dimension.percent 1.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
  ...
  let _ = Toffee.add_child tree node0 node3 |> Result.get_ok in
  let node4 = Toffee.new_leaf tree ({ Toffee.Style.default with align_self = Some (Toffee.Style.Alignment.Center); size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node3 node4 |> Result.get_ok in
  let node5 = Toffee.new_leaf tree ({ Toffee.Style.default with align_self = Some (Toffee.Style.Alignment.Center); size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node3 node5 |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee simple_child Test" [
    "flex_simple_child", [
      test_case "simple_child (border-box)" `Quick test_simple_child_border_box;
      test_case "simple_child (content-box)" `Quick test_simple_child_content_box;
    ];
  ]
