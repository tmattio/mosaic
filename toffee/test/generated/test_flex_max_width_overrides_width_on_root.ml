  ...
  run "Toffee max_width_overrides_width_on_root Test"
    [
      ( "flex_max_width_overrides_width_on_root",
        [
          test_case "max_width_overrides_width_on_root (border-box)" `Quick
            test_max_width_overrides_width_on_root_border_box;
          test_case "max_width_overrides_width_on_root (content-box)" `Quick
            test_max_width_overrides_width_on_root_content_box;
        ] );
    ]
