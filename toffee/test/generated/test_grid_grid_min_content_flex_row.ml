...
(* Generated test for grid_min_content_flex_row in grid layout *)
...
let test_grid_min_content_flex_row_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_min_content_flex_row Test" [
    "grid_grid_min_content_flex_row", [
      test_case "grid_min_content_flex_row (border-box)" `Quick test_grid_min_content_flex_row_border_box;
      test_case "grid_min_content_flex_row (content-box)" `Quick test_grid_min_content_flex_row_content_box;
    ];
  ]
