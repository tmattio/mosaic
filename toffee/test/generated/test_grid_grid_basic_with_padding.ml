...
(* Generated test for grid_basic_with_padding in grid layout *)
...
let test_grid_basic_with_padding_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"y of node6" 90.0 layout.location.y;
...
let test_grid_basic_with_padding_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_basic_with_padding Test" [
    "grid_grid_basic_with_padding", [
      test_case "grid_basic_with_padding (border-box)" `Quick test_grid_basic_with_padding_border_box;
      test_case "grid_basic_with_padding (content-box)" `Quick test_grid_basic_with_padding_content_box;
    ];
  ]
