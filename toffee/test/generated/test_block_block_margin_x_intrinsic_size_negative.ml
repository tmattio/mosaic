...
let test_block_margin_x_intrinsic_size_negative_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 1023.0 layout.size.width;
  ...
  run "Toffee block_margin_x_intrinsic_size_negative Test"
    [
      ( "block_block_margin_x_intrinsic_size_negative",
        [
          test_case "block_margin_x_intrinsic_size_negative (border-box)" `Quick
            test_block_margin_x_intrinsic_size_negative_border_box;
          test_case "block_margin_x_intrinsic_size_negative (content-box)"
            `Quick test_block_margin_x_intrinsic_size_negative_content_box;
        ] );
    ]
