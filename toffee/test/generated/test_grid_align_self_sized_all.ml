...
let test_grid_align_self_sized_all_border_box () =
  ...
  let node0 =
    new_leaf tree
      (Style.make ~display:Style.Display.Flex ~align_self:Start
         ~size:
           {
  ...
  let node2 =
    new_leaf tree
      (Style.make ~display:Style.Display.Flex ~align_self:End
         ~size:
           {
             width = Style.Dimension.length 20.0;
             height = Style.Dimension.length 20.0;
  ...
  let node6 =
    new_leaf tree
      (Style.make ~display:Style.Display.Flex ~align_self:Stretch
         ~size:
           {
             width = Style.Dimension.length 20.0;
             height = Style.Dimension.length 20.0;
  ...
  assert_eq ~msg:"height of node3" 60.0 (Layout.size layout_result).height;
...
let tests =
  let open Alcotest in
  [
    test_case "align_self_sized_all (border-box)" `Quick
      test_grid_align_self_sized_all_border_box;
    test_case "align_self_sized_all (content-box)" `Quick
      test_grid_align_self_sized_all_content_box;
  ]
