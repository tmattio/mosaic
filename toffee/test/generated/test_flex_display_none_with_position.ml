...
(* Generated test for display_none_with_position in flex layout *)
...
let test_display_none_with_position_border_box () =
  (* Setup test helpers *)
...
let test_display_none_with_position_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee display_none_with_position Test" [
    "flex_display_none_with_position", [
      test_case "display_none_with_position (border-box)" `Quick test_display_none_with_position_border_box;
      test_case "display_none_with_position (content-box)" `Quick test_display_none_with_position_content_box;
    ];
  ]
