...
let test_grid_auto_single_item_border_box () =
  ...
  assert_eq ~msg:"x of node2" 968.0 layout.location.x;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 928.0 layout.size.width;
  ...
  assert_eq ~msg:"x of node5" 968.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node8" 968.0 layout.location.x;
  ...
  run "Toffee grid_auto_single_item Test"
    [
      ( "grid_grid_auto_single_item",
        [
          test_case "grid_auto_single_item (border-box)" `Quick
            test_grid_auto_single_item_border_box;
          test_case "grid_auto_single_item (content-box)" `Quick
            test_grid_auto_single_item_content_box;
        ] );
    ]
