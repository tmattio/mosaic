...
(* Generated test for grid_auto_single_item in grid layout *)
...
let test_grid_auto_single_item_border_box () =
  (* Setup test helpers *)
...
let test_grid_auto_single_item_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_auto_single_item Test" [
    "grid_grid_auto_single_item", [
      test_case "grid_auto_single_item (border-box)" `Quick test_grid_auto_single_item_border_box;
      test_case "grid_auto_single_item (content-box)" `Quick test_grid_auto_single_item_content_box;
    ];
  ]
