...
(* Generated test for grid_max_content_single_item_span_2 in grid layout *)
...
let test_grid_max_content_single_item_span_2_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"x of node7" 60.0 layout.location.x;
...
let test_grid_max_content_single_item_span_2_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_max_content_single_item_span_2 Test" [
    "grid_grid_max_content_single_item_span_2", [
      test_case "grid_max_content_single_item_span_2 (border-box)" `Quick test_grid_max_content_single_item_span_2_border_box;
      test_case "grid_max_content_single_item_span_2 (content-box)" `Quick test_grid_max_content_single_item_span_2_content_box;
    ];
  ]
