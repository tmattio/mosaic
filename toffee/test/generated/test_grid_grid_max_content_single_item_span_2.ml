...
let test_grid_max_content_single_item_span_2_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node3" 23.0 layout.size.width;
  ...
  assert_eq ~msg:"x of node4" 63.0 layout.location.x;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node6" 23.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node7" 23.0 layout.size.width;
  assert_eq ~msg:"height of node7" 40.0 layout.size.height;
  assert_eq ~msg:"x of node7" 63.0 layout.location.x;
  ...
  run "Toffee grid_max_content_single_item_span_2 Test"
    [
      ( "grid_grid_max_content_single_item_span_2",
        [
          test_case "grid_max_content_single_item_span_2 (border-box)" `Quick
            test_grid_max_content_single_item_span_2_border_box;
          test_case "grid_max_content_single_item_span_2 (content-box)" `Quick
            test_grid_max_content_single_item_span_2_content_box;
        ] );
    ]
