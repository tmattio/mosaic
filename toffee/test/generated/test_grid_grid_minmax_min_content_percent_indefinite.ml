...
let test_grid_minmax_min_content_percent_indefinite_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 202.0 layout.size.width;
  ...
  run "Toffee grid_minmax_min_content_percent_indefinite Test"
    [
      ( "grid_grid_minmax_min_content_percent_indefinite",
        [
          test_case "grid_minmax_min_content_percent_indefinite (border-box)"
            `Quick test_grid_minmax_min_content_percent_indefinite_border_box;
          test_case "grid_minmax_min_content_percent_indefinite (content-box)"
            `Quick test_grid_minmax_min_content_percent_indefinite_content_box;
        ] );
    ]
