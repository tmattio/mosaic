...
let tests =
  let open Alcotest in
  [
    test_case "margin_x_fixed_size_negative (border-box)" `Quick
      test_block_margin_x_fixed_size_negative_border_box;
    test_case "margin_x_fixed_size_negative (content-box)" `Quick
      test_block_margin_x_fixed_size_negative_content_box;
  ]
