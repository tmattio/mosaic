...
(* Generated test for grid_margins_fixed_stretch in grid layout *)
...
let test_grid_margins_fixed_stretch_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"x of node0" 44.0 layout.location.x;
  assert_eq ~msg:"y of node0" 11.0 layout.location.y;
...
let test_grid_margins_fixed_stretch_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_margins_fixed_stretch Test" [
    "grid_grid_margins_fixed_stretch", [
      test_case "grid_margins_fixed_stretch (border-box)" `Quick test_grid_margins_fixed_stretch_border_box;
      test_case "grid_margins_fixed_stretch (content-box)" `Quick test_grid_margins_fixed_stretch_content_box;
    ];
  ]
