...
let tests =
  ...
  [
    test_case
      "margin_y_collapse_through_blocked_by_overflow_x_hidden (border-box)"
      `Quick
      test_block_margin_y_collapse_through_blocked_by_overflow_x_hidden_border_box;
    test_case
      "margin_y_collapse_through_blocked_by_overflow_x_hidden (content-box)"
      `Quick
      test_block_margin_y_collapse_through_blocked_by_overflow_x_hidden_content_box;
  ]
