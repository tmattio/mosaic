...
(* Generated test for grid_justify_content_space_evenly in grid layout *)
...
let test_grid_justify_content_space_evenly_border_box () =
  (* Setup test helpers *)
...
let test_grid_justify_content_space_evenly_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_justify_content_space_evenly Test" [
    "grid_grid_justify_content_space_evenly", [
      test_case "grid_justify_content_space_evenly (border-box)" `Quick test_grid_justify_content_space_evenly_border_box;
      test_case "grid_justify_content_space_evenly (content-box)" `Quick test_grid_justify_content_space_evenly_content_box;
    ];
  ]
