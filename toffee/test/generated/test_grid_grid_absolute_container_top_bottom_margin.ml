...
(* Generated test for grid_absolute_container_top_bottom_margin in grid layout *)
...
let test_grid_absolute_container_top_bottom_margin_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"height of node0" 149.0 layout.size.height;
  assert_eq ~msg:"x of node0" 4.0 layout.location.x;
  assert_eq ~msg:"y of node0" 3.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node3" 120.0 layout.location.x;
...
let test_grid_absolute_container_top_bottom_margin_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_absolute_container_top_bottom_margin Test" [
    "grid_grid_absolute_container_top_bottom_margin", [
      test_case "grid_absolute_container_top_bottom_margin (border-box)" `Quick test_grid_absolute_container_top_bottom_margin_border_box;
      test_case "grid_absolute_container_top_bottom_margin (content-box)" `Quick test_grid_absolute_container_top_bottom_margin_content_box;
    ];
  ]
