  ...
  run "Toffee flex_row_relative_all_sides Test"
    [
      ( "flex_flex_row_relative_all_sides",
        [
          test_case "flex_row_relative_all_sides (border-box)" `Quick
            test_flex_row_relative_all_sides_border_box;
          test_case "flex_row_relative_all_sides (content-box)" `Quick
            test_flex_row_relative_all_sides_content_box;
        ] );
    ]
