(* Generated test for leaf_overflow_scrollbars_take_up_space_y_axis *)
...
let test_leaf_overflow_scrollbars_take_up_space_y_axis_border_box
    measure_function () =
  (* Setup test helpers *)
  ...
  in
  let _ =
    Toffee.set_node_context tree node (MeasureFunction.Text "HH")
    |> Result.get_ok
  in
...
let test_leaf_overflow_scrollbars_take_up_space_y_axis_content_box
    measure_function () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
...
let tests =
  let open Alcotest in
  [
    test_case "leaf_overflow_scrollbars_take_up_space_y_axis (border-box)"
      `Quick (fun () ->
        test_leaf_overflow_scrollbars_take_up_space_y_axis_border_box
          measure_function ());
    test_case "leaf_overflow_scrollbars_take_up_space_y_axis (content-box)"
      `Quick (fun () ->
        test_leaf_overflow_scrollbars_take_up_space_y_axis_content_box
          measure_function ());
  ]
