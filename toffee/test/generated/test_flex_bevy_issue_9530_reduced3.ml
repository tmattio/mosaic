  ...
  run "Toffee bevy_issue_9530_reduced3 Test"
    [
      ( "flex_bevy_issue_9530_reduced3",
        [
          test_case "bevy_issue_9530_reduced3 (border-box)" `Quick
            test_bevy_issue_9530_reduced3_border_box;
          test_case "bevy_issue_9530_reduced3 (content-box)" `Quick
            test_bevy_issue_9530_reduced3_content_box;
        ] );
    ]
