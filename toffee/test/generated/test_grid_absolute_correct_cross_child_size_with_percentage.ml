(* Generated test for absolute_correct_cross_child_size_with_percentage in grid layout *)
(* Do not edit this file directly. It is generated by gentest.js *)

open Toffee

let test_grid_absolute_correct_cross_child_size_with_percentage_border_box () =
  (* Setup test helpers *)
...
let test_grid_absolute_correct_cross_child_size_with_percentage_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    Windtrap.equal ~msg (Windtrap.Testable.float 0.001) expected actual
  in
...
let tests =
  [
    Windtrap.test
      ...
      test_grid_absolute_correct_cross_child_size_with_percentage_border_box;
    Windtrap.test
      "absolute_correct_cross_child_size_with_percentage (content-box)"
      test_grid_absolute_correct_cross_child_size_with_percentage_content_box;
  ]
