...
(* Generated test for grid_span_2_min_content_fit_content_30px_indefinite_hidden in grid layout *)
...
let test_grid_span_2_min_content_fit_content_30px_indefinite_hidden_border_box () =
  (* Setup test helpers *)
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 70.0 layout.size.width;
...
let test_grid_span_2_min_content_fit_content_30px_indefinite_hidden_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_span_2_min_content_fit_content_30px_indefinite_hidden Test" [
    "grid_grid_span_2_min_content_fit_content_30px_indefinite_hidden", [
      test_case "grid_span_2_min_content_fit_content_30px_indefinite_hidden (border-box)" `Quick test_grid_span_2_min_content_fit_content_30px_indefinite_hidden_border_box;
      test_case "grid_span_2_min_content_fit_content_30px_indefinite_hidden (content-box)" `Quick test_grid_span_2_min_content_fit_content_30px_indefinite_hidden_content_box;
    ];
  ]
