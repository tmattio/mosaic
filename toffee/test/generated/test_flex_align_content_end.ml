...
let test_flex_align_content_end_border_box () =
  (* Setup test helpers *)
  ...
  let node =
    new_leaf tree
      (Style.make ~flex_direction:Style.Flex_direction.Column
         ~flex_wrap:Style.Flex_wrap.Wrap ~align_content:End
         ~size:
           {
...
let test_flex_align_content_end_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "align_content_end (border-box)" `Quick
      test_flex_align_content_end_border_box;
    test_case "align_content_end (content-box)" `Quick
      test_flex_align_content_end_content_box;
  ]
