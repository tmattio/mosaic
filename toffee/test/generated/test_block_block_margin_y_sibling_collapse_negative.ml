...
(* Generated test for block_margin_y_sibling_collapse_negative in block layout *)
...
let test_block_margin_y_sibling_collapse_negative_border_box () =
  (* Setup test helpers *)
...
let test_block_margin_y_sibling_collapse_negative_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee block_margin_y_sibling_collapse_negative Test" [
    "block_block_margin_y_sibling_collapse_negative", [
      test_case "block_margin_y_sibling_collapse_negative (border-box)" `Quick test_block_margin_y_sibling_collapse_negative_border_box;
      test_case "block_margin_y_sibling_collapse_negative (content-box)" `Quick test_block_margin_y_sibling_collapse_negative_content_box;
    ];
  ]
