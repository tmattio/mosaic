  ...
  run "Toffee block_margin_y_sibling_collapse_negative Test"
    [
      ( "block_block_margin_y_sibling_collapse_negative",
        [
          test_case "block_margin_y_sibling_collapse_negative (border-box)"
            `Quick test_block_margin_y_sibling_collapse_negative_border_box;
          test_case "block_margin_y_sibling_collapse_negative (content-box)"
            `Quick test_block_margin_y_sibling_collapse_negative_content_box;
        ] );
    ]
