...
let test_flex_rounding_fractial_input_5_border_box () =
  ...
  assert_eq ~msg:"width of node" 963.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"x of node0" 381.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node1" 482.0 (Layout.location layout_result).x;
