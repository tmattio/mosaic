    ...
    Toffee.new_leaf tree
      {
        ...
        size =
          {
            width = Toffee.Style.Dimension.length 963.333;
    ...
    Toffee.new_leaf tree
      {
        ...
        size =
          {
            width = Toffee.Style.Dimension.length 100.3;
            height = Toffee.Style.Dimension.length 100.3;
          };
      }
  in
      ...
      ( "flex_rounding_fractial_input_5",
        [
          test_case "rounding_fractial_input_5 (border-box)" `Quick
            test_rounding_fractial_input_5_border_box;
          test_case "rounding_fractial_input_5 (content-box)" `Quick
            test_rounding_fractial_input_5_content_box;
        ] );
    ]
