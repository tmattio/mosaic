  ...
  run "Toffee grid_span_2_min_content_max_content_indefinite Test"
    [
      ( "grid_grid_span_2_min_content_max_content_indefinite",
        [
          test_case
            "grid_span_2_min_content_max_content_indefinite (border-box)" `Quick
            test_grid_span_2_min_content_max_content_indefinite_border_box;
          test_case
            "grid_span_2_min_content_max_content_indefinite (content-box)"
            `Quick
            test_grid_span_2_min_content_max_content_indefinite_content_box;
        ] );
    ]
