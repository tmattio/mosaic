...
(* Generated test for block_margin_y_total_collapse_complex in block layout *)
...
let test_block_margin_y_total_collapse_complex_border_box () =
  (* Setup test helpers *)
...
let test_block_margin_y_total_collapse_complex_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  let _ = Toffee.add_child tree node1 node2 |> Result.get_ok in
  let node3 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 10.0 }; margin = { left = Toffee.Style.Length_percentage_auto.Length (0.0); right = Toffee.Style.Length_percentage_auto.Length (0.0); top = Toffee.Style.Length_percentage_auto.Length (7.0); bottom = Toffee.Style.Length_percentage_auto.Length (3.0) }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node1 node3 |> Result.get_ok in
  let node4 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 10.0 }; margin = { left = Toffee.Style.Length_percentage_auto.Length (0.0); right = Toffee.Style.Length_percentage_auto.Length (0.0); top = Toffee.Style.Length_percentage_auto.Length (-6.0); bottom = Toffee.Style.Length_percentage_auto.Length (9.0) }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node1 node4 |> Result.get_ok in
  let node5 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 10.0 }; margin = { left = Toffee.Style.Length_percentage_auto.Length (0.0); right = Toffee.Style.Length_percentage_auto.Length (0.0); top = Toffee.Style.Length_percentage_auto.Length (-5.0); bottom = Toffee.Style.Length_percentage_auto.Length (-5.0) }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node5 |> Result.get_ok in
  let node6 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 10.0 }; margin = { left = Toffee.Style.Length_percentage_auto.Length (0.0); right = Toffee.Style.Length_percentage_auto.Length (0.0); top = Toffee.Style.Length_percentage_auto.Length (-10.0); bottom = Toffee.Style.Length_percentage_auto.Length (-10.0) }; box_sizing = Toffee.Style.Content_box }) in
...
let () =
  let open Alcotest in
  run "Toffee block_margin_y_total_collapse_complex Test" [
    "block_block_margin_y_total_collapse_complex", [
      test_case "block_margin_y_total_collapse_complex (border-box)" `Quick test_block_margin_y_total_collapse_complex_border_box;
      test_case "block_margin_y_total_collapse_complex (content-box)" `Quick test_block_margin_y_total_collapse_complex_content_box;
    ];
  ]
