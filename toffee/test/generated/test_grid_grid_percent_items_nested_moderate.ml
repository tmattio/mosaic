...
let () =
  ...
  run "Toffee grid_percent_items_nested_moderate Test" [
    "grid_grid_percent_items_nested_moderate", [
      test_case "grid_percent_items_nested_moderate (border-box)" `Quick test_grid_percent_items_nested_moderate_border_box;
      test_case "grid_percent_items_nested_moderate (content-box)" `Quick test_grid_percent_items_nested_moderate_content_box;
    ];
  ]
