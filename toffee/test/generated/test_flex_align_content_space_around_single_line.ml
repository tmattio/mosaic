...
let test_flex_align_content_space_around_single_line_border_box () =
  ...
  let node =
    new_leaf tree
      (Style.make ~display:Style.Display.Flex
         ~flex_direction:Style.Flex_direction.Row ~align_content:Space_around
         ~size:
           {
  ...
  assert_eq ~msg:"width of node0" 17.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"x of node1" 17.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node1" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node2 |> Result.get_ok in
  assert_eq ~msg:"width of node2" 17.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node2" 10.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 33.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"width of node4" 16.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node4" 10.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node4" 67.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node4" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node5 |> Result.get_ok in
  assert_eq ~msg:"width of node5" 17.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node5" 10.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node5" 83.0 (Layout.location layout_result).x;
