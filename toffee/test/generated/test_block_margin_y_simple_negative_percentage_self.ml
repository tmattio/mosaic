...
let tests =
  let open Alcotest in
  [
    test_case "margin_y_simple_negative_percentage_self (border-box)" `Quick
      test_block_margin_y_simple_negative_percentage_self_border_box;
    test_case "margin_y_simple_negative_percentage_self (content-box)" `Quick
      test_block_margin_y_simple_negative_percentage_self_content_box;
  ]
