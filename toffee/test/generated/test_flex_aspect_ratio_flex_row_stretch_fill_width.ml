...
let test_flex_aspect_ratio_flex_row_stretch_fill_width_border_box () =
  (* Setup test helpers *)
...
let test_flex_aspect_ratio_flex_row_stretch_fill_width_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "aspect_ratio_flex_row_stretch_fill_width (border-box)" `Quick
      test_flex_aspect_ratio_flex_row_stretch_fill_width_border_box;
    test_case "aspect_ratio_flex_row_stretch_fill_width (content-box)" `Quick
      test_flex_aspect_ratio_flex_row_stretch_fill_width_content_box;
  ]
