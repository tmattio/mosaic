        ...
        margin =
          {
            ...
            bottom = Toffee.Style.Length_percentage_auto.Length 7.0;
          };
      }
  in
  ...
  run "Toffee block_absolute_child_with_margin_y Test"
    [
      ( "block_block_absolute_child_with_margin_y",
        [
          test_case "block_absolute_child_with_margin_y (border-box)" `Quick
            test_block_absolute_child_with_margin_y_border_box;
          test_case "block_absolute_child_with_margin_y (content-box)" `Quick
