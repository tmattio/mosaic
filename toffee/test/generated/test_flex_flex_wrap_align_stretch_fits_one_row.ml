  ...
  run "Toffee flex_wrap_align_stretch_fits_one_row Test"
    [
      ( "flex_flex_wrap_align_stretch_fits_one_row",
        [
          test_case "flex_wrap_align_stretch_fits_one_row (border-box)" `Quick
            test_flex_wrap_align_stretch_fits_one_row_border_box;
          test_case "flex_wrap_align_stretch_fits_one_row (content-box)" `Quick
            test_flex_wrap_align_stretch_fits_one_row_content_box;
        ] );
    ]
