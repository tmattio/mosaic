...
(* Generated test for relative_position_should_not_nudge_siblings in flex layout *)
...
let () =
  ...
  run "Toffee relative_position_should_not_nudge_siblings Test" [
    "flex_relative_position_should_not_nudge_siblings", [
      test_case "relative_position_should_not_nudge_siblings (border-box)" `Quick test_relative_position_should_not_nudge_siblings_border_box;
      test_case "relative_position_should_not_nudge_siblings (content-box)" `Quick test_relative_position_should_not_nudge_siblings_content_box;
    ];
  ]
