...
let test_grid_justify_content_center_with_padding_border_border_box () =
  ...
  assert_eq ~msg:"x of node1" 52.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node3" 132.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node4" 52.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node6" 132.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node7" 52.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node9" 132.0 (Layout.location layout_result).x;
...
let test_grid_justify_content_center_with_padding_border_content_box () =
  ...
  assert_eq ~msg:"width of node3" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node3" 168.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node3" 12.0 (Layout.location layout_result).y;
  let layout_result = layout tree node4 |> Result.get_ok in
  assert_eq ~msg:"width of node4" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node4" 40.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"width of node6" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node6" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node6" 168.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node6" 52.0 (Layout.location layout_result).y;
  let layout_result = layout tree node7 |> Result.get_ok in
  assert_eq ~msg:"width of node7" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node7" 40.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"width of node9" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node9" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node9" 168.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node9" 92.0 (Layout.location layout_result).y;
  let layout_result = layout tree node0 |> Result.get_ok in
...
let tests =
  let open Alcotest in
  [
    test_case "justify_content_center_with_padding_border (border-box)" `Quick
      test_grid_justify_content_center_with_padding_border_border_box;
    test_case "justify_content_center_with_padding_border (content-box)" `Quick
      test_grid_justify_content_center_with_padding_border_content_box;
  ]
