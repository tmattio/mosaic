...
let () =
  ...
  run "Toffee block_margin_y_collapse_complex Test" [
    "block_block_margin_y_collapse_complex", [
      test_case "block_margin_y_collapse_complex (border-box)" `Quick test_block_margin_y_collapse_complex_border_box;
      test_case "block_margin_y_collapse_complex (content-box)" `Quick test_block_margin_y_collapse_complex_content_box;
    ];
  ]
