...
(* Generated test for grid_percent_tracks_indefinite_only in grid layout *)
...
let test_grid_percent_tracks_indefinite_only_border_box () =
  (* Setup test helpers *)
...
let test_grid_percent_tracks_indefinite_only_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_percent_tracks_indefinite_only Test" [
    "grid_grid_percent_tracks_indefinite_only", [
      test_case "grid_percent_tracks_indefinite_only (border-box)" `Quick test_grid_percent_tracks_indefinite_only_border_box;
      test_case "grid_percent_tracks_indefinite_only (content-box)" `Quick test_grid_percent_tracks_indefinite_only_content_box;
    ];
  ]
