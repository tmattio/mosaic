...
let test_block_absolute_child_with_max_height_border_box () =
  ...
  assert_eq ~msg:"y of node0" 640.0 layout.location.y;
  ...
  run "Toffee block_absolute_child_with_max_height Test"
    [
      ( "block_block_absolute_child_with_max_height",
        [
          test_case "block_absolute_child_with_max_height (border-box)" `Quick
            test_block_absolute_child_with_max_height_border_box;
          test_case "block_absolute_child_with_max_height (content-box)" `Quick
            test_block_absolute_child_with_max_height_content_box;
        ] );
    ]
