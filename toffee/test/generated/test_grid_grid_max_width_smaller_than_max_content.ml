  ...
  run "Toffee grid_max_width_smaller_than_max_content Test"
    [
      ( "grid_grid_max_width_smaller_than_max_content",
        [
          test_case "grid_max_width_smaller_than_max_content (border-box)"
            `Quick test_grid_max_width_smaller_than_max_content_border_box;
          test_case "grid_max_width_smaller_than_max_content (content-box)"
            `Quick test_grid_max_width_smaller_than_max_content_content_box;
        ] );
    ]
