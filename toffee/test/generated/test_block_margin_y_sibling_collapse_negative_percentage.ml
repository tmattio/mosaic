...
let test_block_margin_y_sibling_collapse_negative_percentage_border_box () =
  ...
  assert_eq ~msg:"height of node0" 15.0 (Layout.size layout_result).height;
...
let tests =
  [
    Windtrap.test "margin_y_sibling_collapse_negative_percentage (border-box)"
      test_block_margin_y_sibling_collapse_negative_percentage_border_box;
    Windtrap.test "margin_y_sibling_collapse_negative_percentage (content-box)"
      test_block_margin_y_sibling_collapse_negative_percentage_content_box;
  ]
