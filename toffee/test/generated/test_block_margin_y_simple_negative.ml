...
let tests =
  let open Alcotest in
  [
    test_case "margin_y_simple_negative (border-box)" `Quick
      test_block_margin_y_simple_negative_border_box;
    test_case "margin_y_simple_negative (content-box)" `Quick
      test_block_margin_y_simple_negative_content_box;
  ]
