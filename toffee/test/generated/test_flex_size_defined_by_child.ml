...
let () =
  ...
  run "Toffee size_defined_by_child Test" [
    "flex_size_defined_by_child", [
      test_case "size_defined_by_child (border-box)" `Quick test_size_defined_by_child_border_box;
      test_case "size_defined_by_child (content-box)" `Quick test_size_defined_by_child_content_box;
    ];
  ]
