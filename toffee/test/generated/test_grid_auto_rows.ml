...
let test_grid_auto_rows_border_box () =
  ...
  assert_eq ~msg:"height of node6" 30.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"y of node7" 150.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"height of node0" 180.0 (Layout.size layout_result).height;
...
let tests =
  [
    Windtrap.test "auto_rows (border-box)" test_grid_auto_rows_border_box;
    Windtrap.test "auto_rows (content-box)" test_grid_auto_rows_content_box;
  ]
