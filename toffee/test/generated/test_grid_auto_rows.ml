...
let test_grid_auto_rows_border_box () =
  ...
  assert_eq ~msg:"height of node" 180.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"height of node5" 30.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"y of node6" 150.0 (Layout.location layout_result).y;
