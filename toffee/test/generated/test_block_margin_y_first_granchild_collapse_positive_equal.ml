...
let tests =
  let open Alcotest in
  [
    test_case "margin_y_first_granchild_collapse_positive_equal (border-box)"
      `Quick
      test_block_margin_y_first_granchild_collapse_positive_equal_border_box;
    test_case "margin_y_first_granchild_collapse_positive_equal (content-box)"
      `Quick
      test_block_margin_y_first_granchild_collapse_positive_equal_content_box;
  ]
