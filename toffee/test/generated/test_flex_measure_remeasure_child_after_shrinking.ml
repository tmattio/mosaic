...
let test_measure_remeasure_child_after_shrinking_border_box () =
  ...
  assert_eq ~msg:"height of node" 68.0 layout.size.height;
  ...
  run "Toffee measure_remeasure_child_after_shrinking Test"
    [
      ( "flex_measure_remeasure_child_after_shrinking",
        [
          test_case "measure_remeasure_child_after_shrinking (border-box)"
            `Quick test_measure_remeasure_child_after_shrinking_border_box;
          test_case "measure_remeasure_child_after_shrinking (content-box)"
            `Quick test_measure_remeasure_child_after_shrinking_content_box;
        ] );
    ]
