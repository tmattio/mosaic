...
(* Generated test for measure_remeasure_child_after_shrinking in flex layout *)
...
let test_measure_remeasure_child_after_shrinking_border_box () =
  (* Setup test helpers *)
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with align_items = Some (Toffee.Style.Alignment.Start); size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto } }) in
...
let test_measure_remeasure_child_after_shrinking_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with align_items = Some (Toffee.Style.Alignment.Start); size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.auto }; box_sizing = Toffee.Style.Content_box }) in
...
let () =
  let open Alcotest in
  run "Toffee measure_remeasure_child_after_shrinking Test" [
    "flex_measure_remeasure_child_after_shrinking", [
      test_case "measure_remeasure_child_after_shrinking (border-box)" `Quick test_measure_remeasure_child_after_shrinking_border_box;
      test_case "measure_remeasure_child_after_shrinking (content-box)" `Quick test_measure_remeasure_child_after_shrinking_content_box;
    ];
  ]
