...
(* Generated test for grid_justify_content_center in grid layout *)
...
let test_grid_justify_content_center_border_box () =
  (* Setup test helpers *)
...
let test_grid_justify_content_center_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_justify_content_center Test" [
    "grid_grid_justify_content_center", [
      test_case "grid_justify_content_center (border-box)" `Quick test_grid_justify_content_center_border_box;
      test_case "grid_justify_content_center (content-box)" `Quick test_grid_justify_content_center_content_box;
    ];
  ]
