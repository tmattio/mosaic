...
let test_grid_span_13_most_non_flex_with_minmax_indefinite_hidden_border_box
  ...
  assert_eq ~msg:"width of node" 322.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node1" 16.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node2" 95.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node2" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 16.0 (Layout.location layout_result).x;
