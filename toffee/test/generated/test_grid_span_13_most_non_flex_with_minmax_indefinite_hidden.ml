...
let test_grid_span_13_most_non_flex_with_minmax_indefinite_hidden_border_box ()
  ...
  assert_eq ~msg:"width of node3" 95.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node3" 16.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node5" 111.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node6" 111.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node6" 40.0 (Layout.location layout_result).y;
  let layout_result = layout tree node7 |> Result.get_ok in
  assert_eq ~msg:"width of node7" 64.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node7" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node7" 121.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node8" 185.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node9" 187.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node10" 191.0 (Layout.location layout_result).x;
...
let tests =
  let open Alcotest in
  [
    test_case "span_13_most_non_flex_with_minmax_indefinite_hidden (border-box)"
      `Quick
      test_grid_span_13_most_non_flex_with_minmax_indefinite_hidden_border_box;
    test_case
      "span_13_most_non_flex_with_minmax_indefinite_hidden (content-box)" `Quick
      test_grid_span_13_most_non_flex_with_minmax_indefinite_hidden_content_box;
  ]
