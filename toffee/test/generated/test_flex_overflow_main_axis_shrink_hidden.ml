  ...
  run "Toffee overflow_main_axis_shrink_hidden Test"
    [
      ( "flex_overflow_main_axis_shrink_hidden",
        [
          test_case "overflow_main_axis_shrink_hidden (border-box)" `Quick
            test_overflow_main_axis_shrink_hidden_border_box;
          test_case "overflow_main_axis_shrink_hidden (content-box)" `Quick
            test_overflow_main_axis_shrink_hidden_content_box;
        ] );
    ]
