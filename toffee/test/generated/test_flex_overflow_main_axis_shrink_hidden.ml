...
let test_flex_overflow_main_axis_shrink_hidden_border_box () =
  (* Setup test helpers *)
...
let test_flex_overflow_main_axis_shrink_hidden_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "overflow_main_axis_shrink_hidden (border-box)" `Quick
      test_flex_overflow_main_axis_shrink_hidden_border_box;
    test_case "overflow_main_axis_shrink_hidden (content-box)" `Quick
      test_flex_overflow_main_axis_shrink_hidden_content_box;
  ]
