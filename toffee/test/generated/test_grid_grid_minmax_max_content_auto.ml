  ...
  run "Toffee grid_minmax_max_content_auto Test"
    [
      ( "grid_grid_minmax_max_content_auto",
        [
          test_case "grid_minmax_max_content_auto (border-box)" `Quick
            test_grid_minmax_max_content_auto_border_box;
          test_case "grid_minmax_max_content_auto (content-box)" `Quick
            test_grid_minmax_max_content_auto_content_box;
        ] );
    ]
