...
let test_grid_auto_columns_border_box () =
  ...
  assert_eq ~msg:"width of node" 190.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"x of node2" 70.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node5" 130.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node7" 160.0 (Layout.location layout_result).x;
