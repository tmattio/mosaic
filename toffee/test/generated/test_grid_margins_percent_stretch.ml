(* Generated test for grid_margins_percent_stretch in grid layout *)
(* Do not edit this file directly. It is generated by gentest.js *)

open Toffee

let test_grid_margins_percent_stretch_border_box () =
  (* Setup test helpers *)
...
let test_grid_margins_percent_stretch_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "margins_percent_stretch (border-box)" `Quick
      test_grid_margins_percent_stretch_border_box;
    test_case "margins_percent_stretch (content-box)" `Quick
      test_grid_margins_percent_stretch_content_box;
  ]
