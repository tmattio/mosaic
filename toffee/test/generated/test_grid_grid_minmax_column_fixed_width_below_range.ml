...
(* Generated test for grid_minmax_column_fixed_width_below_range in grid layout *)
...
let test_grid_minmax_column_fixed_width_below_range_border_box () =
  (* Setup test helpers *)
...
let test_grid_minmax_column_fixed_width_below_range_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_minmax_column_fixed_width_below_range Test" [
    "grid_grid_minmax_column_fixed_width_below_range", [
      test_case "grid_minmax_column_fixed_width_below_range (border-box)" `Quick test_grid_minmax_column_fixed_width_below_range_border_box;
      test_case "grid_minmax_column_fixed_width_below_range (content-box)" `Quick test_grid_minmax_column_fixed_width_below_range_content_box;
    ];
  ]
