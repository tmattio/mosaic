...
let tests =
  let open Alcotest in
  [
    test_case "margin_y_simple_negative_percentage_other (border-box)" `Quick
      test_block_margin_y_simple_negative_percentage_other_border_box;
    test_case "margin_y_simple_negative_percentage_other (content-box)" `Quick
      test_block_margin_y_simple_negative_percentage_other_content_box;
  ]
