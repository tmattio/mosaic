    ...
    Toffee.new_leaf tree
      {
        ...
        size =
          {
            width = Toffee.Style.Dimension.length 50.0;
            height = Toffee.Style.Dimension.length 80.0;
          };
      }
  in
  ...
  run "Toffee grid_align_items_baseline_nested_column Test"
    [
      ( "grid_grid_align_items_baseline_nested_column",
        [
          test_case "grid_align_items_baseline_nested_column (border-box)"
            `Quick test_grid_align_items_baseline_nested_column_border_box;
          test_case "grid_align_items_baseline_nested_column (content-box)"
            `Quick test_grid_align_items_baseline_nested_column_content_box;
        ] );
    ]
