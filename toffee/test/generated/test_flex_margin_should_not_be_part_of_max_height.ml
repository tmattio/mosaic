...
let test_flex_margin_should_not_be_part_of_max_height_border_box () =
  (* Setup test helpers *)
...
let test_flex_margin_should_not_be_part_of_max_height_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "margin_should_not_be_part_of_max_height (border-box)" `Quick
      test_flex_margin_should_not_be_part_of_max_height_border_box;
    test_case "margin_should_not_be_part_of_max_height (content-box)" `Quick
      test_flex_margin_should_not_be_part_of_max_height_content_box;
  ]
