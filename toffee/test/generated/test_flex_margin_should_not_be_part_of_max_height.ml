        ...
        size =
          {
            ...
            height = Toffee.Style.Dimension.length 250.0;
          };
      }
  in
  let node0 =
  ...
  run "Toffee margin_should_not_be_part_of_max_height Test"
    [
      ( "flex_margin_should_not_be_part_of_max_height",
        [
          test_case "margin_should_not_be_part_of_max_height (border-box)"
            `Quick test_margin_should_not_be_part_of_max_height_border_box;
          test_case "margin_should_not_be_part_of_max_height (content-box)"
            `Quick test_margin_should_not_be_part_of_max_height_content_box;
        ] );
    ]
