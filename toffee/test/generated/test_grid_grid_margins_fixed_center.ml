    ...
    Toffee.new_leaf tree
      {
        ...
        margin =
          {
            left = Toffee.Style.Length_percentage_auto.Length 8.0;
            right = Toffee.Style.Length_percentage_auto.Length 4.0;
  ...
  run "Toffee grid_margins_fixed_center Test"
    [
      ( "grid_grid_margins_fixed_center",
        [
          test_case "grid_margins_fixed_center (border-box)" `Quick
            test_grid_margins_fixed_center_border_box;
          test_case "grid_margins_fixed_center (content-box)" `Quick
