...
let test_grid_margins_fixed_center_border_box () =
  ...
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with align_self = Some (Toffee.Style.Alignment.Center); justify_self = Some (Toffee.Style.Alignment.Center); size = { width = Toffee.Style.Dimension.length 20.0; height = Toffee.Style.Dimension.length 20.0 }; margin = { left = Toffee.Style.Length_percentage_auto.Length (8.0); right = Toffee.Style.Length_percentage_auto.Length (4.0); top = Toffee.Style.Length_percentage_auto.Length (2.0); bottom = Toffee.Style.Length_percentage_auto.Length (6.0) } }) in
...
let () =
  let open Alcotest in
  run "Toffee grid_margins_fixed_center Test" [
    "grid_grid_margins_fixed_center", [
      test_case "grid_margins_fixed_center (border-box)" `Quick test_grid_margins_fixed_center_border_box;
      test_case "grid_margins_fixed_center (content-box)" `Quick test_grid_margins_fixed_center_content_box;
    ];
  ]
