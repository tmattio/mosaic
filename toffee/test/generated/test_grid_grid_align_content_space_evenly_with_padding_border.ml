...
(* Generated test for grid_align_content_space_evenly_with_padding_border in grid layout *)
...
let test_grid_align_content_space_evenly_with_padding_border_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"y of node6" 116.0 layout.location.y;
  ...
  assert_eq ~msg:"y of node7" 116.0 layout.location.y;
  ...
  assert_eq ~msg:"y of node8" 116.0 layout.location.y;
  ()



let test_grid_align_content_space_evenly_with_padding_border_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  assert_eq ~msg:"height of node0" 40.0 layout.size.height;
  assert_eq ~msg:"x of node0" 48.0 layout.location.x;
  assert_eq ~msg:"y of node0" 32.0 layout.location.y;
  let layout = Toffee.layout tree node1 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 40.0 layout.size.width;
  assert_eq ~msg:"height of node1" 40.0 layout.size.height;
  assert_eq ~msg:"x of node1" 88.0 layout.location.x;
  assert_eq ~msg:"y of node1" 32.0 layout.location.y;
  let layout = Toffee.layout tree node2 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 40.0 layout.size.width;
  assert_eq ~msg:"height of node2" 40.0 layout.size.height;
  assert_eq ~msg:"x of node2" 128.0 layout.location.x;
  assert_eq ~msg:"y of node2" 32.0 layout.location.y;
  let layout = Toffee.layout tree node3 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node3" 40.0 layout.size.width;
  assert_eq ~msg:"height of node3" 40.0 layout.size.height;
  ...
  assert_eq ~msg:"height of node6" 40.0 layout.size.height;
  assert_eq ~msg:"x of node6" 48.0 layout.location.x;
  assert_eq ~msg:"y of node6" 152.0 layout.location.y;
  let layout = Toffee.layout tree node7 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node7" 40.0 layout.size.width;
  assert_eq ~msg:"height of node7" 40.0 layout.size.height;
  assert_eq ~msg:"x of node7" 88.0 layout.location.x;
  assert_eq ~msg:"y of node7" 152.0 layout.location.y;
  let layout = Toffee.layout tree node8 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node8" 40.0 layout.size.width;
  assert_eq ~msg:"height of node8" 40.0 layout.size.height;
  assert_eq ~msg:"x of node8" 128.0 layout.location.x;
  assert_eq ~msg:"y of node8" 152.0 layout.location.y;
  ()
...
let () =
  let open Alcotest in
  run "Toffee grid_align_content_space_evenly_with_padding_border Test" [
    "grid_grid_align_content_space_evenly_with_padding_border", [
      test_case "grid_align_content_space_evenly_with_padding_border (border-box)" `Quick test_grid_align_content_space_evenly_with_padding_border_border_box;
      test_case "grid_align_content_space_evenly_with_padding_border (content-box)" `Quick test_grid_align_content_space_evenly_with_padding_border_content_box;
    ];
  ]
