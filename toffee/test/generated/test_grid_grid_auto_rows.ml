...
let test_grid_auto_rows_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (100.0); max = Toffee.Style.Grid.Length (100.0) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }]; grid_auto_rows = [{ min = Toffee.Style.Grid.Length (10.0); max = Toffee.Style.Grid.Length (10.0) }; { min = Toffee.Style.Grid.Length (20.0); max = Toffee.Style.Grid.Length (20.0) }; { min = Toffee.Style.Grid.Length (30.0); max = Toffee.Style.Grid.Length (30.0) }] }) in
...
let test_grid_auto_rows_content_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (100.0); max = Toffee.Style.Grid.Length (100.0) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }]; grid_auto_rows = [{ min = Toffee.Style.Grid.Length (10.0); max = Toffee.Style.Grid.Length (10.0) }; { min = Toffee.Style.Grid.Length (20.0); max = Toffee.Style.Grid.Length (20.0) }; { min = Toffee.Style.Grid.Length (30.0); max = Toffee.Style.Grid.Length (30.0) }]; box_sizing = Toffee.Style.Content_box }) in
...
let () =
  let open Alcotest in
  run "Toffee grid_auto_rows Test" [
    "grid_grid_auto_rows", [
      test_case "grid_auto_rows (border-box)" `Quick test_grid_auto_rows_border_box;
      test_case "grid_auto_rows (content-box)" `Quick test_grid_auto_rows_content_box;
    ];
  ]
