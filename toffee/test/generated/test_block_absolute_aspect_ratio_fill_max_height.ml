...
let test_block_absolute_aspect_ratio_fill_max_height_border_box measure_function
    () =
  (* Setup test helpers *)
...
let tests =
  ...
  [
    test_case "absolute_aspect_ratio_fill_max_height (border-box)" `Quick
      (fun () ->
        test_block_absolute_aspect_ratio_fill_max_height_border_box
          measure_function ());
    test_case "absolute_aspect_ratio_fill_max_height (content-box)" `Quick
      (fun () ->
        test_block_absolute_aspect_ratio_fill_max_height_content_box
          measure_function ());
  ]
