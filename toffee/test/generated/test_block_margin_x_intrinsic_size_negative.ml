...
let test_block_margin_x_intrinsic_size_negative_border_box () =
  ...
  assert_eq ~msg:"width of node0" 15.0 (Layout.size layout_result).width;
...
let tests =
  let open Alcotest in
  [
    test_case "margin_x_intrinsic_size_negative (border-box)" `Quick
      test_block_margin_x_intrinsic_size_negative_border_box;
    test_case "margin_x_intrinsic_size_negative (content-box)" `Quick
      test_block_margin_x_intrinsic_size_negative_content_box;
  ]
