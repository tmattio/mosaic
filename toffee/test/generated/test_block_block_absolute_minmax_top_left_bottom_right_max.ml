  ...
  run "Toffee block_absolute_minmax_top_left_bottom_right_max Test"
    [
      ( "block_block_absolute_minmax_top_left_bottom_right_max",
        [
          test_case
            "block_absolute_minmax_top_left_bottom_right_max (border-box)"
            `Quick
            test_block_absolute_minmax_top_left_bottom_right_max_border_box;
          test_case
            "block_absolute_minmax_top_left_bottom_right_max (content-box)"
            `Quick
            test_block_absolute_minmax_top_left_bottom_right_max_content_box;
        ] );
    ]
