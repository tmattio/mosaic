...
let test_grid_align_items_baseline_complex_border_box () =
    ...
    Toffee.new_leaf tree
      {
        ...
        size =
          {
            width = Toffee.Style.Dimension.auto;
            height = Toffee.Style.Dimension.length 5.0;
          };
      }
  in
  ...
  assert_eq ~msg:"y of node10" 80.0 layout.location.y;
  let layout = Toffee.layout tree node11 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node11" 20.0 layout.size.width;
  ...
  run "Toffee grid_align_items_baseline_complex Test"
    [
      ( "grid_grid_align_items_baseline_complex",
        [
          test_case "grid_align_items_baseline_complex (border-box)" `Quick
            test_grid_align_items_baseline_complex_border_box;
          test_case "grid_align_items_baseline_complex (content-box)" `Quick
