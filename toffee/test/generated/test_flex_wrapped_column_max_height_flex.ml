...
let test_flex_wrapped_column_max_height_flex_border_box () =
  ...
  assert_eq ~msg:"x of node0" 300.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node2" 300.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node2" 400.0 (Layout.location layout_result).y;
  ()
