...
let test_flex_blitz_issue_88_border_box () =
  (* Setup test helpers *)
...
let test_flex_blitz_issue_88_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "blitz_issue_88 (border-box)" `Quick
      test_flex_blitz_issue_88_border_box;
    test_case "blitz_issue_88 (content-box)" `Quick
      test_flex_blitz_issue_88_content_box;
  ]
