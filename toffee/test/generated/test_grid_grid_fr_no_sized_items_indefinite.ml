...
let test_grid_fr_no_sized_items_indefinite_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 484.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 484.0 layout.size.width;
  assert_eq ~msg:"height of node2" 40.0 layout.size.height;
  assert_eq ~msg:"x of node2" 524.0 layout.location.x;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 484.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node5" 484.0 layout.size.width;
  assert_eq ~msg:"height of node5" 0.0 layout.size.height;
  assert_eq ~msg:"x of node5" 524.0 layout.location.x;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node7" 484.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node8" 484.0 layout.size.width;
  assert_eq ~msg:"height of node8" 0.0 layout.size.height;
  assert_eq ~msg:"x of node8" 524.0 layout.location.x;
  ...
  run "Toffee grid_fr_no_sized_items_indefinite Test"
    [
      ( "grid_grid_fr_no_sized_items_indefinite",
        [
          test_case "grid_fr_no_sized_items_indefinite (border-box)" `Quick
            test_grid_fr_no_sized_items_indefinite_border_box;
          test_case "grid_fr_no_sized_items_indefinite (content-box)" `Quick
