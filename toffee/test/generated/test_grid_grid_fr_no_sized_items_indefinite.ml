...
let test_grid_fr_no_sized_items_indefinite_content_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (1.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (1.0) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (1.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr (1.0) }]; box_sizing = Toffee.Style.Content_box }) in
...
let () =
  let open Alcotest in
  run "Toffee grid_fr_no_sized_items_indefinite Test" [
    "grid_grid_fr_no_sized_items_indefinite", [
      test_case "grid_fr_no_sized_items_indefinite (border-box)" `Quick test_grid_fr_no_sized_items_indefinite_border_box;
      test_case "grid_fr_no_sized_items_indefinite (content-box)" `Quick test_grid_fr_no_sized_items_indefinite_content_box;
    ];
  ]
