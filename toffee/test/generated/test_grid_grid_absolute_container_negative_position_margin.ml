...
(* Generated test for grid_absolute_container_negative_position_margin in grid layout *)
...
let test_grid_absolute_container_negative_position_margin_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"width of node" 180.0 layout.size.width;
  ...
  assert_eq ~msg:"x of node0" 193.0 layout.location.x;
  assert_eq ~msg:"y of node0" (-4.0) layout.location.y;
  ...
  assert_eq ~msg:"y of node1" 182.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node7" 120.0 layout.location.x;
  assert_eq ~msg:"y of node7" 50.0 layout.location.y;
...
let test_grid_absolute_container_negative_position_margin_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }]; padding = { left = Toffee.Style.Length_percentage.Length (40.0); right = Toffee.Style.Length_percentage.Length (20.0); top = Toffee.Style.Length_percentage.Length (10.0); bottom = Toffee.Style.Length_percentage.Length (30.0) }; box_sizing = Toffee.Style.Content_box }) in
...
let () =
  let open Alcotest in
  run "Toffee grid_absolute_container_negative_position_margin Test" [
    "grid_grid_absolute_container_negative_position_margin", [
      test_case "grid_absolute_container_negative_position_margin (border-box)" `Quick test_grid_absolute_container_negative_position_margin_border_box;
      test_case "grid_absolute_container_negative_position_margin (content-box)" `Quick test_grid_absolute_container_negative_position_margin_content_box;
    ];
  ]
