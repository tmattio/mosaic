...
let test_grid_absolute_container_negative_position_margin_border_box () =
    ...
    Toffee.new_leaf tree
      {
        ...
        inset =
          {
            left = Toffee.Style.Length_percentage_auto.Length (-35.0);
            right = Toffee.Style.Length_percentage_auto.Length 0.0;
            top = Toffee.Style.Length_percentage_auto.Length 0.0;
            bottom = Toffee.Style.Length_percentage_auto.Length (-25.0);
          };
      }
  in
  ...
  assert_eq ~msg:"x of node0" 1029.0 layout.location.x;
  ...
  assert_eq ~msg:"y of node1" 782.0 layout.location.y;
  ...
  run "Toffee grid_absolute_container_negative_position_margin Test"
    [
      ( "grid_grid_absolute_container_negative_position_margin",
        [
          test_case
            "grid_absolute_container_negative_position_margin (border-box)"
            `Quick
            test_grid_absolute_container_negative_position_margin_border_box;
          test_case
            "grid_absolute_container_negative_position_margin (content-box)"
            `Quick
            test_grid_absolute_container_negative_position_margin_content_box;
        ] );
    ]
