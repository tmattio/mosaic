...
let test_block_absolute_margin_auto_bottom_and_top_with_inset_border_box () =
  ...
  assert_eq ~msg:"y of node0" 346.0 layout.location.y;
  ()
  ...
  run "Toffee block_absolute_margin_auto_bottom_and_top_with_inset Test"
    [
      ( "block_block_absolute_margin_auto_bottom_and_top_with_inset",
        [
          test_case
            "block_absolute_margin_auto_bottom_and_top_with_inset (border-box)"
            `Quick
            test_block_absolute_margin_auto_bottom_and_top_with_inset_border_box;
          test_case
            "block_absolute_margin_auto_bottom_and_top_with_inset (content-box)"
            `Quick
            test_block_absolute_margin_auto_bottom_and_top_with_inset_content_box;
        ] );
    ]
