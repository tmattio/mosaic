...
(* Generated test for percentage_padding_should_calculate_based_only_on_width in flex layout *)
...
let test_percentage_padding_should_calculate_based_only_on_width_border_box () =
  ...
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with flex_direction = Toffee.Style.Flex.Column; flex_grow = 1.0; padding = { left = Toffee.Style.Length_percentage.Percent (0.1); right = Toffee.Style.Length_percentage.Percent (0.1); top = Toffee.Style.Length_percentage.Percent (0.1); bottom = Toffee.Style.Length_percentage.Percent (0.1) } }) in
...
let () =
  ...
  run "Toffee percentage_padding_should_calculate_based_only_on_width Test" [
    "flex_percentage_padding_should_calculate_based_only_on_width", [
      test_case "percentage_padding_should_calculate_based_only_on_width (border-box)" `Quick test_percentage_padding_should_calculate_based_only_on_width_border_box;
      test_case "percentage_padding_should_calculate_based_only_on_width (content-box)" `Quick test_percentage_padding_should_calculate_based_only_on_width_content_box;
    ];
  ]
