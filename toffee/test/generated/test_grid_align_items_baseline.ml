...
let tests =
  let open Alcotest in
  [
    test_case "align_items_baseline (border-box)" `Quick
      test_grid_align_items_baseline_border_box;
    test_case "align_items_baseline (content-box)" `Quick
      test_grid_align_items_baseline_content_box;
  ]
