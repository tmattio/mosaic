...
let test_block_margin_y_first_child_collapse_not_blocked_by_padding_bottom_border_box
  ...
  assert_eq ~msg:"height of node1" 11.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"height of node0" 21.0 (Layout.size layout_result).height;
...
let tests =
  ...
  [
    test_case
      "margin_y_first_child_collapse_not_blocked_by_padding_bottom (border-box)"
      `Quick
      test_block_margin_y_first_child_collapse_not_blocked_by_padding_bottom_border_box;
    test_case
      "margin_y_first_child_collapse_not_blocked_by_padding_bottom \
       (content-box)"
      `Quick
      test_block_margin_y_first_child_collapse_not_blocked_by_padding_bottom_content_box;
  ]
