...
let tests =
  let open Alcotest in
  [
    test_case "margin_x_fixed_auto_top (border-box)" `Quick
      test_block_margin_x_fixed_auto_top_border_box;
    test_case "margin_x_fixed_auto_top (content-box)" `Quick
      test_block_margin_x_fixed_auto_top_content_box;
  ]
