...
(* Generated test for overflow_main_axis_shrink_scroll in flex layout *)
...
let test_overflow_main_axis_shrink_scroll_border_box () =
  (* Setup test helpers *)
...
let test_overflow_main_axis_shrink_scroll_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee overflow_main_axis_shrink_scroll Test" [
    "flex_overflow_main_axis_shrink_scroll", [
      test_case "overflow_main_axis_shrink_scroll (border-box)" `Quick test_overflow_main_axis_shrink_scroll_border_box;
      test_case "overflow_main_axis_shrink_scroll (content-box)" `Quick test_overflow_main_axis_shrink_scroll_content_box;
    ];
  ]
