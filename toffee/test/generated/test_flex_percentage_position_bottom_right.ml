    ...
    Toffee.new_leaf tree
      {
        ...
        size =
          {
            width = Toffee.Style.Dimension.percent 0.55;
            height = Toffee.Style.Dimension.percent 0.15;
          };
        inset =
          {
            left = Toffee.Style.Length_percentage_auto.Length 0.0;
            right = Toffee.Style.Length_percentage_auto.Percent 0.2;
      ...
      ( "flex_percentage_position_bottom_right",
        [
          test_case "percentage_position_bottom_right (border-box)" `Quick
            test_percentage_position_bottom_right_border_box;
          test_case "percentage_position_bottom_right (content-box)" `Quick
            test_percentage_position_bottom_right_content_box;
        ] );
    ]
