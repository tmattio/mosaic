...
let test_flex_absolute_aspect_ratio_height_overrides_inset_border_box () =
  (* Setup test helpers *)
...
let test_flex_absolute_aspect_ratio_height_overrides_inset_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "absolute_aspect_ratio_height_overrides_inset (border-box)" `Quick
      test_flex_absolute_aspect_ratio_height_overrides_inset_border_box;
    test_case "absolute_aspect_ratio_height_overrides_inset (content-box)"
      `Quick test_flex_absolute_aspect_ratio_height_overrides_inset_content_box;
  ]
