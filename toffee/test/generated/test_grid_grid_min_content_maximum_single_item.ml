...
let test_grid_min_content_maximum_single_item_border_box () =
    ...
    Toffee.new_leaf tree
      {
        ...
        grid_template_columns =
          [
            ...
            Toffee.Style.Grid.Single
              {
                min = Toffee.Style.Grid.Length 0.0;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 23.0 layout.size.width;
  ...
  assert_eq ~msg:"x of node5" 63.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node8" 63.0 layout.location.x;
  ...
  run "Toffee grid_min_content_maximum_single_item Test"
    [
      ( "grid_grid_min_content_maximum_single_item",
        [
          test_case "grid_min_content_maximum_single_item (border-box)" `Quick
            test_grid_min_content_maximum_single_item_border_box;
          test_case "grid_min_content_maximum_single_item (content-box)" `Quick
            test_grid_min_content_maximum_single_item_content_box;
        ] );
    ]
