...
let test_block_margin_y_sibling_collapse_positive_and_negative_border_box () =
  ...
  assert_eq ~msg:"height of node" 90.0 layout.size.height;
  ...
  assert_eq ~msg:"y of node2" 35.0 layout.location.y;
  ...
  assert_eq ~msg:"y of node6" 70.0 layout.location.y;
  ()
...
let () =
  ...
  run "Toffee block_margin_y_sibling_collapse_positive_and_negative Test" [
    "block_block_margin_y_sibling_collapse_positive_and_negative", [
      test_case "block_margin_y_sibling_collapse_positive_and_negative (border-box)" `Quick test_block_margin_y_sibling_collapse_positive_and_negative_border_box;
      test_case "block_margin_y_sibling_collapse_positive_and_negative (content-box)" `Quick test_block_margin_y_sibling_collapse_positive_and_negative_content_box;
    ];
  ]
