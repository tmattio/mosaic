...
let test_block_absolute_layout_percentage_height_border_box () =
  ...
  assert_eq ~msg:"height of node0" 384.0 layout.size.height;
  ...
  run "Toffee block_absolute_layout_percentage_height Test"
    [
      ( "block_block_absolute_layout_percentage_height",
        [
          test_case "block_absolute_layout_percentage_height (border-box)"
            `Quick test_block_absolute_layout_percentage_height_border_box;
          test_case "block_absolute_layout_percentage_height (content-box)"
            `Quick test_block_absolute_layout_percentage_height_content_box;
        ] );
    ]
