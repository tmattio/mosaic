...
let tests =
  [
    Windtrap.test "align_baseline_child_top (border-box)"
      test_block_align_baseline_child_top_border_box;
    Windtrap.test "align_baseline_child_top (content-box)"
      test_block_align_baseline_child_top_content_box;
  ]
