...
let test_flex_align_items_center_with_max_height_with_align_content_flex_start_border_box
    () =
  (* Setup test helpers *)
...
let test_flex_align_items_center_with_max_height_with_align_content_flex_start_content_box
    () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
