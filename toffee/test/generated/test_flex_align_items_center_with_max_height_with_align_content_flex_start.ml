...
let () =
  let open Alcotest in
  run
    "Toffee align_items_center_with_max_height_with_align_content_flex_start \
     Test"
    [
        ...
        [
          test_case
            "align_items_center_with_max_height_with_align_content_flex_start \
             (border-box)"
            `Quick
            test_align_items_center_with_max_height_with_align_content_flex_start_border_box;
          test_case
            "align_items_center_with_max_height_with_align_content_flex_start \
             (content-box)"
            `Quick
            test_align_items_center_with_max_height_with_align_content_flex_start_content_box;
        ] );
    ]
