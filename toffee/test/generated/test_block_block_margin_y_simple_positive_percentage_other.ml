...
let test_block_margin_y_simple_positive_percentage_other_border_box () =
  ...
  assert_eq ~msg:"height of node" 121.0 layout.size.height;
  ...
  assert_eq ~msg:"y of node1" 111.0 layout.location.y;
  ()
  ...
  run "Toffee block_margin_y_simple_positive_percentage_other Test"
    [
      ( "block_block_margin_y_simple_positive_percentage_other",
        [
          test_case
            "block_margin_y_simple_positive_percentage_other (border-box)"
            `Quick
            test_block_margin_y_simple_positive_percentage_other_border_box;
          test_case
            "block_margin_y_simple_positive_percentage_other (content-box)"
            `Quick
            test_block_margin_y_simple_positive_percentage_other_content_box;
        ] );
    ]
