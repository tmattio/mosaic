...
let test_percentage_moderate_complexity2_border_box () =
  (* Setup test helpers *)
  ...
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with flex_direction = Toffee.Style.Flex.Column; size = { width = Toffee.Style.Dimension.percent 0.5; height = Toffee.Style.Dimension.auto }; padding = { left = Toffee.Style.Length_percentage.Percent (0.1); right = Toffee.Style.Length_percentage.Percent (0.1); top = Toffee.Style.Length_percentage.Percent (0.1); bottom = Toffee.Style.Length_percentage.Percent (0.1) } }) in
...
let test_percentage_moderate_complexity2_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with flex_direction = Toffee.Style.Flex.Column; size = { width = Toffee.Style.Dimension.percent 0.5; height = Toffee.Style.Dimension.auto }; padding = { left = Toffee.Style.Length_percentage.Percent (0.1); right = Toffee.Style.Length_percentage.Percent (0.1); top = Toffee.Style.Length_percentage.Percent (0.1); bottom = Toffee.Style.Length_percentage.Percent (0.1) }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee percentage_moderate_complexity2 Test" [
    "flex_percentage_moderate_complexity2", [
      test_case "percentage_moderate_complexity2 (border-box)" `Quick test_percentage_moderate_complexity2_border_box;
      test_case "percentage_moderate_complexity2 (content-box)" `Quick test_percentage_moderate_complexity2_content_box;
    ];
  ]
