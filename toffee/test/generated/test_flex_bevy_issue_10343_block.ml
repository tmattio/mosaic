...
let () =
  ...
  run "Toffee bevy_issue_10343_block Test" [
    "flex_bevy_issue_10343_block", [
      test_case "bevy_issue_10343_block (border-box)" `Quick test_bevy_issue_10343_block_border_box;
      test_case "bevy_issue_10343_block (content-box)" `Quick test_bevy_issue_10343_block_content_box;
    ];
  ]
