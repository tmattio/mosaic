  ...
  run "Toffee grid_minmax_max_content_1fr Test"
    [
      ( "grid_grid_minmax_max_content_1fr",
        [
          test_case "grid_minmax_max_content_1fr (border-box)" `Quick
            test_grid_minmax_max_content_1fr_border_box;
          test_case "grid_minmax_max_content_1fr (content-box)" `Quick
            test_grid_minmax_max_content_1fr_content_box;
        ] );
    ]
