...
let tests =
  let open Alcotest in
  [
    test_case "absolute_margin_auto_bottom_without_inset (border-box)" `Quick
      test_block_absolute_margin_auto_bottom_without_inset_border_box;
    test_case "absolute_margin_auto_bottom_without_inset (content-box)" `Quick
      test_block_absolute_margin_auto_bottom_without_inset_content_box;
  ]
