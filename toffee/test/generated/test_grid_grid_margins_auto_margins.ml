...
(* Generated test for grid_margins_auto_margins in grid layout *)
...
let test_grid_margins_auto_margins_border_box () =
  (* Setup test helpers *)
  ...
  let node6 = Toffee.new_leaf tree ({ Toffee.Style.default with align_self = Some (Toffee.Style.Alignment.Start); justify_self = Some (Toffee.Style.Alignment.Start); size = { width = Toffee.Style.Dimension.length 20.0; height = Toffee.Style.Dimension.length 20.0 }; margin = { left = Toffee.Style.Length_percentage_auto.Auto; right = Toffee.Style.Length_percentage_auto.Auto; top = Toffee.Style.Length_percentage_auto.Auto; bottom = Toffee.Style.Length_percentage_auto.Auto } }) in
  ...
  assert_eq ~msg:"x of node2" 130.0 layout.location.x;
  ...
  assert_eq ~msg:"y of node6" 100.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node8" 120.0 layout.location.x;
  assert_eq ~msg:"y of node8" 90.0 layout.location.y;
  ()



let test_grid_margins_auto_margins_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_margins_auto_margins Test" [
    "grid_grid_margins_auto_margins", [
      test_case "grid_margins_auto_margins (border-box)" `Quick test_grid_margins_auto_margins_border_box;
      test_case "grid_margins_auto_margins (content-box)" `Quick test_grid_margins_auto_margins_content_box;
    ];
  ]
