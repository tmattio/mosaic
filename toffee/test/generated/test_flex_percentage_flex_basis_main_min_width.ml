    ...
    Toffee.new_leaf tree
      {
        ...
        min_size =
          {
            width = Toffee.Style.Dimension.percent 0.2;
            height = Toffee.Style.Dimension.auto;
          };
      }
  in
  ...
  run "Toffee percentage_flex_basis_main_min_width Test"
    [
      ( "flex_percentage_flex_basis_main_min_width",
        [
          test_case "percentage_flex_basis_main_min_width (border-box)" `Quick
            test_percentage_flex_basis_main_min_width_border_box;
          test_case "percentage_flex_basis_main_min_width (content-box)" `Quick
            test_percentage_flex_basis_main_min_width_content_box;
        ] );
    ]
