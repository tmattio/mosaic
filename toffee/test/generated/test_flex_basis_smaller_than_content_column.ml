...
let tests =
  let open Alcotest in
  [
    test_case "basis_smaller_than_content_column (border-box)" `Quick
      test_flex_basis_smaller_than_content_column_border_box;
    test_case "basis_smaller_than_content_column (content-box)" `Quick
      test_flex_basis_smaller_than_content_column_content_box;
  ]
