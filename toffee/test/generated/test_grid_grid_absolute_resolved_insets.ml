...
let test_grid_absolute_resolved_insets_border_box () =
  ...
  let node7 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; position = Toffee.Style.Relative; size = { width = Toffee.Style.Dimension.length 200.0; height = Toffee.Style.Dimension.length 200.0 }; padding = { left = Toffee.Style.Length_percentage.Length (15.0); right = Toffee.Style.Length_percentage.Length (15.0); top = Toffee.Style.Length_percentage.Length (15.0); bottom = Toffee.Style.Length_percentage.Length (15.0) }; border = { left = Toffee.Style.Length_percentage.Length (20.0); right = Toffee.Style.Length_percentage.Length (20.0); top = Toffee.Style.Length_percentage.Length (20.0); bottom = Toffee.Style.Length_percentage.Length (20.0) } }) in
  ...
  assert_eq ~msg:"x of node8" 20.0 layout.location.x;
...
let test_grid_absolute_resolved_insets_content_box () =
  ...
  let layout = Toffee.layout tree node in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node" 540.0 layout.size.width;
...
let () =
  let open Alcotest in
  run "Toffee grid_absolute_resolved_insets Test" [
    "grid_grid_absolute_resolved_insets", [
      test_case "grid_absolute_resolved_insets (border-box)" `Quick test_grid_absolute_resolved_insets_border_box;
      test_case "grid_absolute_resolved_insets (content-box)" `Quick test_grid_absolute_resolved_insets_content_box;
    ];
  ]
