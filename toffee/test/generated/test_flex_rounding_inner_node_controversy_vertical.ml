...
let test_flex_rounding_inner_node_controversy_vertical_border_box () =
  ...
  assert_eq ~msg:"height of node1" 107.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"y of node2" 107.0 (Layout.location layout_result).y;
  let layout_result = layout tree node4 |> Result.get_ok in
  assert_eq ~msg:"width of node4" 10.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node4" 107.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node4" 0.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node4" 213.0 (Layout.location layout_result).y;
