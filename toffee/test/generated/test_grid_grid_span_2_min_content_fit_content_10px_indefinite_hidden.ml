...
(* Generated test for grid_span_2_min_content_fit_content_10px_indefinite_hidden in grid layout *)
...
let test_grid_span_2_min_content_fit_content_10px_indefinite_hidden_border_box () =
  (* Setup test helpers *)
...
let test_grid_span_2_min_content_fit_content_10px_indefinite_hidden_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_span_2_min_content_fit_content_10px_indefinite_hidden Test" [
    "grid_grid_span_2_min_content_fit_content_10px_indefinite_hidden", [
      test_case "grid_span_2_min_content_fit_content_10px_indefinite_hidden (border-box)" `Quick test_grid_span_2_min_content_fit_content_10px_indefinite_hidden_border_box;
      test_case "grid_span_2_min_content_fit_content_10px_indefinite_hidden (content-box)" `Quick test_grid_span_2_min_content_fit_content_10px_indefinite_hidden_content_box;
    ];
  ]
