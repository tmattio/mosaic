...
let tests =
  ...
  [
    test_case
      "basis_smaller_then_content_with_flex_grow_small_size (border-box)" `Quick
      test_flex_basis_smaller_then_content_with_flex_grow_small_size_border_box;
    test_case
      "basis_smaller_then_content_with_flex_grow_small_size (content-box)"
      `Quick
      test_flex_basis_smaller_then_content_with_flex_grow_small_size_content_box;
  ]
