...
let test_grid_absolute_with_padding_and_margin_border_box () =
  ...
  assert_eq ~msg:"x of node1" 178.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node2" 14.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node2" 147.0 (Layout.location layout_result).y;
...
let tests =
  let open Alcotest in
  [
    test_case "absolute_with_padding_and_margin (border-box)" `Quick
      test_grid_absolute_with_padding_and_margin_border_box;
    test_case "absolute_with_padding_and_margin (content-box)" `Quick
