...
let test_flex_measure_height_overrides_measure_border_box measure_function () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"height of node1" 5.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"height of node0" 5.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node0" 0.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node0" 0.0 (Layout.location layout_result).y;
  ()

let test_flex_measure_height_overrides_measure_content_box measure_function () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "measure_height_overrides_measure (border-box)" `Quick (fun () ->
        test_flex_measure_height_overrides_measure_border_box measure_function
          ());
    test_case "measure_height_overrides_measure (content-box)" `Quick (fun () ->
        test_flex_measure_height_overrides_measure_content_box measure_function
          ());
  ]
