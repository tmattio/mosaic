...
let tests =
  let open Alcotest in
  [
    test_case "align_items_sized_stretch (border-box)" `Quick
      test_grid_align_items_sized_stretch_border_box;
    test_case "align_items_sized_stretch (content-box)" `Quick
      test_grid_align_items_sized_stretch_content_box;
  ]
