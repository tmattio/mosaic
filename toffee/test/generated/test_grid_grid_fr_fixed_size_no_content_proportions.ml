...
(* Generated test for grid_fr_fixed_size_no_content_proportions in grid layout *)
...
let test_grid_fr_fixed_size_no_content_proportions_border_box () =
  (* Setup test helpers *)
...
let test_grid_fr_fixed_size_no_content_proportions_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_fr_fixed_size_no_content_proportions Test" [
    "grid_grid_fr_fixed_size_no_content_proportions", [
      test_case "grid_fr_fixed_size_no_content_proportions (border-box)" `Quick test_grid_fr_fixed_size_no_content_proportions_border_box;
      test_case "grid_fr_fixed_size_no_content_proportions (content-box)" `Quick test_grid_fr_fixed_size_no_content_proportions_content_box;
    ];
  ]
