...
let test_flex_align_content_space_evenly_single_line_border_box () =
  (* Setup test helpers *)
  ...
  let node =
    new_leaf tree
      (Style.make ~display:Style.Display.Flex
         ~flex_direction:Style.Flex_direction.Row ~align_content:Space_evenly
         ~size:
           {
...
let test_flex_align_content_space_evenly_single_line_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "align_content_space_evenly_single_line (border-box)" `Quick
      test_flex_align_content_space_evenly_single_line_border_box;
    test_case "align_content_space_evenly_single_line (content-box)" `Quick
      test_flex_align_content_space_evenly_single_line_content_box;
  ]
