...
(* Generated test for grid_fit_content_percent_definite_argument in grid layout *)
...
let test_grid_fit_content_percent_definite_argument_border_box () =
  (* Setup test helpers *)
...
let test_grid_fit_content_percent_definite_argument_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_fit_content_percent_definite_argument Test" [
    "grid_grid_fit_content_percent_definite_argument", [
      test_case "grid_fit_content_percent_definite_argument (border-box)" `Quick test_grid_fit_content_percent_definite_argument_border_box;
      test_case "grid_fit_content_percent_definite_argument (content-box)" `Quick test_grid_fit_content_percent_definite_argument_content_box;
    ];
  ]
