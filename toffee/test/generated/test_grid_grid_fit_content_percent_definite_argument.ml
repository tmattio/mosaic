  ...
  run "Toffee grid_fit_content_percent_definite_argument Test"
    [
      ( "grid_grid_fit_content_percent_definite_argument",
        [
          test_case "grid_fit_content_percent_definite_argument (border-box)"
            `Quick test_grid_fit_content_percent_definite_argument_border_box;
          test_case "grid_fit_content_percent_definite_argument (content-box)"
            `Quick test_grid_fit_content_percent_definite_argument_content_box;
        ] );
    ]
