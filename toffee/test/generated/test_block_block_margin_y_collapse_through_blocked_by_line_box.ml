...
let () =
  let open Alcotest in
  run "Toffee block_margin_y_collapse_through_blocked_by_line_box Test" [
    "block_block_margin_y_collapse_through_blocked_by_line_box", [
      test_case "block_margin_y_collapse_through_blocked_by_line_box (border-box)" `Quick test_block_margin_y_collapse_through_blocked_by_line_box_border_box;
      test_case "block_margin_y_collapse_through_blocked_by_line_box (content-box)" `Quick test_block_margin_y_collapse_through_blocked_by_line_box_content_box;
    ];
  ]
