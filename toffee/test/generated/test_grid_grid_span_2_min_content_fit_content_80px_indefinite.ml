...
(* Generated test for grid_span_2_min_content_fit_content_80px_indefinite in grid layout *)
...
let test_grid_span_2_min_content_fit_content_80px_indefinite_border_box () =
  (* Setup test helpers *)
...
let test_grid_span_2_min_content_fit_content_80px_indefinite_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_span_2_min_content_fit_content_80px_indefinite Test" [
    "grid_grid_span_2_min_content_fit_content_80px_indefinite", [
      test_case "grid_span_2_min_content_fit_content_80px_indefinite (border-box)" `Quick test_grid_span_2_min_content_fit_content_80px_indefinite_border_box;
      test_case "grid_span_2_min_content_fit_content_80px_indefinite (content-box)" `Quick test_grid_span_2_min_content_fit_content_80px_indefinite_content_box;
    ];
  ]
