...
let test_grid_span_2_min_content_fit_content_80px_indefinite_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 92.0 layout.size.width;
  ...
  run "Toffee grid_span_2_min_content_fit_content_80px_indefinite Test"
    [
      ( "grid_grid_span_2_min_content_fit_content_80px_indefinite",
        [
          test_case
            "grid_span_2_min_content_fit_content_80px_indefinite (border-box)"
            `Quick
            test_grid_span_2_min_content_fit_content_80px_indefinite_border_box;
          test_case
            "grid_span_2_min_content_fit_content_80px_indefinite (content-box)"
            `Quick
