...
let test_flex_gap_column_gap_inflexible_border_box () =
  (* Setup test helpers *)
...
let test_flex_gap_column_gap_inflexible_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "gap_column_gap_inflexible (border-box)" `Quick
      test_flex_gap_column_gap_inflexible_border_box;
    test_case "gap_column_gap_inflexible (content-box)" `Quick
      test_flex_gap_column_gap_inflexible_content_box;
  ]
