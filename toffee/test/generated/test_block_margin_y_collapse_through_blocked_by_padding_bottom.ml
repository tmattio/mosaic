...
let test_block_margin_y_collapse_through_blocked_by_padding_bottom_border_box ()
  ...
  assert_eq ~msg:"height of node2" 1.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"y of node3" 31.0 (Layout.location layout_result).y;
...
let tests =
  let open Alcotest in
  [
    test_case "margin_y_collapse_through_blocked_by_padding_bottom (border-box)"
      `Quick
      test_block_margin_y_collapse_through_blocked_by_padding_bottom_border_box;
    test_case
      "margin_y_collapse_through_blocked_by_padding_bottom (content-box)" `Quick
      test_block_margin_y_collapse_through_blocked_by_padding_bottom_content_box;
  ]
