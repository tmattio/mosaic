...
let test_grid_fit_content_percent_indefinite_min_content_hidden_border_box
  ...
  in
  let _ =
    set_node_context tree node1 (Some (MeasureFunction.Text "HHHH​HH"))
    |> Result.get_ok
  in
  let node0 =
...
let tests =
  let open Alcotest in
  [
    test_case "fit_content_percent_indefinite_min_content_hidden (border-box)"
      `Quick (fun () ->
        test_grid_fit_content_percent_indefinite_min_content_hidden_border_box
          measure_function ());
    test_case "fit_content_percent_indefinite_min_content_hidden (content-box)"
      `Quick (fun () ->
        test_grid_fit_content_percent_indefinite_min_content_hidden_content_box
          measure_function ());
  ]
