...
(* Generated test for grid_max_content_single_item_span_2_gap_percent_definite in grid layout *)
...
let test_grid_max_content_single_item_span_2_gap_percent_definite_border_box () =
  (* Setup test helpers *)
  ...
  let _ = Toffee.set_node_context tree node1 (MeasureFunction.Fixed {width = 80.0; height = 10.0}) |> Result.get_ok in
  ...
  assert_eq ~msg:"x of node6" 60.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node7" 100.0 layout.location.x;
...
let test_grid_max_content_single_item_span_2_gap_percent_definite_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_max_content_single_item_span_2_gap_percent_definite Test" [
    "grid_grid_max_content_single_item_span_2_gap_percent_definite", [
      test_case "grid_max_content_single_item_span_2_gap_percent_definite (border-box)" `Quick test_grid_max_content_single_item_span_2_gap_percent_definite_border_box;
      test_case "grid_max_content_single_item_span_2_gap_percent_definite (content-box)" `Quick test_grid_max_content_single_item_span_2_gap_percent_definite_content_box;
    ];
  ]
