  ...
  run "Toffee block_display_none_with_margin Test"
    [
      ( "block_block_display_none_with_margin",
        [
          test_case "block_display_none_with_margin (border-box)" `Quick
            test_block_display_none_with_margin_border_box;
          test_case "block_display_none_with_margin (content-box)" `Quick
            test_block_display_none_with_margin_content_box;
        ] );
    ]
