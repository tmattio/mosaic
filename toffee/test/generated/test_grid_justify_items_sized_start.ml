...
let tests =
  let open Alcotest in
  [
    test_case "justify_items_sized_start (border-box)" `Quick
      test_grid_justify_items_sized_start_border_box;
    test_case "justify_items_sized_start (content-box)" `Quick
      test_grid_justify_items_sized_start_content_box;
  ]
