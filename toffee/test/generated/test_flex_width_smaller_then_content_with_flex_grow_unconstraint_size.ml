        ...
        [
          test_case
            "width_smaller_then_content_with_flex_grow_unconstraint_size \
             (border-box)"
            `Quick
            test_width_smaller_then_content_with_flex_grow_unconstraint_size_border_box;
          test_case
            "width_smaller_then_content_with_flex_grow_unconstraint_size \
             (content-box)"
            `Quick
            test_width_smaller_then_content_with_flex_grow_unconstraint_size_content_box;
        ] );
    ]
