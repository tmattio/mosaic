        ...
        size =
          {
            ...
            height = Toffee.Style.Dimension.length 36.0;
          };
      }
  in
  ...
  run "Toffee align_items_stretch_min_cross Test"
    [
      ( "flex_align_items_stretch_min_cross",
        [
          test_case "align_items_stretch_min_cross (border-box)" `Quick
            test_align_items_stretch_min_cross_border_box;
          test_case "align_items_stretch_min_cross (content-box)" `Quick
            test_align_items_stretch_min_cross_content_box;
        ] );
    ]
