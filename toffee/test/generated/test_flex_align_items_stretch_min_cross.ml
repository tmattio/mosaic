...
let test_flex_align_items_stretch_min_cross_border_box () =
  (* Setup test helpers *)
...
let test_flex_align_items_stretch_min_cross_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "align_items_stretch_min_cross (border-box)" `Quick
      test_flex_align_items_stretch_min_cross_border_box;
    test_case "align_items_stretch_min_cross (content-box)" `Quick
      test_flex_align_items_stretch_min_cross_content_box;
  ]
