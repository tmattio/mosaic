...
let test_flex_measure_child_with_flex_shrink_border_box () =
  (* Setup test helpers *)
...
let test_flex_measure_child_with_flex_shrink_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "measure_child_with_flex_shrink (border-box)" `Quick
      test_flex_measure_child_with_flex_shrink_border_box;
    test_case "measure_child_with_flex_shrink (content-box)" `Quick
      test_flex_measure_child_with_flex_shrink_content_box;
  ]
