...
(* Generated test for measure_child_with_flex_shrink in flex layout *)
...
let test_measure_child_with_flex_shrink_border_box () =
  (* Setup test helpers *)
...
let test_measure_child_with_flex_shrink_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee measure_child_with_flex_shrink Test" [
    "flex_measure_child_with_flex_shrink", [
      test_case "measure_child_with_flex_shrink (border-box)" `Quick test_measure_child_with_flex_shrink_border_box;
      test_case "measure_child_with_flex_shrink (content-box)" `Quick test_measure_child_with_flex_shrink_content_box;
    ];
  ]
