...
let test_measure_child_with_flex_grow_border_box () =
  (* Setup test helpers *)
...
let test_measure_child_with_flex_grow_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee measure_child_with_flex_grow Test" [
    "flex_measure_child_with_flex_grow", [
      test_case "measure_child_with_flex_grow (border-box)" `Quick test_measure_child_with_flex_grow_border_box;
      test_case "measure_child_with_flex_grow (content-box)" `Quick test_measure_child_with_flex_grow_content_box;
    ];
  ]
