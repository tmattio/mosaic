...
let test_grid_fr_span_2_proportion_sub_1_sum_border_box () =
  ...
  assert_eq ~msg:"x of node3" 24.0 (Layout.location layout_result).x;
...
let tests =
  let open Alcotest in
  [
    test_case "fr_span_2_proportion_sub_1_sum (border-box)" `Quick
      test_grid_fr_span_2_proportion_sub_1_sum_border_box;
    test_case "fr_span_2_proportion_sub_1_sum (content-box)" `Quick
