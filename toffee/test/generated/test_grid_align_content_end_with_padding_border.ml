...
let test_grid_align_content_end_with_padding_border_border_box () =
  ...
  assert_eq ~msg:"y of node1" 44.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node2" 44.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node3" 44.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node4" 84.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node5" 84.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node6" 84.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node7" 124.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node8" 124.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node9" 124.0 (Layout.location layout_result).y;
...
let test_grid_align_content_end_with_padding_border_content_box () =
  ...
  assert_eq ~msg:"height of node1" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node1" 48.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node1" 92.0 (Layout.location layout_result).y;
  let layout_result = layout tree node2 |> Result.get_ok in
  assert_eq ~msg:"width of node2" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node2" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 88.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node2" 92.0 (Layout.location layout_result).y;
  let layout_result = layout tree node3 |> Result.get_ok in
  assert_eq ~msg:"width of node3" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node3" 128.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"height of node4" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node4" 48.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node4" 132.0 (Layout.location layout_result).y;
  let layout_result = layout tree node5 |> Result.get_ok in
  assert_eq ~msg:"width of node5" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node5" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node5" 88.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node5" 132.0 (Layout.location layout_result).y;
  let layout_result = layout tree node6 |> Result.get_ok in
  assert_eq ~msg:"width of node6" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node6" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node6" 128.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node6" 132.0 (Layout.location layout_result).y;
  let layout_result = layout tree node7 |> Result.get_ok in
  assert_eq ~msg:"width of node7" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node7" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node7" 48.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node7" 172.0 (Layout.location layout_result).y;
  let layout_result = layout tree node8 |> Result.get_ok in
  assert_eq ~msg:"width of node8" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node8" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node8" 88.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node8" 172.0 (Layout.location layout_result).y;
  let layout_result = layout tree node9 |> Result.get_ok in
  assert_eq ~msg:"width of node9" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node9" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node9" 128.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node9" 172.0 (Layout.location layout_result).y;
  let layout_result = layout tree node0 |> Result.get_ok in
...
let tests =
  let open Alcotest in
  [
    test_case "align_content_end_with_padding_border (border-box)" `Quick
      test_grid_align_content_end_with_padding_border_border_box;
    test_case "align_content_end_with_padding_border (content-box)" `Quick
      test_grid_align_content_end_with_padding_border_content_box;
  ]
