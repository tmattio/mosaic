...
let tests =
  let open Alcotest in
  [
    test_case "margin_y_first_child_collapse_blocked_by_border_top (border-box)"
      `Quick
      test_block_margin_y_first_child_collapse_blocked_by_border_top_border_box;
    test_case
      "margin_y_first_child_collapse_blocked_by_border_top (content-box)" `Quick
      test_block_margin_y_first_child_collapse_blocked_by_border_top_content_box;
  ]
