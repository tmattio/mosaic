(* Generated test for grid_span_2_max_content_fit_content_80px_indefinite_hidden in grid layout *)
(* Do not edit this file directly. It is generated by gentest.js *)

open Toffee

let test_grid_span_2_max_content_fit_content_80px_indefinite_hidden_border_box
    () =
  (* Setup test helpers *)
           ...
           [
             ...
             Style.Grid.Template_component.single
               (Style.Grid.Track_sizing_function.fit_content
                  (Style.Compact_length.fit_content_px 80.0));
           ]
         ~grid_template_rows:
           [
             Style.Grid.Template_component.single
...
let test_grid_span_2_max_content_fit_content_80px_indefinite_hidden_content_box
    () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
...
let tests =
  ...
  [
    test_case
      "span_2_max_content_fit_content_80px_indefinite_hidden (border-box)"
      `Quick
      test_grid_span_2_max_content_fit_content_80px_indefinite_hidden_border_box;
    test_case
      "span_2_max_content_fit_content_80px_indefinite_hidden (content-box)"
      `Quick
      test_grid_span_2_max_content_fit_content_80px_indefinite_hidden_content_box;
  ]
