...
let test_flex_measure_flex_basis_overrides_measure_border_box measure_function
    () =
  (* Setup test helpers *)
...
let test_flex_measure_flex_basis_overrides_measure_content_box measure_function
    () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
...
let tests =
  ...
  [
    test_case "measure_flex_basis_overrides_measure (border-box)" `Quick
      (fun () ->
        test_flex_measure_flex_basis_overrides_measure_border_box
          measure_function ());
    test_case "measure_flex_basis_overrides_measure (content-box)" `Quick
      (fun () ->
        test_flex_measure_flex_basis_overrides_measure_content_box
          measure_function ());
  ]
