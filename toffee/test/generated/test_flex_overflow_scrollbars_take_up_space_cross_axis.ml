...
let test_flex_overflow_scrollbars_take_up_space_cross_axis_border_box () =
  (* Setup test helpers *)
...
let test_flex_overflow_scrollbars_take_up_space_cross_axis_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "overflow_scrollbars_take_up_space_cross_axis (border-box)" `Quick
      test_flex_overflow_scrollbars_take_up_space_cross_axis_border_box;
    test_case "overflow_scrollbars_take_up_space_cross_axis (content-box)"
      `Quick test_flex_overflow_scrollbars_take_up_space_cross_axis_content_box;
  ]
