        ...
        inset =
          {
            ...
            right = Toffee.Style.Length_percentage_auto.Length 6.0;
            top = Toffee.Style.Length_percentage_auto.Auto;
            bottom = Toffee.Style.Length_percentage_auto.Length 8.0;
          };
      }
  in
  ...
  run "Toffee block_inset_fixed Test"
    [
      ( "block_block_inset_fixed",
        [
          test_case "block_inset_fixed (border-box)" `Quick
            test_block_inset_fixed_border_box;
          test_case "block_inset_fixed (content-box)" `Quick
