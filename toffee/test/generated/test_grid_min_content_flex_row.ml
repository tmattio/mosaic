...
let tests =
  let open Alcotest in
  [
    test_case "min_content_flex_row (border-box)" `Quick
      test_grid_min_content_flex_row_border_box;
    test_case "min_content_flex_row (content-box)" `Quick
      test_grid_min_content_flex_row_content_box;
  ]
