...
let test_grid_justify_content_space_around_with_padding_border_border_box () =
  ...
  assert_eq ~msg:"x of node0" 53.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node2" 187.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node3" 53.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node5" 187.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node6" 53.0 layout.location.x;
