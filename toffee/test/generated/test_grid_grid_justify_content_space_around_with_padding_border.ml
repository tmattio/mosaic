...
let test_grid_justify_content_space_around_with_padding_border_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }]; justify_content = Some (Toffee.Style.Alignment.Space_around); size = { width = Toffee.Style.Dimension.length 200.0; height = Toffee.Style.Dimension.length 200.0 }; padding = { left = Toffee.Style.Length_percentage.Length (40.0); right = Toffee.Style.Length_percentage.Length (20.0); top = Toffee.Style.Length_percentage.Length (10.0); bottom = Toffee.Style.Length_percentage.Length (30.0) }; border = { left = Toffee.Style.Length_percentage.Length (8.0); right = Toffee.Style.Length_percentage.Length (4.0); top = Toffee.Style.Length_percentage.Length (2.0); bottom = Toffee.Style.Length_percentage.Length (6.0) } }) in
  ...
  assert_eq ~msg:"x of node0" 49.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node1" 92.0 layout.location.x;
  ...
  assert_eq ~msg:"y of node2" 12.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node3" 49.0 layout.location.x;
  assert_eq ~msg:"y of node3" 52.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node4" 92.0 layout.location.x;
  assert_eq ~msg:"y of node4" 52.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node5" 135.0 layout.location.x;
  assert_eq ~msg:"y of node5" 52.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node6" 49.0 layout.location.x;
  assert_eq ~msg:"y of node6" 92.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node7" 92.0 layout.location.x;
  assert_eq ~msg:"y of node7" 92.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node8" 135.0 layout.location.x;
  assert_eq ~msg:"y of node8" 92.0 layout.location.y;
  ()
...
let test_grid_justify_content_space_around_with_padding_border_content_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }]; justify_content = Some (Toffee.Style.Alignment.Space_around); size = { width = Toffee.Style.Dimension.length 200.0; height = Toffee.Style.Dimension.length 200.0 }; padding = { left = Toffee.Style.Length_percentage.Length (40.0); right = Toffee.Style.Length_percentage.Length (20.0); top = Toffee.Style.Length_percentage.Length (10.0); bottom = Toffee.Style.Length_percentage.Length (30.0) }; border = { left = Toffee.Style.Length_percentage.Length (8.0); right = Toffee.Style.Length_percentage.Length (4.0); top = Toffee.Style.Length_percentage.Length (2.0); bottom = Toffee.Style.Length_percentage.Length (6.0) }; box_sizing = Toffee.Style.Content_box }) in
  ...
  let layout = Toffee.layout tree node in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node" 272.0 layout.size.width;
  assert_eq ~msg:"height of node" 248.0 layout.size.height;
  assert_eq ~msg:"x of node" 0.0 layout.location.x;
  assert_eq ~msg:"y of node" 0.0 layout.location.y;
  let layout = Toffee.layout tree node0 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 40.0 layout.size.width;
  assert_eq ~msg:"height of node0" 40.0 layout.size.height;
  assert_eq ~msg:"x of node0" 61.0 layout.location.x;
  assert_eq ~msg:"y of node0" 12.0 layout.location.y;
  let layout = Toffee.layout tree node1 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 40.0 layout.size.width;
  assert_eq ~msg:"height of node1" 40.0 layout.size.height;
  assert_eq ~msg:"x of node1" 128.0 layout.location.x;
  assert_eq ~msg:"y of node1" 12.0 layout.location.y;
  let layout = Toffee.layout tree node2 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 40.0 layout.size.width;
  assert_eq ~msg:"height of node2" 40.0 layout.size.height;
  assert_eq ~msg:"x of node2" 195.0 layout.location.x;
  assert_eq ~msg:"y of node2" 12.0 layout.location.y;
  let layout = Toffee.layout tree node3 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node3" 40.0 layout.size.width;
  assert_eq ~msg:"height of node3" 40.0 layout.size.height;
  assert_eq ~msg:"x of node3" 61.0 layout.location.x;
  assert_eq ~msg:"y of node3" 52.0 layout.location.y;
  let layout = Toffee.layout tree node4 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 40.0 layout.size.width;
  assert_eq ~msg:"height of node4" 40.0 layout.size.height;
  assert_eq ~msg:"x of node4" 128.0 layout.location.x;
  assert_eq ~msg:"y of node4" 52.0 layout.location.y;
  let layout = Toffee.layout tree node5 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node5" 40.0 layout.size.width;
  assert_eq ~msg:"height of node5" 40.0 layout.size.height;
  assert_eq ~msg:"x of node5" 195.0 layout.location.x;
  assert_eq ~msg:"y of node5" 52.0 layout.location.y;
  let layout = Toffee.layout tree node6 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node6" 40.0 layout.size.width;
  assert_eq ~msg:"height of node6" 40.0 layout.size.height;
  assert_eq ~msg:"x of node6" 61.0 layout.location.x;
  assert_eq ~msg:"y of node6" 92.0 layout.location.y;
  let layout = Toffee.layout tree node7 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node7" 40.0 layout.size.width;
  assert_eq ~msg:"height of node7" 40.0 layout.size.height;
  assert_eq ~msg:"x of node7" 128.0 layout.location.x;
  assert_eq ~msg:"y of node7" 92.0 layout.location.y;
  let layout = Toffee.layout tree node8 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node8" 40.0 layout.size.width;
  assert_eq ~msg:"height of node8" 40.0 layout.size.height;
  assert_eq ~msg:"x of node8" 195.0 layout.location.x;
  assert_eq ~msg:"y of node8" 92.0 layout.location.y;
  ()
...
let () =
  let open Alcotest in
  run "Toffee grid_justify_content_space_around_with_padding_border Test" [
    "grid_grid_justify_content_space_around_with_padding_border", [
      test_case "grid_justify_content_space_around_with_padding_border (border-box)" `Quick test_grid_justify_content_space_around_with_padding_border_border_box;
      test_case "grid_justify_content_space_around_with_padding_border (content-box)" `Quick test_grid_justify_content_space_around_with_padding_border_content_box;
    ];
  ]
