...
let test_grid_fr_span_2_proportion_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 336.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 672.0 layout.size.width;
  assert_eq ~msg:"height of node2" 40.0 layout.size.height;
  assert_eq ~msg:"x of node2" 336.0 layout.location.x;
  ...
  run "Toffee grid_fr_span_2_proportion Test"
    [
      ( "grid_grid_fr_span_2_proportion",
        [
          test_case "grid_fr_span_2_proportion (border-box)" `Quick
            test_grid_fr_span_2_proportion_border_box;
          test_case "grid_fr_span_2_proportion (content-box)" `Quick
            test_grid_fr_span_2_proportion_content_box;
        ] );
    ]
