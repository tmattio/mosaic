...
let test_grid_minmax_max_content_percent_definite_border_box measure_function ()
    =
  (* Setup test helpers *)
...
let test_grid_minmax_max_content_percent_definite_content_box measure_function
    () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
...
let tests =
  let open Alcotest in
  [
    test_case "minmax_max_content_percent_definite (border-box)" `Quick
      (fun () ->
        test_grid_minmax_max_content_percent_definite_border_box
          measure_function ());
    test_case "minmax_max_content_percent_definite (content-box)" `Quick
      (fun () ->
