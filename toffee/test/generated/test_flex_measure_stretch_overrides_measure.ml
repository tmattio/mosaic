...
let test_flex_measure_stretch_overrides_measure_border_box () =
  (* Setup test helpers *)
...
let test_flex_measure_stretch_overrides_measure_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "measure_stretch_overrides_measure (border-box)" `Quick
      test_flex_measure_stretch_overrides_measure_border_box;
    test_case "measure_stretch_overrides_measure (content-box)" `Quick
      test_flex_measure_stretch_overrides_measure_content_box;
  ]
