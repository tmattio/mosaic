...
(* Generated test for grid_overflow_inline_axis_visible in grid layout *)
...
let test_grid_overflow_inline_axis_visible_border_box () =
  (* Setup test helpers *)
...
let test_grid_overflow_inline_axis_visible_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_overflow_inline_axis_visible Test" [
    "grid_grid_overflow_inline_axis_visible", [
      test_case "grid_overflow_inline_axis_visible (border-box)" `Quick test_grid_overflow_inline_axis_visible_border_box;
      test_case "grid_overflow_inline_axis_visible (content-box)" `Quick test_grid_overflow_inline_axis_visible_content_box;
    ];
  ]
