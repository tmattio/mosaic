...
let test_flex_align_items_center_justify_content_center_border_box () =
  ...
  assert_eq ~msg:"x of node2" 245.0 (Layout.location layout_result).x;
...
let tests =
  [
    Windtrap.test "align_items_center_justify_content_center (border-box)"
      test_flex_align_items_center_justify_content_center_border_box;
    Windtrap.test "align_items_center_justify_content_center (content-box)"
