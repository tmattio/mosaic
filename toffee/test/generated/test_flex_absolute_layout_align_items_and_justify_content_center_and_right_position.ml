...
let test_absolute_layout_align_items_and_justify_content_center_and_right_position_border_box
  ...
  assert_eq ~msg:"x of node0" 951.0 layout.location.x;
        ...
        [
          test_case
            "absolute_layout_align_items_and_justify_content_center_and_right_position \
             (border-box)"
            `Quick
            test_absolute_layout_align_items_and_justify_content_center_and_right_position_border_box;
          test_case
            "absolute_layout_align_items_and_justify_content_center_and_right_position \
             (content-box)"
            `Quick
            test_absolute_layout_align_items_and_justify_content_center_and_right_position_content_box;
        ] );
    ]
