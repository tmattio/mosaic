...
let test_block_absolute_layout_row_width_height_end_bottom_border_box () =
  ...
  assert_eq ~msg:"x of node0" 996.0 layout.location.x;
  assert_eq ~msg:"y of node0" 740.0 layout.location.y;
  ()
  ...
  run "Toffee block_absolute_layout_row_width_height_end_bottom Test"
    [
      ( "block_block_absolute_layout_row_width_height_end_bottom",
        [
          test_case
            "block_absolute_layout_row_width_height_end_bottom (border-box)"
            `Quick
            test_block_absolute_layout_row_width_height_end_bottom_border_box;
          test_case
            "block_absolute_layout_row_width_height_end_bottom (content-box)"
            `Quick
