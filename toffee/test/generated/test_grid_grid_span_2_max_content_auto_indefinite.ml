...
let test_grid_span_2_max_content_auto_indefinite_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 939.0 layout.size.width;
  ...
  run "Toffee grid_span_2_max_content_auto_indefinite Test"
    [
      ( "grid_grid_span_2_max_content_auto_indefinite",
        [
          test_case "grid_span_2_max_content_auto_indefinite (border-box)"
            `Quick test_grid_span_2_max_content_auto_indefinite_border_box;
          test_case "grid_span_2_max_content_auto_indefinite (content-box)"
            `Quick test_grid_span_2_max_content_auto_indefinite_content_box;
        ] );
    ]
