...
(* Generated test for grid_align_content_space_between_with_padding_border in grid layout *)
...
let test_grid_align_content_space_between_with_padding_border_border_box () =
  (* Setup test helpers *)
...
let test_grid_align_content_space_between_with_padding_border_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_align_content_space_between_with_padding_border Test" [
    "grid_grid_align_content_space_between_with_padding_border", [
      test_case "grid_align_content_space_between_with_padding_border (border-box)" `Quick test_grid_align_content_space_between_with_padding_border_border_box;
      test_case "grid_align_content_space_between_with_padding_border (content-box)" `Quick test_grid_align_content_space_between_with_padding_border_content_box;
    ];
  ]
