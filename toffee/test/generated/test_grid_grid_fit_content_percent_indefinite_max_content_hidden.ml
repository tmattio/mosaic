...
(* Generated test for grid_fit_content_percent_indefinite_max_content_hidden in grid layout *)
...
let test_grid_fit_content_percent_indefinite_max_content_hidden_border_box () =
  (* Setup test helpers *)
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Auto }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }] }) in
  let node0 = Toffee.new_leaf tree (Toffee.Style.default) in
  let _ = Toffee.set_node_context tree node0 (MeasureFunction.Fixed {width = 20.0; height = 10.0}) |> Result.get_ok in
...
let test_grid_fit_content_percent_indefinite_max_content_hidden_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_fit_content_percent_indefinite_max_content_hidden Test" [
    "grid_grid_fit_content_percent_indefinite_max_content_hidden", [
      test_case "grid_fit_content_percent_indefinite_max_content_hidden (border-box)" `Quick test_grid_fit_content_percent_indefinite_max_content_hidden_border_box;
      test_case "grid_fit_content_percent_indefinite_max_content_hidden (content-box)" `Quick test_grid_fit_content_percent_indefinite_max_content_hidden_content_box;
    ];
  ]
