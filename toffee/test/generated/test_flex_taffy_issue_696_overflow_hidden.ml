...
let test_flex_taffy_issue_696_overflow_hidden_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"scroll_height of node1" 200.0
...
let test_flex_taffy_issue_696_overflow_hidden_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "taffy_issue_696_overflow_hidden (border-box)" `Quick
      test_flex_taffy_issue_696_overflow_hidden_border_box;
    test_case "taffy_issue_696_overflow_hidden (content-box)" `Quick
      test_flex_taffy_issue_696_overflow_hidden_content_box;
  ]
