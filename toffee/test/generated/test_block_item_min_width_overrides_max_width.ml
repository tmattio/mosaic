...
let tests =
  let open Alcotest in
  [
    test_case "item_min_width_overrides_max_width (border-box)" `Quick
      test_block_item_min_width_overrides_max_width_border_box;
    test_case "item_min_width_overrides_max_width (content-box)" `Quick
      test_block_item_min_width_overrides_max_width_content_box;
  ]
