...
let test_grid_align_items_baseline_child_multiline_no_override_on_secondline_border_box
  ...
  let node5 =
    new_leaf tree
      (Style.make ~display:Style.Display.Grid ~align_self:Baseline
         ~size:
           {
             width = Style.Dimension.length 25.0;
             height = Style.Dimension.length 10.0;
  ...
  assert_eq ~msg:"y of node1" 68.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"width of node4" 25.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node5" 25.0 (Layout.size layout_result).width;
...
let tests =
  ...
  [
    test_case
      "align_items_baseline_child_multiline_no_override_on_secondline \
       (border-box)"
      `Quick
      test_grid_align_items_baseline_child_multiline_no_override_on_secondline_border_box;
    test_case
      "align_items_baseline_child_multiline_no_override_on_secondline \
       (content-box)"
      `Quick
      test_grid_align_items_baseline_child_multiline_no_override_on_secondline_content_box;
  ]
