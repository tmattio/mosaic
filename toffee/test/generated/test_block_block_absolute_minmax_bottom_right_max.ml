...
let test_block_absolute_minmax_bottom_right_max_border_box () =
  ...
  assert_eq ~msg:"x of node0" 966.0 layout.location.x;
  assert_eq ~msg:"y of node0" 720.0 layout.location.y;
  ()
  ...
  run "Toffee block_absolute_minmax_bottom_right_max Test"
    [
      ( "block_block_absolute_minmax_bottom_right_max",
        [
          test_case "block_absolute_minmax_bottom_right_max (border-box)" `Quick
            test_block_absolute_minmax_bottom_right_max_border_box;
          test_case "block_absolute_minmax_bottom_right_max (content-box)"
            `Quick test_block_absolute_minmax_bottom_right_max_content_box;
        ] );
    ]
