...
(* Generated test for absolute_layout_percentage_bottom_based_on_parent_height in flex layout *)
...
let test_absolute_layout_percentage_bottom_based_on_parent_height_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.length 200.0 } }) in
...
let test_absolute_layout_percentage_bottom_based_on_parent_height_content_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.length 200.0 }; box_sizing = Toffee.Style.Content_box }) in
...
let () =
  ...
  run "Toffee absolute_layout_percentage_bottom_based_on_parent_height Test" [
    "flex_absolute_layout_percentage_bottom_based_on_parent_height", [
      test_case "absolute_layout_percentage_bottom_based_on_parent_height (border-box)" `Quick test_absolute_layout_percentage_bottom_based_on_parent_height_border_box;
      test_case "absolute_layout_percentage_bottom_based_on_parent_height (content-box)" `Quick test_absolute_layout_percentage_bottom_based_on_parent_height_content_box;
    ];
  ]
