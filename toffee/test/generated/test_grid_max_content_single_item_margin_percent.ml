...
let test_grid_max_content_single_item_margin_percent_border_box measure_function
  ...
  in
  let _ =
    set_node_context tree node2 (Some (MeasureFunction.Text "HH​HH"))
    |> Result.get_ok
  in
  ...
  assert_eq ~msg:"width of node2" 28.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node2" 32.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 48.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node2" 2.0 (Layout.location layout_result).y;
