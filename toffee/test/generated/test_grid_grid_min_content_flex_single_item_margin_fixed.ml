...
(* Generated test for grid_min_content_flex_single_item_margin_fixed in grid layout *)
...
let test_grid_min_content_flex_single_item_margin_fixed_border_box () =
  (* Setup test helpers *)
  ...
  let node4 = Toffee.new_leaf tree ({ Toffee.Style.default with margin = { left = Toffee.Style.Length_percentage_auto.Length (20.0); right = Toffee.Style.Length_percentage_auto.Length (10.0); top = Toffee.Style.Length_percentage_auto.Length (5.0); bottom = Toffee.Style.Length_percentage_auto.Length (15.0) } }) in
  ...
  assert_eq ~msg:"x of node4" 60.0 layout.location.x;
...
let test_grid_min_content_flex_single_item_margin_fixed_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_min_content_flex_single_item_margin_fixed Test" [
    "grid_grid_min_content_flex_single_item_margin_fixed", [
      test_case "grid_min_content_flex_single_item_margin_fixed (border-box)" `Quick test_grid_min_content_flex_single_item_margin_fixed_border_box;
      test_case "grid_min_content_flex_single_item_margin_fixed (content-box)" `Quick test_grid_min_content_flex_single_item_margin_fixed_content_box;
    ];
  ]
