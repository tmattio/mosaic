...
let test_grid_min_content_flex_single_item_margin_fixed_border_box () =
        ...
        margin =
          {
            ...
            bottom = Toffee.Style.Length_percentage_auto.Length 15.0;
          };
      }
  in
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 928.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 938.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node7" 928.0 layout.size.width;
  ...
  run "Toffee grid_min_content_flex_single_item_margin_fixed Test"
    [
      ( "grid_grid_min_content_flex_single_item_margin_fixed",
        [
          test_case
            "grid_min_content_flex_single_item_margin_fixed (border-box)" `Quick
            test_grid_min_content_flex_single_item_margin_fixed_border_box;
          test_case
            "grid_min_content_flex_single_item_margin_fixed (content-box)"
            `Quick
            test_grid_min_content_flex_single_item_margin_fixed_content_box;
        ] );
    ]
