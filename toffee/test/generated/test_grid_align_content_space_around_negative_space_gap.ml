  ...
  let node1 =
    new_with_children tree
      (Style.make ~display:Style.Display.Grid
         ...
         ~justify_content:Center ~align_content:Space_around
         ~size:
           {
...
let tests =
  let open Alcotest in
  [
    test_case "align_content_space_around_negative_space_gap (border-box)"
      `Quick test_grid_align_content_space_around_negative_space_gap_border_box;
    test_case "align_content_space_around_negative_space_gap (content-box)"
      `Quick test_grid_align_content_space_around_negative_space_gap_content_box;
  ]
