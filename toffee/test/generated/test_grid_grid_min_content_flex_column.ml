...
(* Generated test for grid_min_content_flex_column in grid layout *)
...
let test_grid_min_content_flex_column_border_box () =
  (* Setup test helpers *)
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Min_content; max = Toffee.Style.Grid.Min_content }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }] }) in
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Flex; flex_direction = Toffee.Style.Flex.Column }) in
  ...
  let _ = Toffee.set_node_context tree node3 (MeasureFunction.Fixed {width = 50.0; height = 10.0}) |> Result.get_ok in
...
let test_grid_min_content_flex_column_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Min_content; max = Toffee.Style.Grid.Min_content }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }]; box_sizing = Toffee.Style.Content_box }) in
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Flex; flex_direction = Toffee.Style.Flex.Column; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee grid_min_content_flex_column Test" [
    "grid_grid_min_content_flex_column", [
      test_case "grid_min_content_flex_column (border-box)" `Quick test_grid_min_content_flex_column_border_box;
      test_case "grid_min_content_flex_column (content-box)" `Quick test_grid_min_content_flex_column_content_box;
    ];
  ]
