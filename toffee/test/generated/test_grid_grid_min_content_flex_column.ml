...
let test_grid_min_content_flex_column_border_box () =
  ...
  assert_eq ~msg:"y of node2" 36.0 layout.location.y;
  ...
  assert_eq ~msg:"y of node3" 72.0 layout.location.y;
  ()
  ...
  run "Toffee grid_min_content_flex_column Test"
    [
      ( "grid_grid_min_content_flex_column",
        [
          test_case "grid_min_content_flex_column (border-box)" `Quick
            test_grid_min_content_flex_column_border_box;
          test_case "grid_min_content_flex_column (content-box)" `Quick
            test_grid_min_content_flex_column_content_box;
        ] );
    ]
