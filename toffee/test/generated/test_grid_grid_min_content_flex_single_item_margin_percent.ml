...
let test_grid_min_content_flex_single_item_margin_percent_border_box () =
  ...
  in
  let _ =
    Toffee.set_node_context tree node4
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 958.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 677.0 layout.size.width;
  assert_eq ~msg:"height of node4" 0.0 layout.size.height;
  assert_eq ~msg:"x of node4" 234.0 layout.location.x;
  assert_eq ~msg:"y of node4" 88.0 layout.location.y;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node7" 958.0 layout.size.width;
  ...
  run "Toffee grid_min_content_flex_single_item_margin_percent Test"
    [
      ( "grid_grid_min_content_flex_single_item_margin_percent",
        [
          test_case
            "grid_min_content_flex_single_item_margin_percent (border-box)"
            `Quick
            test_grid_min_content_flex_single_item_margin_percent_border_box;
          test_case
            "grid_min_content_flex_single_item_margin_percent (content-box)"
            `Quick
            test_grid_min_content_flex_single_item_margin_percent_content_box;
        ] );
    ]
