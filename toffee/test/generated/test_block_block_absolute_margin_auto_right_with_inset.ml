  ...
  run "Toffee block_absolute_margin_auto_right_with_inset Test"
    [
      ( "block_block_absolute_margin_auto_right_with_inset",
        [
          test_case "block_absolute_margin_auto_right_with_inset (border-box)"
            `Quick test_block_absolute_margin_auto_right_with_inset_border_box;
          test_case "block_absolute_margin_auto_right_with_inset (content-box)"
            `Quick test_block_absolute_margin_auto_right_with_inset_content_box;
        ] );
    ]
