(* Generated test for grid_absolute_resolved_insets in grid layout *)
(* Do not edit this file directly. It is generated by gentest.js *)

open Toffee

let test_grid_absolute_resolved_insets_border_box () =
  (* Setup test helpers *)
  ...
  let node1 =
    new_with_children tree
      (Style.make ~display:Style.Display.Grid ~position:Style.Position.Relative
         ~size:
           {
...
let test_grid_absolute_resolved_insets_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  assert_eq ~msg:"scroll_height of node8" 0.0
    (Layout.scroll_height layout_result);
  let layout_result = layout tree node0 |> Result.get_ok in
  assert_eq ~msg:"width of node0" 540.0 (Layout.size layout_result).width;
...
let tests =
  ...
  [
    test_case "absolute_resolved_insets (border-box)" `Quick
      test_grid_absolute_resolved_insets_border_box;
    test_case "absolute_resolved_insets (content-box)" `Quick
      test_grid_absolute_resolved_insets_content_box;
  ]
