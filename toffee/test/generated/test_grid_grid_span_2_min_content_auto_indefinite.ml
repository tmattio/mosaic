(* Generated test for grid_span_2_min_content_auto_indefinite in grid layout *)
...
let test_grid_span_2_min_content_auto_indefinite_border_box () =
  (* Setup test helpers *)
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 985.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 1008.0 layout.size.width;
...
let test_grid_span_2_min_content_auto_indefinite_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_span_2_min_content_auto_indefinite Test"
    [
      ( "grid_grid_span_2_min_content_auto_indefinite",
        [
          test_case "grid_span_2_min_content_auto_indefinite (border-box)"
            `Quick test_grid_span_2_min_content_auto_indefinite_border_box;
          test_case "grid_span_2_min_content_auto_indefinite (content-box)"
            `Quick test_grid_span_2_min_content_auto_indefinite_content_box;
        ] );
    ]
