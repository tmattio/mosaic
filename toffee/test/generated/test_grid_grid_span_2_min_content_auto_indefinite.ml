...
let () =
  ...
  run "Toffee grid_span_2_min_content_auto_indefinite Test" [
    "grid_grid_span_2_min_content_auto_indefinite", [
      test_case "grid_span_2_min_content_auto_indefinite (border-box)" `Quick test_grid_span_2_min_content_auto_indefinite_border_box;
      test_case "grid_span_2_min_content_auto_indefinite (content-box)" `Quick test_grid_span_2_min_content_auto_indefinite_content_box;
    ];
  ]
