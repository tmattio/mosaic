    ...
    Toffee.new_leaf tree
      {
        ...
        size =
          {
            width = Toffee.Style.Dimension.auto;
            height = Toffee.Style.Dimension.length 1.0;
          };
        margin =
          {
            left = Toffee.Style.Length_percentage_auto.Length 0.0;
  ...
  run "Toffee block_margin_y_collapse_through_blocked_by_height Test"
    [
      ( "block_block_margin_y_collapse_through_blocked_by_height",
        [
          test_case
            "block_margin_y_collapse_through_blocked_by_height (border-box)"
            `Quick
            test_block_margin_y_collapse_through_blocked_by_height_border_box;
          test_case
            "block_margin_y_collapse_through_blocked_by_height (content-box)"
            `Quick
