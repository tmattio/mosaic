...
let test_flex_absolute_layout_child_order_border_box () =
  ...
  assert_eq ~msg:"width of node0" 55.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"x of node1" 25.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node1" 30.0 (Layout.location layout_result).y;
  let layout_result = layout tree node2 |> Result.get_ok in
  assert_eq ~msg:"width of node2" 55.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node2" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 55.0 (Layout.location layout_result).x;
