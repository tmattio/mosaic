...
let test_flex_percentage_different_width_height_column_border_box () =
  ...
  assert_eq ~msg:"y of node2" 210.0 (Layout.location layout_result).y;
...
let tests =
  [
    Windtrap.test "percentage_different_width_height_column (border-box)"
      test_flex_percentage_different_width_height_column_border_box;
    Windtrap.test "percentage_different_width_height_column (content-box)"
