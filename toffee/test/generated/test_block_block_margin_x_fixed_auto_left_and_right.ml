  ...
  run "Toffee block_margin_x_fixed_auto_left_and_right Test"
    [
      ( "block_block_margin_x_fixed_auto_left_and_right",
        [
          test_case "block_margin_x_fixed_auto_left_and_right (border-box)"
            `Quick test_block_margin_x_fixed_auto_left_and_right_border_box;
          test_case "block_margin_x_fixed_auto_left_and_right (content-box)"
            `Quick test_block_margin_x_fixed_auto_left_and_right_content_box;
        ] );
    ]
