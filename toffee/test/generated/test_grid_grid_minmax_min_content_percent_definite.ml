  ...
  run "Toffee grid_minmax_min_content_percent_definite Test"
    [
      ( "grid_grid_minmax_min_content_percent_definite",
        [
          test_case "grid_minmax_min_content_percent_definite (border-box)"
            `Quick test_grid_minmax_min_content_percent_definite_border_box;
          test_case "grid_minmax_min_content_percent_definite (content-box)"
            `Quick test_grid_minmax_min_content_percent_definite_content_box;
        ] );
    ]
