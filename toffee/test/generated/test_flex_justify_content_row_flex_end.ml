...
let test_flex_justify_content_row_flex_end_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"x of node2" 90.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node2" 0.0 (Layout.location layout_result).y;
  ()

let test_flex_justify_content_row_flex_end_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "justify_content_row_flex_end (border-box)" `Quick
      test_flex_justify_content_row_flex_end_border_box;
    test_case "justify_content_row_flex_end (content-box)" `Quick
      test_flex_justify_content_row_flex_end_content_box;
  ]
