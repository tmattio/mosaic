...
let test_flex_rounding_fractial_input_2_border_box () =
  (* Setup test helpers *)
         ...
         ~size:
           {
             ...
             height = Style.Dimension.length 113.6;
           }
         ~box_sizing:Style.Box_sizing.Border_box ())
      [| node1; node2; node3 |]
    |> Result.get_ok
  ...
  assert_eq ~msg:"height of node1" 65.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"height of node3" 25.0 (Layout.size layout_result).height;
...
let tests =
  ...
  [
    test_case "rounding_fractial_input_2 (border-box)" `Quick
      test_flex_rounding_fractial_input_2_border_box;
    test_case "rounding_fractial_input_2 (content-box)" `Quick
      test_flex_rounding_fractial_input_2_content_box;
  ]
