...
let test_measure_child_with_flex_shrink_hidden_border_box () =
  ...
  let _ =
    Toffee.set_node_context tree node1
      (MeasureFunction.Fixed { width = 540.0; height = 10.0 })
    |> Result.get_ok
  in
      ...
      ( "flex_measure_child_with_flex_shrink_hidden",
        [
          test_case "measure_child_with_flex_shrink_hidden (border-box)" `Quick
            test_measure_child_with_flex_shrink_hidden_border_box;
          test_case "measure_child_with_flex_shrink_hidden (content-box)" `Quick
            test_measure_child_with_flex_shrink_hidden_content_box;
        ] );
    ]
