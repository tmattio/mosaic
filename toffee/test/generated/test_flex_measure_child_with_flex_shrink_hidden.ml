...
let test_flex_measure_child_with_flex_shrink_hidden_border_box measure_function
    () =
  (* Setup test helpers *)
...
let test_flex_measure_child_with_flex_shrink_hidden_content_box measure_function
    () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
