...
let test_grid_min_content_flex_single_item_margin_percent_border_box
  ...
  assert_eq ~msg:"height of node2" 38.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 42.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"width of node5" 28.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node5" 32.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node5" 48.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node5" 42.0 (Layout.location layout_result).y;
