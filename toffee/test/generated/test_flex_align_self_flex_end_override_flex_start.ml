  ...
  run "Toffee align_self_flex_end_override_flex_start Test"
    [
      ( "flex_align_self_flex_end_override_flex_start",
        [
          test_case "align_self_flex_end_override_flex_start (border-box)"
            `Quick test_align_self_flex_end_override_flex_start_border_box;
          test_case "align_self_flex_end_override_flex_start (content-box)"
            `Quick test_align_self_flex_end_override_flex_start_content_box;
        ] );
    ]
