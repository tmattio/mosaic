  ...
  run "Toffee block_margin_y_collapse_through_negative Test"
    [
      ( "block_block_margin_y_collapse_through_negative",
        [
          test_case "block_margin_y_collapse_through_negative (border-box)"
            `Quick test_block_margin_y_collapse_through_negative_border_box;
          test_case "block_margin_y_collapse_through_negative (content-box)"
            `Quick test_block_margin_y_collapse_through_negative_content_box;
        ] );
    ]
