...
let test_bevy_issue_9530_reduced4_border_box () =
  ...
  assert_eq ~msg:"height of node" 144.0 layout.size.height;
  ...
  assert_eq ~msg:"height of node0" 144.0 layout.size.height;
  ...
  run "Toffee bevy_issue_9530_reduced4 Test"
    [
      ( "flex_bevy_issue_9530_reduced4",
        [
          test_case "bevy_issue_9530_reduced4 (border-box)" `Quick
            test_bevy_issue_9530_reduced4_border_box;
          test_case "bevy_issue_9530_reduced4 (content-box)" `Quick
            test_bevy_issue_9530_reduced4_content_box;
        ] );
    ]
