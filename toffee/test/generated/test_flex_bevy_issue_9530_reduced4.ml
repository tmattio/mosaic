...
let test_flex_bevy_issue_9530_reduced4_border_box measure_function () =
  (* Setup test helpers *)
...
let test_flex_bevy_issue_9530_reduced4_content_box measure_function () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "bevy_issue_9530_reduced4 (border-box)" `Quick (fun () ->
        test_flex_bevy_issue_9530_reduced4_border_box measure_function ());
    test_case "bevy_issue_9530_reduced4 (content-box)" `Quick (fun () ->
        test_flex_bevy_issue_9530_reduced4_content_box measure_function ());
  ]
