...
let test_flex_bevy_issue_9530_reduced4_border_box () =
  (* Setup test helpers *)
...
let test_flex_bevy_issue_9530_reduced4_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "bevy_issue_9530_reduced4 (border-box)" `Quick
      test_flex_bevy_issue_9530_reduced4_border_box;
    test_case "bevy_issue_9530_reduced4 (content-box)" `Quick
      test_flex_bevy_issue_9530_reduced4_content_box;
  ]
