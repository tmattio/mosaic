  ...
  run "Toffee block_absolute_margin_auto_top_without_inset Test"
    [
      ( "block_block_absolute_margin_auto_top_without_inset",
        [
          test_case "block_absolute_margin_auto_top_without_inset (border-box)"
            `Quick test_block_absolute_margin_auto_top_without_inset_border_box;
          test_case "block_absolute_margin_auto_top_without_inset (content-box)"
            `Quick test_block_absolute_margin_auto_top_without_inset_content_box;
        ] );
    ]
