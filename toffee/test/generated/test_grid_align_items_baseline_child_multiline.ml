...
let tests =
  let open Alcotest in
  [
    test_case "align_items_baseline_child_multiline (border-box)" `Quick
      test_grid_align_items_baseline_child_multiline_border_box;
    test_case "align_items_baseline_child_multiline (content-box)" `Quick
      test_grid_align_items_baseline_child_multiline_content_box;
  ]
