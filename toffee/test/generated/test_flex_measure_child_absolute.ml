...
let test_flex_measure_child_absolute_border_box () =
  (* Setup test helpers *)
...
let test_flex_measure_child_absolute_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "measure_child_absolute (border-box)" `Quick
      test_flex_measure_child_absolute_border_box;
    test_case "measure_child_absolute (content-box)" `Quick
      test_flex_measure_child_absolute_content_box;
  ]
