...
let test_measure_child_absolute_border_box () =
  ...
  let _ = Toffee.set_node_context tree node0 (MeasureFunction.Fixed {width = 60.0; height = 10.0}) |> Result.get_ok in
...
let () =
  ...
  run "Toffee measure_child_absolute Test" [
    "flex_measure_child_absolute", [
      test_case "measure_child_absolute (border-box)" `Quick test_measure_child_absolute_border_box;
      test_case "measure_child_absolute (content-box)" `Quick test_measure_child_absolute_content_box;
    ];
  ]
