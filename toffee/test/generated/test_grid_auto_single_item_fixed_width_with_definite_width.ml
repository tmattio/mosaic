...
let test_grid_auto_single_item_fixed_width_with_definite_width_border_box () =
  ...
  assert_eq ~msg:"x of node2" 170.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node5" 170.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"width of node7" 130.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"x of node8" 170.0 (Layout.location layout_result).x;
