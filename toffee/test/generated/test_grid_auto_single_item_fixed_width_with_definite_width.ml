...
let test_grid_auto_single_item_fixed_width_with_definite_width_border_box () =
  ...
  assert_eq ~msg:"x of node3" 170.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"width of node5" 130.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"x of node6" 170.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"width of node8" 130.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node9" 30.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node9" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node9" 170.0 (Layout.location layout_result).x;
