...
let test_grid_absolute_align_self_sized_all_border_box () =
  ...
  assert_eq ~msg:"y of node2" 100.0 (Layout.location layout_result).y;
...
let tests =
  let open Alcotest in
  [
    test_case "absolute_align_self_sized_all (border-box)" `Quick
      test_grid_absolute_align_self_sized_all_border_box;
    test_case "absolute_align_self_sized_all (content-box)" `Quick
