    ...
    Toffee.new_leaf tree
      {
        ...
        size =
          {
            width = Toffee.Style.Dimension.length 101.0;
  ...
  run "Toffee rounding_flex_basis_flex_shrink_row Test"
    [
      ( "flex_rounding_flex_basis_flex_shrink_row",
        [
          test_case "rounding_flex_basis_flex_shrink_row (border-box)" `Quick
            test_rounding_flex_basis_flex_shrink_row_border_box;
          test_case "rounding_flex_basis_flex_shrink_row (content-box)" `Quick
            test_rounding_flex_basis_flex_shrink_row_content_box;
        ] );
    ]
