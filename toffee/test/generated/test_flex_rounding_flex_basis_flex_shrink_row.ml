...
let test_flex_rounding_flex_basis_flex_shrink_row_border_box () =
  ...
  assert_eq ~msg:"width of node" 101.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node0" 67.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"x of node1" 67.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node2" 84.0 (Layout.location layout_result).x;
