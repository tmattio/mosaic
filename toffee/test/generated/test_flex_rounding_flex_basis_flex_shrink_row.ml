...
let test_flex_rounding_flex_basis_flex_shrink_row_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"x of node3" 84.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node3" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node0 |> Result.get_ok in
  assert_eq ~msg:"width of node0" 101.0 (Layout.size layout_result).width;
...
let test_flex_rounding_flex_basis_flex_shrink_row_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "rounding_flex_basis_flex_shrink_row (border-box)" `Quick
      test_flex_rounding_flex_basis_flex_shrink_row_border_box;
    test_case "rounding_flex_basis_flex_shrink_row (content-box)" `Quick
      test_flex_rounding_flex_basis_flex_shrink_row_content_box;
  ]
