...
let test_grid_margins_auto_margins_override_stretch_border_box () =
  ...
  let node6 = Toffee.new_leaf tree ({ Toffee.Style.default with align_self = Some (Toffee.Style.Alignment.Stretch); justify_self = Some (Toffee.Style.Alignment.Stretch); margin = { left = Toffee.Style.Length_percentage_auto.Auto; right = Toffee.Style.Length_percentage_auto.Auto; top = Toffee.Style.Length_percentage_auto.Auto; bottom = Toffee.Style.Length_percentage_auto.Auto } }) in
  let _ = Toffee.set_node_context tree node6 (MeasureFunction.Fixed {width = 50.0; height = 10.0}) |> Result.get_ok in
  ...
  assert_eq ~msg:"y of node6" 105.0 layout.location.y;
...
let () =
  let open Alcotest in
  run "Toffee grid_margins_auto_margins_override_stretch Test" [
    "grid_grid_margins_auto_margins_override_stretch", [
      test_case "grid_margins_auto_margins_override_stretch (border-box)" `Quick test_grid_margins_auto_margins_override_stretch_border_box;
      test_case "grid_margins_auto_margins_override_stretch (content-box)" `Quick test_grid_margins_auto_margins_override_stretch_content_box;
    ];
  ]
