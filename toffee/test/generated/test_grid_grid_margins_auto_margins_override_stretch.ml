...
let test_grid_margins_auto_margins_override_stretch_border_box () =
  ...
  in
  let _ =
    Toffee.set_node_context tree node6
  ...
  assert_eq ~msg:"height of node6" 36.0 layout.size.height;
  ...
  run "Toffee grid_margins_auto_margins_override_stretch Test"
    [
      ( "grid_grid_margins_auto_margins_override_stretch",
        [
          test_case "grid_margins_auto_margins_override_stretch (border-box)"
            `Quick test_grid_margins_auto_margins_override_stretch_border_box;
          test_case "grid_margins_auto_margins_override_stretch (content-box)"
            `Quick test_grid_margins_auto_margins_override_stretch_content_box;
        ] );
    ]
