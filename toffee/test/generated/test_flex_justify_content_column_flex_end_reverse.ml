...
let test_flex_justify_content_column_flex_end_reverse_border_box () =
  (* Setup test helpers *)
...
let test_flex_justify_content_column_flex_end_reverse_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "justify_content_column_flex_end_reverse (border-box)" `Quick
      test_flex_justify_content_column_flex_end_reverse_border_box;
    test_case "justify_content_column_flex_end_reverse (content-box)" `Quick
      test_flex_justify_content_column_flex_end_reverse_content_box;
  ]
