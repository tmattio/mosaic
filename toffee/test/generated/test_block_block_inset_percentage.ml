...
let () =
  ...
  run "Toffee block_inset_percentage Test" [
    "block_block_inset_percentage", [
      test_case "block_inset_percentage (border-box)" `Quick test_block_inset_percentage_border_box;
      test_case "block_inset_percentage (content-box)" `Quick test_block_inset_percentage_content_box;
    ];
  ]
