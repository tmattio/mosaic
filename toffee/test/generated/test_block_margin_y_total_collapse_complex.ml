...
let test_block_margin_y_total_collapse_complex_border_box () =
  ...
  assert_eq ~msg:"y of node4" 7.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node5" (-6.0) (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node7" (-10.0) (Layout.location layout_result).y;
