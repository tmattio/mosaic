...
let test_block_margin_y_total_collapse_complex_border_box () =
         ...
         ~margin:
           {
             left = Style.Length_percentage_auto.length 0.0;
             right = Style.Length_percentage_auto.length 0.0;
             top = Style.Length_percentage_auto.length 7.0;
         ...
         ~margin:
           {
             left = Style.Length_percentage_auto.length 0.0;
             right = Style.Length_percentage_auto.length 0.0;
             top = Style.Length_percentage_auto.length (-6.0);
  ...
  assert_eq ~msg:"y of node3" 7.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node4" (-6.0) (Layout.location layout_result).y;
...
let tests =
  let open Alcotest in
  [
    test_case "margin_y_total_collapse_complex (border-box)" `Quick
      test_block_margin_y_total_collapse_complex_border_box;
    test_case "margin_y_total_collapse_complex (content-box)" `Quick
      test_block_margin_y_total_collapse_complex_content_box;
  ]
