...
let tests =
  let open Alcotest in
  [
    test_case "margin_y_simple_positive (border-box)" `Quick
      test_block_margin_y_simple_positive_border_box;
    test_case "margin_y_simple_positive (content-box)" `Quick
      test_block_margin_y_simple_positive_content_box;
  ]
