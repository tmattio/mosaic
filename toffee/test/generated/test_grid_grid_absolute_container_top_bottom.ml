...
let test_grid_absolute_container_top_bottom_border_box () =
  ...
  assert_eq ~msg:"height of node0" 761.0 layout.size.height;
  assert_eq ~msg:"x of node0" 40.0 layout.location.x;
  assert_eq ~msg:"y of node0" (-6.0) layout.location.y;
  ...
  run "Toffee grid_absolute_container_top_bottom Test"
    [
      ( "grid_grid_absolute_container_top_bottom",
        [
          test_case "grid_absolute_container_top_bottom (border-box)" `Quick
            test_grid_absolute_container_top_bottom_border_box;
          test_case "grid_absolute_container_top_bottom (content-box)" `Quick
            test_grid_absolute_container_top_bottom_content_box;
        ] );
    ]
