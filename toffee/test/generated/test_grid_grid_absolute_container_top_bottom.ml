...
(* Generated test for grid_absolute_container_top_bottom in grid layout *)
...
let test_grid_absolute_container_top_bottom_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"height of node0" 153.0 layout.size.height;
...
let test_grid_absolute_container_top_bottom_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_absolute_container_top_bottom Test" [
    "grid_grid_absolute_container_top_bottom", [
      test_case "grid_absolute_container_top_bottom (border-box)" `Quick test_grid_absolute_container_top_bottom_border_box;
      test_case "grid_absolute_container_top_bottom (content-box)" `Quick test_grid_absolute_container_top_bottom_content_box;
    ];
  ]
