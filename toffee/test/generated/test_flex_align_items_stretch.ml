  ...
  run "Toffee align_items_stretch Test"
    [
      ( "flex_align_items_stretch",
        [
          test_case "align_items_stretch (border-box)" `Quick
            test_align_items_stretch_border_box;
          test_case "align_items_stretch (content-box)" `Quick
            test_align_items_stretch_content_box;
        ] );
    ]
