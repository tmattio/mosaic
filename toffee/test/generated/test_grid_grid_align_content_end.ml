...
(* Generated test for grid_align_content_end in grid layout *)
...
let test_grid_align_content_end_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"y of node3" 120.0 layout.location.y;
  ...
  assert_eq ~msg:"y of node6" 160.0 layout.location.y;
...
let test_grid_align_content_end_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_align_content_end Test" [
    "grid_grid_align_content_end", [
      test_case "grid_align_content_end (border-box)" `Quick test_grid_align_content_end_border_box;
      test_case "grid_align_content_end (content-box)" `Quick test_grid_align_content_end_content_box;
    ];
  ]
