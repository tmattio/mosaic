  ...
  run "Toffee flex_shrink_by_outer_margin_with_max_size Test"
    [
      ( "flex_flex_shrink_by_outer_margin_with_max_size",
        [
          test_case "flex_shrink_by_outer_margin_with_max_size (border-box)"
            `Quick test_flex_shrink_by_outer_margin_with_max_size_border_box;
          test_case "flex_shrink_by_outer_margin_with_max_size (content-box)"
            `Quick test_flex_shrink_by_outer_margin_with_max_size_content_box;
        ] );
    ]
