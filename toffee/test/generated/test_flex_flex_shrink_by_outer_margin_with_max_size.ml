...
(* Generated test for flex_shrink_by_outer_margin_with_max_size in flex layout *)
...
let test_flex_shrink_by_outer_margin_with_max_size_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with flex_direction = Toffee.Style.Flex.Column; size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 100.0 }; max_size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 80.0 } }) in
...
let () =
  let open Alcotest in
  run "Toffee flex_shrink_by_outer_margin_with_max_size Test" [
    "flex_flex_shrink_by_outer_margin_with_max_size", [
      test_case "flex_shrink_by_outer_margin_with_max_size (border-box)" `Quick test_flex_shrink_by_outer_margin_with_max_size_border_box;
      test_case "flex_shrink_by_outer_margin_with_max_size (content-box)" `Quick test_flex_shrink_by_outer_margin_with_max_size_content_box;
    ];
  ]
