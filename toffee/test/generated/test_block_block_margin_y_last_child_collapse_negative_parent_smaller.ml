  ...
  run "Toffee block_margin_y_last_child_collapse_negative_parent_smaller Test"
    [
      ( "block_block_margin_y_last_child_collapse_negative_parent_smaller",
        [
          test_case
            "block_margin_y_last_child_collapse_negative_parent_smaller \
             (border-box)"
            `Quick
            test_block_margin_y_last_child_collapse_negative_parent_smaller_border_box;
          test_case
            "block_margin_y_last_child_collapse_negative_parent_smaller \
             (content-box)"
            `Quick
            test_block_margin_y_last_child_collapse_negative_parent_smaller_content_box;
        ] );
    ]
