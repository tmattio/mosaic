...
let test_grid_fit_content_points_min_content_border_box measure_function () =
  (* Setup test helpers *)
...
let test_grid_fit_content_points_min_content_content_box measure_function () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "fit_content_points_min_content (border-box)" `Quick (fun () ->
        test_grid_fit_content_points_min_content_border_box measure_function ());
    test_case "fit_content_points_min_content (content-box)" `Quick (fun () ->
        test_grid_fit_content_points_min_content_content_box measure_function ());
  ]
