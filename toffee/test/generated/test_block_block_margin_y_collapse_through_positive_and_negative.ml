        ...
        margin =
          {
            ...
            bottom = Toffee.Style.Length_percentage_auto.Length (-4.0);
          };
      }
  in
  ...
  run "Toffee block_margin_y_collapse_through_positive_and_negative Test"
    [
      ( "block_block_margin_y_collapse_through_positive_and_negative",
        [
          test_case
            "block_margin_y_collapse_through_positive_and_negative (border-box)"
            `Quick
            test_block_margin_y_collapse_through_positive_and_negative_border_box;
          test_case
            "block_margin_y_collapse_through_positive_and_negative \
             (content-box)"
            `Quick
