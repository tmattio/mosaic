...
(* Generated test for grid_minmax_column_fixed_width_within_range in grid layout *)
...
let test_grid_minmax_column_fixed_width_within_range_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"x of node8" 70.0 layout.location.x;
  assert_eq ~msg:"y of node8" 80.0 layout.location.y;
  ()



let test_grid_minmax_column_fixed_width_within_range_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_minmax_column_fixed_width_within_range Test" [
    "grid_grid_minmax_column_fixed_width_within_range", [
      test_case "grid_minmax_column_fixed_width_within_range (border-box)" `Quick test_grid_minmax_column_fixed_width_within_range_border_box;
      test_case "grid_minmax_column_fixed_width_within_range (content-box)" `Quick test_grid_minmax_column_fixed_width_within_range_content_box;
    ];
  ]
