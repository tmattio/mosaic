      ...
      (Style.make ~display:Style.Display.Grid
         ~grid_template_columns:
           [
             ...
             Style.Grid.Template_component.single
               (Style.Grid.Track_sizing_function.fr 3.0);
           ]
         ~grid_template_rows:
           [
             Style.Grid.Template_component.single
...
let tests =
  let open Alcotest in
  [
    test_case "fr_span_2_proportion_with_non_spanned_track (border-box)" `Quick
      test_grid_fr_span_2_proportion_with_non_spanned_track_border_box;
    test_case "fr_span_2_proportion_with_non_spanned_track (content-box)" `Quick
