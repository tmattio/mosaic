  ...
  run "Toffee max_width_overrides_width Test"
    [
      ( "flex_max_width_overrides_width",
        [
          test_case "max_width_overrides_width (border-box)" `Quick
            test_max_width_overrides_width_border_box;
          test_case "max_width_overrides_width (content-box)" `Quick
            test_max_width_overrides_width_content_box;
        ] );
    ]
