...
let test_grid_percent_tracks_indefinite_with_content_overflow_border_box () =
    ...
    Toffee.new_leaf tree
      {
        ...
        grid_template_columns =
          [
            Toffee.Style.Grid.Single
              {
                min = Toffee.Style.Grid.Percent 0.4;
                max = Toffee.Style.Grid.Percent 0.4;
              };
            Toffee.Style.Grid.Single
              {
                min = Toffee.Style.Grid.Percent 0.4;
        ...
        grid_template_rows =
          [
            Toffee.Style.Grid.Single
              {
                min = Toffee.Style.Grid.Percent 0.5;
                max = Toffee.Style.Grid.Percent 0.5;
              };
            Toffee.Style.Grid.Single
              {
                min = Toffee.Style.Grid.Percent 0.8;
                max = Toffee.Style.Grid.Percent 0.8;
              };
          ];
      }
  in
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 403.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node5" 403.0 layout.size.width;
  assert_eq ~msg:"height of node5" 80.0 layout.size.height;
  assert_eq ~msg:"x of node5" 403.0 layout.location.x;
  assert_eq ~msg:"y of node5" 50.0 layout.location.y;
  let layout = Toffee.layout tree node6 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node6" 404.0 layout.size.width;
  assert_eq ~msg:"height of node6" 80.0 layout.size.height;
  assert_eq ~msg:"x of node6" 806.0 layout.location.x;
  ...
  run "Toffee grid_percent_tracks_indefinite_with_content_overflow Test"
    [
      ( "grid_grid_percent_tracks_indefinite_with_content_overflow",
        [
          test_case
            "grid_percent_tracks_indefinite_with_content_overflow (border-box)"
            `Quick
            test_grid_percent_tracks_indefinite_with_content_overflow_border_box;
          test_case
            "grid_percent_tracks_indefinite_with_content_overflow (content-box)"
            `Quick
