...
(* Generated test for grid_percent_tracks_indefinite_with_content_overflow in grid layout *)
...
let test_grid_percent_tracks_indefinite_with_content_overflow_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.4); max = Toffee.Style.Grid.Percent (0.4) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.4); max = Toffee.Style.Grid.Percent (0.4) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.4); max = Toffee.Style.Grid.Percent (0.4) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.5); max = Toffee.Style.Grid.Percent (0.5) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.8); max = Toffee.Style.Grid.Percent (0.8) }] }) in
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.length 100.0 } }) in
  ...
  assert_eq ~msg:"height of node4" 80.0 layout.size.height;
  ...
  assert_eq ~msg:"height of node5" 80.0 layout.size.height;
  ...
  assert_eq ~msg:"height of node6" 80.0 layout.size.height;
...
let test_grid_percent_tracks_indefinite_with_content_overflow_content_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.4); max = Toffee.Style.Grid.Percent (0.4) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.4); max = Toffee.Style.Grid.Percent (0.4) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.4); max = Toffee.Style.Grid.Percent (0.4) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.5); max = Toffee.Style.Grid.Percent (0.5) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.8); max = Toffee.Style.Grid.Percent (0.8) }]; box_sizing = Toffee.Style.Content_box }) in
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.length 100.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee grid_percent_tracks_indefinite_with_content_overflow Test" [
    "grid_grid_percent_tracks_indefinite_with_content_overflow", [
      test_case "grid_percent_tracks_indefinite_with_content_overflow (border-box)" `Quick test_grid_percent_tracks_indefinite_with_content_overflow_border_box;
      test_case "grid_percent_tracks_indefinite_with_content_overflow (content-box)" `Quick test_grid_percent_tracks_indefinite_with_content_overflow_content_box;
    ];
  ]
