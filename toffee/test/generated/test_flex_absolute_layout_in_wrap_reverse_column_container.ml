...
let test_flex_absolute_layout_in_wrap_reverse_column_container_border_box () =
  (* Setup test helpers *)
...
let test_flex_absolute_layout_in_wrap_reverse_column_container_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "absolute_layout_in_wrap_reverse_column_container (border-box)"
      `Quick
      test_flex_absolute_layout_in_wrap_reverse_column_container_border_box;
    test_case "absolute_layout_in_wrap_reverse_column_container (content-box)"
      `Quick
      test_flex_absolute_layout_in_wrap_reverse_column_container_content_box;
  ]
