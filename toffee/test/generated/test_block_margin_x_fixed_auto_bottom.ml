...
let tests =
  let open Alcotest in
  [
    test_case "margin_x_fixed_auto_bottom (border-box)" `Quick
      test_block_margin_x_fixed_auto_bottom_border_box;
    test_case "margin_x_fixed_auto_bottom (content-box)" `Quick
      test_block_margin_x_fixed_auto_bottom_content_box;
  ]
