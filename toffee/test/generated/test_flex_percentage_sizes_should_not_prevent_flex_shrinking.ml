...
let test_percentage_sizes_should_not_prevent_flex_shrinking_border_box () =
  ...
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.percent 1.2; height = Toffee.Style.Dimension.auto } }) in
...
let test_percentage_sizes_should_not_prevent_flex_shrinking_content_box () =
  ...
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.percent 1.2; height = Toffee.Style.Dimension.auto }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
...
let () =
  ...
  run "Toffee percentage_sizes_should_not_prevent_flex_shrinking Test" [
    "flex_percentage_sizes_should_not_prevent_flex_shrinking", [
      test_case "percentage_sizes_should_not_prevent_flex_shrinking (border-box)" `Quick test_percentage_sizes_should_not_prevent_flex_shrinking_border_box;
      test_case "percentage_sizes_should_not_prevent_flex_shrinking (content-box)" `Quick test_percentage_sizes_should_not_prevent_flex_shrinking_content_box;
    ];
  ]
