...
(* Generated test for grid_justify_content_space_around in grid layout *)
...
let test_grid_justify_content_space_around_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"x of node0" 13.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node2" 147.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node3" 13.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node5" 147.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node6" 13.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node8" 147.0 layout.location.x;
  assert_eq ~msg:"y of node8" 80.0 layout.location.y;
  ()



let test_grid_justify_content_space_around_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_justify_content_space_around Test" [
    "grid_grid_justify_content_space_around", [
      test_case "grid_justify_content_space_around (border-box)" `Quick test_grid_justify_content_space_around_border_box;
      test_case "grid_justify_content_space_around (content-box)" `Quick test_grid_justify_content_space_around_content_box;
    ];
  ]
