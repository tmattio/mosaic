...
let test_grid_percent_items_nested_with_padding_margin_border_box () =
    ...
    Toffee.new_leaf tree
      {
        ...
        grid_template_rows =
          [
            ...
            Toffee.Style.Grid.Single
              { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Fr 4.0 };
          ];
        size =
          {
    ...
    Toffee.new_leaf tree
      {
        ...
        min_size =
          {
            width = Toffee.Style.Dimension.percent 0.6;
  ...
  assert_eq ~msg:"height of node0" 41.0 layout.size.height;
  ...
  assert_eq ~msg:"height of node3" 149.0 layout.size.height;
  assert_eq ~msg:"x of node3" 0.0 layout.location.x;
  assert_eq ~msg:"y of node3" 51.0 layout.location.y;
  ()
...
let test_grid_percent_items_nested_with_padding_margin_content_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node3" 200.0 layout.size.width;
  assert_eq ~msg:"height of node3" 148.0 layout.size.height;
  assert_eq ~msg:"x of node3" 0.0 layout.location.x;
...
let () =
  let open Alcotest in
  run "Toffee grid_percent_items_nested_with_padding_margin Test"
    [
      ( "grid_grid_percent_items_nested_with_padding_margin",
        [
          test_case "grid_percent_items_nested_with_padding_margin (border-box)"
            `Quick test_grid_percent_items_nested_with_padding_margin_border_box;
          test_case
            "grid_percent_items_nested_with_padding_margin (content-box)" `Quick
