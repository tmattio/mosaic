...
(* Generated test for grid_align_content_end_with_padding_border in grid layout *)
...
let test_grid_align_content_end_with_padding_border_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"x of node0" 48.0 layout.location.x;
  assert_eq ~msg:"y of node0" 44.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node1" 88.0 layout.location.x;
  assert_eq ~msg:"y of node1" 44.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node2" 128.0 layout.location.x;
  assert_eq ~msg:"y of node2" 44.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node3" 48.0 layout.location.x;
  assert_eq ~msg:"y of node3" 84.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node4" 88.0 layout.location.x;
  assert_eq ~msg:"y of node4" 84.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node5" 128.0 layout.location.x;
  assert_eq ~msg:"y of node5" 84.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node6" 48.0 layout.location.x;
  assert_eq ~msg:"y of node6" 124.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node7" 88.0 layout.location.x;
  assert_eq ~msg:"y of node7" 124.0 layout.location.y;
  ...
  assert_eq ~msg:"x of node8" 128.0 layout.location.x;
  assert_eq ~msg:"y of node8" 124.0 layout.location.y;
  ()



let test_grid_align_content_end_with_padding_border_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  assert_eq ~msg:"height of node0" 40.0 layout.size.height;
  assert_eq ~msg:"x of node0" 48.0 layout.location.x;
  assert_eq ~msg:"y of node0" 92.0 layout.location.y;
  let layout = Toffee.layout tree node1 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 40.0 layout.size.width;
  assert_eq ~msg:"height of node1" 40.0 layout.size.height;
  assert_eq ~msg:"x of node1" 88.0 layout.location.x;
  assert_eq ~msg:"y of node1" 92.0 layout.location.y;
  let layout = Toffee.layout tree node2 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 40.0 layout.size.width;
  assert_eq ~msg:"height of node2" 40.0 layout.size.height;
  assert_eq ~msg:"x of node2" 128.0 layout.location.x;
  assert_eq ~msg:"y of node2" 92.0 layout.location.y;
  let layout = Toffee.layout tree node3 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node3" 40.0 layout.size.width;
  assert_eq ~msg:"height of node3" 40.0 layout.size.height;
  assert_eq ~msg:"x of node3" 48.0 layout.location.x;
  assert_eq ~msg:"y of node3" 132.0 layout.location.y;
  let layout = Toffee.layout tree node4 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 40.0 layout.size.width;
  assert_eq ~msg:"height of node4" 40.0 layout.size.height;
  assert_eq ~msg:"x of node4" 88.0 layout.location.x;
  assert_eq ~msg:"y of node4" 132.0 layout.location.y;
  let layout = Toffee.layout tree node5 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node5" 40.0 layout.size.width;
  assert_eq ~msg:"height of node5" 40.0 layout.size.height;
  assert_eq ~msg:"x of node5" 128.0 layout.location.x;
  assert_eq ~msg:"y of node5" 132.0 layout.location.y;
  let layout = Toffee.layout tree node6 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node6" 40.0 layout.size.width;
  assert_eq ~msg:"height of node6" 40.0 layout.size.height;
  assert_eq ~msg:"x of node6" 48.0 layout.location.x;
  assert_eq ~msg:"y of node6" 172.0 layout.location.y;
  let layout = Toffee.layout tree node7 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node7" 40.0 layout.size.width;
  assert_eq ~msg:"height of node7" 40.0 layout.size.height;
  assert_eq ~msg:"x of node7" 88.0 layout.location.x;
  assert_eq ~msg:"y of node7" 172.0 layout.location.y;
  let layout = Toffee.layout tree node8 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node8" 40.0 layout.size.width;
  assert_eq ~msg:"height of node8" 40.0 layout.size.height;
  assert_eq ~msg:"x of node8" 128.0 layout.location.x;
  assert_eq ~msg:"y of node8" 172.0 layout.location.y;
  ()
...
let () =
  let open Alcotest in
  run "Toffee grid_align_content_end_with_padding_border Test" [
    "grid_grid_align_content_end_with_padding_border", [
      test_case "grid_align_content_end_with_padding_border (border-box)" `Quick test_grid_align_content_end_with_padding_border_border_box;
      test_case "grid_align_content_end_with_padding_border (content-box)" `Quick test_grid_align_content_end_with_padding_border_content_box;
    ];
  ]
