    ...
    Toffee.new_leaf tree
      {
        ...
        justify_items = Some Toffee.Style.Alignment.End;
        size =
          {
  ...
  run "Toffee grid_justify_items_sized_end Test"
    [
      ( "grid_grid_justify_items_sized_end",
        [
          test_case "grid_justify_items_sized_end (border-box)" `Quick
            test_grid_justify_items_sized_end_border_box;
          test_case "grid_justify_items_sized_end (content-box)" `Quick
