...
let tests =
  let open Alcotest in
  [
    test_case "justify_items_sized_stretch (border-box)" `Quick
      test_grid_justify_items_sized_stretch_border_box;
    test_case "justify_items_sized_stretch (content-box)" `Quick
      test_grid_justify_items_sized_stretch_content_box;
  ]
