...
let test_flex_align_content_space_between_wrapped_border_box () =
  (* Setup test helpers *)
  ...
  let node0 =
    new_with_children tree
      (Style.make ~flex_direction:Style.Flex_direction.Row
         ~flex_wrap:Style.Flex_wrap.Wrap ~align_content:Space_between
         ~size:
           {
  ...
  assert_eq ~msg:"y of node5" 90.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node6" 90.0 (Layout.location layout_result).y;
...
let test_flex_align_content_space_between_wrapped_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "align_content_space_between_wrapped (border-box)" `Quick
      test_flex_align_content_space_between_wrapped_border_box;
    test_case "align_content_space_between_wrapped (content-box)" `Quick
      test_flex_align_content_space_between_wrapped_content_box;
  ]
