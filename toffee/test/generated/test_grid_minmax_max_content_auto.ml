...
let test_grid_minmax_max_content_auto_border_box measure_function () =
  (* Setup test helpers *)
...
let test_grid_minmax_max_content_auto_content_box measure_function () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "minmax_max_content_auto (border-box)" `Quick (fun () ->
        test_grid_minmax_max_content_auto_border_box measure_function ());
    test_case "minmax_max_content_auto (content-box)" `Quick (fun () ->
        test_grid_minmax_max_content_auto_content_box measure_function ());
  ]
