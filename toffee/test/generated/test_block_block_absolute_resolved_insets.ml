...
let test_block_absolute_resolved_insets_border_box () =
  ...
  assert_eq ~msg:"height of node" 810.0 layout.size.height;
  ...
  assert_eq ~msg:"x of node14" 0.0 layout.location.x;
  assert_eq ~msg:"y of node14" 540.0 layout.location.y;
  ...
  run "Toffee block_absolute_resolved_insets Test"
    [
      ( "block_block_absolute_resolved_insets",
        [
          test_case "block_absolute_resolved_insets (border-box)" `Quick
            test_block_absolute_resolved_insets_border_box;
          test_case "block_absolute_resolved_insets (content-box)" `Quick
