...
let test_grid_justify_content_space_around_border_box () =
  ...
  assert_eq ~msg:"x of node0" 13.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node2" 147.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node3" 13.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node5" 147.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node6" 13.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node8" 147.0 (Layout.location layout_result).x;
