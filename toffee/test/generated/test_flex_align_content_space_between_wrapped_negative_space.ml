...
let test_flex_align_content_space_between_wrapped_negative_space_border_box () =
  (* Setup test helpers *)
...
let test_flex_align_content_space_between_wrapped_negative_space_content_box ()
    =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
...
let tests =
  let open Alcotest in
  [
    test_case "align_content_space_between_wrapped_negative_space (border-box)"
      `Quick
      test_flex_align_content_space_between_wrapped_negative_space_border_box;
    test_case "align_content_space_between_wrapped_negative_space (content-box)"
      `Quick
      test_flex_align_content_space_between_wrapped_negative_space_content_box;
  ]
