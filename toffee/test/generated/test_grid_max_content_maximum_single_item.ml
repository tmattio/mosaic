           ...
           [
             ...
             Style.Grid.Template_component.single
               (Style.Grid.Track_sizing_function.minmax
                  ~min:(Style.Compact_length.length 0.0)
...
let tests =
  let open Alcotest in
  [
    test_case "max_content_maximum_single_item (border-box)" `Quick
      test_grid_max_content_maximum_single_item_border_box;
    test_case "max_content_maximum_single_item (content-box)" `Quick
