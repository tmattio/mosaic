  ...
  run "Toffee block_margin_y_last_child_collapse_negative_equal Test"
    [
      ( "block_block_margin_y_last_child_collapse_negative_equal",
        [
          test_case
            "block_margin_y_last_child_collapse_negative_equal (border-box)"
            `Quick
            test_block_margin_y_last_child_collapse_negative_equal_border_box;
          test_case
            "block_margin_y_last_child_collapse_negative_equal (content-box)"
            `Quick
            test_block_margin_y_last_child_collapse_negative_equal_content_box;
        ] );
    ]
