...
let tests =
  ...
  [
    test_case
      "margin_y_first_child_collapse_negative_parent_larger (border-box)" `Quick
      test_block_margin_y_first_child_collapse_negative_parent_larger_border_box;
    test_case
      "margin_y_first_child_collapse_negative_parent_larger (content-box)"
      `Quick
      test_block_margin_y_first_child_collapse_negative_parent_larger_content_box;
  ]
