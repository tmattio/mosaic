...
let test_aspect_ratio_flex_row_fill_max_height_border_box () =
  ...
  assert_eq ~msg:"height of node0" 198.0 layout.size.height;
  ...
  run "Toffee aspect_ratio_flex_row_fill_max_height Test"
    [
      ( "flex_aspect_ratio_flex_row_fill_max_height",
        [
          test_case "aspect_ratio_flex_row_fill_max_height (border-box)" `Quick
            test_aspect_ratio_flex_row_fill_max_height_border_box;
          test_case "aspect_ratio_flex_row_fill_max_height (content-box)" `Quick
            test_aspect_ratio_flex_row_fill_max_height_content_box;
        ] );
    ]
