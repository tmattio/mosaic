...
let tests =
  ...
  [
    test_case
      "basis_smaller_then_content_with_flex_grow_very_large_size (border-box)"
      `Quick
      test_flex_basis_smaller_then_content_with_flex_grow_very_large_size_border_box;
    test_case
      "basis_smaller_then_content_with_flex_grow_very_large_size (content-box)"
      `Quick
      test_flex_basis_smaller_then_content_with_flex_grow_very_large_size_content_box;
  ]
