...
let test_grid_minmax_min_content_percent_indefinite_border_box measure_function
    () =
  (* Setup test helpers *)
           ...
           [
             Style.Grid.Template_component.single
               (Style.Grid.Track_sizing_function.minmax
                  ...
                  ~max:(Style.Length_percentage.percent 0.2));
           ]
         ~grid_template_rows:
           [
             Style.Grid.Template_component.single
...
let test_grid_minmax_min_content_percent_indefinite_content_box measure_function
    () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
...
let tests =
  let open Alcotest in
  [
    test_case "minmax_min_content_percent_indefinite (border-box)" `Quick
      (fun () ->
        test_grid_minmax_min_content_percent_indefinite_border_box
          measure_function ());
    test_case "minmax_min_content_percent_indefinite (content-box)" `Quick
      (fun () ->
        test_grid_minmax_min_content_percent_indefinite_content_box
          measure_function ());
  ]
