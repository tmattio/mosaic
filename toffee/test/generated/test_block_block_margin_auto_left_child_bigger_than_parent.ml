  ...
  run "Toffee block_margin_auto_left_child_bigger_than_parent Test"
    [
      ( "block_block_margin_auto_left_child_bigger_than_parent",
        [
          test_case
            "block_margin_auto_left_child_bigger_than_parent (border-box)"
            `Quick
            test_block_margin_auto_left_child_bigger_than_parent_border_box;
          test_case
            "block_margin_auto_left_child_bigger_than_parent (content-box)"
            `Quick
            test_block_margin_auto_left_child_bigger_than_parent_content_box;
        ] );
    ]
