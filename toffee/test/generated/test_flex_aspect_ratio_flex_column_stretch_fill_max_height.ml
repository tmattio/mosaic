...
let test_aspect_ratio_flex_column_stretch_fill_max_height_border_box () =
  ...
  let _ =
    Toffee.set_node_context tree node0
      (MeasureFunction.Text "HH​HH​HH​HH​HH​HH​HH​HH​HH​HH​HH")
    |> Result.get_ok
  in
  ...
  run "Toffee aspect_ratio_flex_column_stretch_fill_max_height Test"
    [
      ( "flex_aspect_ratio_flex_column_stretch_fill_max_height",
        [
          test_case
            "aspect_ratio_flex_column_stretch_fill_max_height (border-box)"
            `Quick
            test_aspect_ratio_flex_column_stretch_fill_max_height_border_box;
          test_case
            "aspect_ratio_flex_column_stretch_fill_max_height (content-box)"
            `Quick
            test_aspect_ratio_flex_column_stretch_fill_max_height_content_box;
        ] );
    ]
