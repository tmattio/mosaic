...
let tests =
  let open Alcotest in
  [
    test_case "margin_x_percentage_intrinsic_size_other_positive (border-box)"
      `Quick
      test_block_margin_x_percentage_intrinsic_size_other_positive_border_box;
    test_case "margin_x_percentage_intrinsic_size_other_positive (content-box)"
      `Quick
      test_block_margin_x_percentage_intrinsic_size_other_positive_content_box;
  ]
