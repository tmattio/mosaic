...
let test_block_margin_y_sibling_collapse_positive_percentage_border_box () =
  ...
  assert_eq ~msg:"height of node" 55.0 layout.size.height;
  ...
  run "Toffee block_margin_y_sibling_collapse_positive_percentage Test"
    [
      ( "block_block_margin_y_sibling_collapse_positive_percentage",
        [
          test_case
            "block_margin_y_sibling_collapse_positive_percentage (border-box)"
            `Quick
            test_block_margin_y_sibling_collapse_positive_percentage_border_box;
          test_case
            "block_margin_y_sibling_collapse_positive_percentage (content-box)"
            `Quick
