...
(* Generated test for grid_absolute_container_left_right_margin in grid layout *)
...
let test_grid_absolute_container_left_right_margin_border_box () =
  (* Setup test helpers *)
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 167.0 layout.size.width;
  assert_eq ~msg:"height of node0" 0.0 layout.size.height;
  assert_eq ~msg:"x of node0" 9.0 layout.location.x;
...
let test_grid_absolute_container_left_right_margin_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_absolute_container_left_right_margin Test" [
    "grid_grid_absolute_container_left_right_margin", [
      test_case "grid_absolute_container_left_right_margin (border-box)" `Quick test_grid_absolute_container_left_right_margin_border_box;
      test_case "grid_absolute_container_left_right_margin (content-box)" `Quick test_grid_absolute_container_left_right_margin_content_box;
    ];
  ]
