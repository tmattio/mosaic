...
let test_grid_absolute_container_left_right_margin_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 1011.0 layout.size.width;
  ...
  run "Toffee grid_absolute_container_left_right_margin Test"
    [
      ( "grid_grid_absolute_container_left_right_margin",
        [
          test_case "grid_absolute_container_left_right_margin (border-box)"
            `Quick test_grid_absolute_container_left_right_margin_border_box;
          test_case "grid_absolute_container_left_right_margin (content-box)"
            `Quick test_grid_absolute_container_left_right_margin_content_box;
        ] );
    ]
