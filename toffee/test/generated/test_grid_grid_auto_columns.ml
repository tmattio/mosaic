...
let test_grid_auto_columns_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (100.0); max = Toffee.Style.Grid.Length (100.0) }]; grid_auto_columns = [{ min = Toffee.Style.Grid.Length (10.0); max = Toffee.Style.Grid.Length (10.0) }; { min = Toffee.Style.Grid.Length (20.0); max = Toffee.Style.Grid.Length (20.0) }; { min = Toffee.Style.Grid.Length (30.0); max = Toffee.Style.Grid.Length (30.0) }]; grid_auto_flow = Toffee.Style.Grid.Column }) in
  ...
  assert_eq ~msg:"width of node" 190.0 layout.size.width;
  ...
  assert_eq ~msg:"height of node5" 100.0 layout.size.height;
  assert_eq ~msg:"x of node5" 130.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node6" 140.0 layout.location.x;
  ...
  assert_eq ~msg:"height of node7" 100.0 layout.size.height;
  assert_eq ~msg:"x of node7" 160.0 layout.location.x;
...
let test_grid_auto_columns_content_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (100.0); max = Toffee.Style.Grid.Length (100.0) }]; grid_auto_columns = [{ min = Toffee.Style.Grid.Length (10.0); max = Toffee.Style.Grid.Length (10.0) }; { min = Toffee.Style.Grid.Length (20.0); max = Toffee.Style.Grid.Length (20.0) }; { min = Toffee.Style.Grid.Length (30.0); max = Toffee.Style.Grid.Length (30.0) }]; grid_auto_flow = Toffee.Style.Grid.Column; box_sizing = Toffee.Style.Content_box }) in
...
let () =
  let open Alcotest in
  run "Toffee grid_auto_columns Test" [
    "grid_grid_auto_columns", [
      test_case "grid_auto_columns (border-box)" `Quick test_grid_auto_columns_border_box;
      test_case "grid_auto_columns (content-box)" `Quick test_grid_auto_columns_content_box;
    ];
  ]
