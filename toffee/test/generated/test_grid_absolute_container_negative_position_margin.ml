...
let test_grid_absolute_container_negative_position_margin_border_box () =
         ...
         ~inset:
           {
             ...
             right = Style.Length_percentage_auto.length (-15.0);
  ...
  let node2 =
    new_leaf tree
      (Style.make ~position:Style.Position.Absolute
         ...
         ~inset:
           {
             left = Style.Length_percentage_auto.length (-35.0);
             right = Style.Length_percentage_auto.auto;
             top = Style.Length_percentage_auto.auto;
             bottom = Style.Length_percentage_auto.length (-25.0);
           }
         ~box_sizing:Style.Box_sizing.Border_box ())
    |> Result.get_ok
  in
  ...
  assert_eq ~msg:"x of node1" 193.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"y of node2" 182.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"x of node8" 120.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node8" 50.0 (Layout.location layout_result).y;
...
let tests =
  let open Alcotest in
  [
    test_case "absolute_container_negative_position_margin (border-box)" `Quick
      test_grid_absolute_container_negative_position_margin_border_box;
    test_case "absolute_container_negative_position_margin (content-box)" `Quick
