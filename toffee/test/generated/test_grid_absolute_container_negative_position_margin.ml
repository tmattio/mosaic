...
let test_grid_absolute_container_negative_position_margin_border_box () =
  ...
  assert_eq ~msg:"x of node0" 193.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node0" (-4.0) (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node1" 182.0 (Layout.location layout_result).y;
