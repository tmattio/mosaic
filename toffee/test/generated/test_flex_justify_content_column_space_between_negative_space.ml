...
let test_flex_justify_content_column_space_between_negative_space_border_box ()
    =
  (* Setup test helpers *)
...
let test_flex_justify_content_column_space_between_negative_space_content_box ()
    =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
...
let tests =
  let open Alcotest in
  [
    test_case "justify_content_column_space_between_negative_space (border-box)"
      `Quick
      test_flex_justify_content_column_space_between_negative_space_border_box;
    test_case
      "justify_content_column_space_between_negative_space (content-box)" `Quick
      test_flex_justify_content_column_space_between_negative_space_content_box;
  ]
