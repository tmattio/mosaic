  ...
  run "Toffee aspect_ratio_flex_row_stretch_fill_max_height Test"
    [
      ( "flex_aspect_ratio_flex_row_stretch_fill_max_height",
        [
          test_case "aspect_ratio_flex_row_stretch_fill_max_height (border-box)"
            `Quick test_aspect_ratio_flex_row_stretch_fill_max_height_border_box;
          test_case
            "aspect_ratio_flex_row_stretch_fill_max_height (content-box)" `Quick
            test_aspect_ratio_flex_row_stretch_fill_max_height_content_box;
        ] );
    ]
