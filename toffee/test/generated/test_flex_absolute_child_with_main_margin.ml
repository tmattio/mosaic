...
let test_absolute_child_with_main_margin_content_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with flex_direction = Toffee.Style.Flex.Row; size = { width = Toffee.Style.Dimension.length 20.0; height = Toffee.Style.Dimension.length 37.0 }; box_sizing = Toffee.Style.Content_box }) in
...
let () =
  ...
  run "Toffee absolute_child_with_main_margin Test" [
    "flex_absolute_child_with_main_margin", [
      test_case "absolute_child_with_main_margin (border-box)" `Quick test_absolute_child_with_main_margin_border_box;
      test_case "absolute_child_with_main_margin (content-box)" `Quick test_absolute_child_with_main_margin_content_box;
    ];
  ]
