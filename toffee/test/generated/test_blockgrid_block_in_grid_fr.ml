(* Generated test for blockgrid_block_in_grid_fr *)
...
let test_blockgrid_block_in_grid_fr_border_box measure_function () =
  (* Setup test helpers *)
...
let test_blockgrid_block_in_grid_fr_content_box measure_function () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "blockgrid_block_in_grid_fr (border-box)" `Quick (fun () ->
        test_blockgrid_block_in_grid_fr_border_box measure_function ());
    test_case "blockgrid_block_in_grid_fr (content-box)" `Quick (fun () ->
        test_blockgrid_block_in_grid_fr_content_box measure_function ());
  ]
