...
let test_grid_out_of_order_items_border_box () =
  ...
  assert_eq ~msg:"x of node0" 80.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"width of node2" 35.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node2" 35.0 (Layout.size layout_result).height;
