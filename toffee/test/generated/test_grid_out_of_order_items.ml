...
let test_grid_out_of_order_items_border_box () =
         ...
         ~size:
           {
             ...
             height = Style.Dimension.length 35.0;
           }
  ...
  let node0 =
    new_with_children tree
      (Style.make ~display:Style.Display.Grid
         ...
         ~grid_auto_flow:Style.Grid.Auto_flow.Row_dense
         ~size:
           {
  ...
  assert_eq ~msg:"width of node3" 35.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 35.0 (Layout.size layout_result).height;
...
let tests =
  let open Alcotest in
  [
    test_case "out_of_order_items (border-box)" `Quick
      test_grid_out_of_order_items_border_box;
    test_case "out_of_order_items (content-box)" `Quick
      test_grid_out_of_order_items_content_box;
  ]
