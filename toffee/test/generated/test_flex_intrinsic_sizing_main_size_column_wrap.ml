...
(* Generated test for intrinsic_sizing_main_size_column_wrap in flex layout *)
...
let test_intrinsic_sizing_main_size_column_wrap_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with flex_direction = Toffee.Style.Flex.Column; flex_wrap = Toffee.Style.Flex.Wrap }) in
...
let test_intrinsic_sizing_main_size_column_wrap_content_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with flex_direction = Toffee.Style.Flex.Column; flex_wrap = Toffee.Style.Flex.Wrap; box_sizing = Toffee.Style.Content_box }) in
...
let () =
  ...
  run "Toffee intrinsic_sizing_main_size_column_wrap Test" [
    "flex_intrinsic_sizing_main_size_column_wrap", [
      test_case "intrinsic_sizing_main_size_column_wrap (border-box)" `Quick test_intrinsic_sizing_main_size_column_wrap_border_box;
      test_case "intrinsic_sizing_main_size_column_wrap (content-box)" `Quick test_intrinsic_sizing_main_size_column_wrap_content_box;
    ];
  ]
