...
let test_intrinsic_sizing_main_size_column_wrap_border_box () =
  ...
  assert_eq ~msg:"height of node" 92.0 layout.size.height;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 18.0 layout.size.width;
  assert_eq ~msg:"height of node1" 46.0 layout.size.height;
  assert_eq ~msg:"x of node1" 0.0 layout.location.x;
  assert_eq ~msg:"y of node1" 46.0 layout.location.y;
  ()
