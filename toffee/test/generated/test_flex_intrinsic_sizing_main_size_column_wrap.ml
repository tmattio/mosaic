...
let test_flex_intrinsic_sizing_main_size_column_wrap_border_box () =
  (* Setup test helpers *)
...
let tests =
  [
    Windtrap.test "intrinsic_sizing_main_size_column_wrap (border-box)"
      test_flex_intrinsic_sizing_main_size_column_wrap_border_box;
    Windtrap.test "intrinsic_sizing_main_size_column_wrap (content-box)"
