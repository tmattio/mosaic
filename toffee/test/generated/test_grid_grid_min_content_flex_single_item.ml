...
let test_grid_min_content_flex_single_item_border_box () =
  (* Setup test helpers *)
  ...
  let node1 = Toffee.new_leaf tree ({ Toffee.Style.default with min_size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.auto } }) in
...
let test_grid_min_content_flex_single_item_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
  let node1 = Toffee.new_leaf tree ({ Toffee.Style.default with min_size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.auto }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node1 |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee grid_min_content_flex_single_item Test" [
    "grid_grid_min_content_flex_single_item", [
      test_case "grid_min_content_flex_single_item (border-box)" `Quick test_grid_min_content_flex_single_item_border_box;
      test_case "grid_min_content_flex_single_item (content-box)" `Quick test_grid_min_content_flex_single_item_content_box;
    ];
  ]
