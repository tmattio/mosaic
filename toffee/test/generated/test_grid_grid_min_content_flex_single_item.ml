...
let test_grid_min_content_flex_single_item_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 968.0 layout.size.width;
  ...
  run "Toffee grid_min_content_flex_single_item Test"
    [
      ( "grid_grid_min_content_flex_single_item",
        [
          test_case "grid_min_content_flex_single_item (border-box)" `Quick
            test_grid_min_content_flex_single_item_border_box;
          test_case "grid_min_content_flex_single_item (content-box)" `Quick
            test_grid_min_content_flex_single_item_content_box;
        ] );
    ]
