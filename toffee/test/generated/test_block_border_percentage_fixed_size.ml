...
let tests =
  let open Alcotest in
  [
    test_case "border_percentage_fixed_size (border-box)" `Quick
      test_block_border_percentage_fixed_size_border_box;
    test_case "border_percentage_fixed_size (content-box)" `Quick
      test_block_border_percentage_fixed_size_content_box;
  ]
