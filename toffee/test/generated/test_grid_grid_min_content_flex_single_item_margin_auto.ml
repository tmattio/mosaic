...
let test_grid_min_content_flex_single_item_margin_auto_border_box () =
  ...
  let node4 = Toffee.new_leaf tree ({ Toffee.Style.default with margin = { left = Toffee.Style.Length_percentage_auto.Auto; right = Toffee.Style.Length_percentage_auto.Auto; top = Toffee.Style.Length_percentage_auto.Auto; bottom = Toffee.Style.Length_percentage_auto.Auto } }) in
  let _ = Toffee.set_node_context tree node4 (MeasureFunction.Fixed {width = 50.0; height = 10.0}) |> Result.get_ok in
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node6" 10.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node7" 30.0 layout.size.width;
  assert_eq ~msg:"height of node7" 40.0 layout.size.height;
  assert_eq ~msg:"x of node7" 50.0 layout.location.x;
...
let test_grid_min_content_flex_single_item_margin_auto_content_box () =
  ...
  let _ = Toffee.add_child tree node node3 |> Result.get_ok in
  let node4 = Toffee.new_leaf tree ({ Toffee.Style.default with margin = { left = Toffee.Style.Length_percentage_auto.Auto; right = Toffee.Style.Length_percentage_auto.Auto; top = Toffee.Style.Length_percentage_auto.Auto; bottom = Toffee.Style.Length_percentage_auto.Auto }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.set_node_context tree node4 (MeasureFunction.Fixed {width = 50.0; height = 10.0}) |> Result.get_ok in
  let _ = Toffee.add_child tree node node4 |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee grid_min_content_flex_single_item_margin_auto Test" [
    "grid_grid_min_content_flex_single_item_margin_auto", [
      test_case "grid_min_content_flex_single_item_margin_auto (border-box)" `Quick test_grid_min_content_flex_single_item_margin_auto_border_box;
      test_case "grid_min_content_flex_single_item_margin_auto (content-box)" `Quick test_grid_min_content_flex_single_item_margin_auto_content_box;
    ];
  ]
