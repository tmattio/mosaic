...
let test_block_aspect_ratio_fill_min_width_border_box measure_function () =
  (* Setup test helpers *)
...
let test_block_aspect_ratio_fill_min_width_content_box measure_function () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "aspect_ratio_fill_min_width (border-box)" `Quick (fun () ->
        test_block_aspect_ratio_fill_min_width_border_box measure_function ());
    test_case "aspect_ratio_fill_min_width (content-box)" `Quick (fun () ->
        test_block_aspect_ratio_fill_min_width_content_box measure_function ());
  ]
