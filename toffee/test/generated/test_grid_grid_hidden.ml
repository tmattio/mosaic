...
let test_grid_hidden_border_box () =
  ...
  let node1 =
    Toffee.new_leaf tree
      { Toffee.Style.default with display = Toffee.Style.None }
  in
  ...
  assert_eq ~msg:"y of node4" (-8.0) layout.location.y;
  ...
  assert_eq ~msg:"x of node6" (-8.0) layout.location.x;
  assert_eq ~msg:"y of node6" (-8.0) layout.location.y;
...
let () =
  ...
  run "Toffee grid_hidden Test"
    [
      ( "grid_grid_hidden",
        [
          test_case "grid_hidden (border-box)" `Quick
            test_grid_hidden_border_box;
          test_case "grid_hidden (content-box)" `Quick
            test_grid_hidden_content_box;
        ] );
    ]
