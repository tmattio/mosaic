...
(* Generated test for grid_hidden in grid layout *)
...
let test_grid_hidden_border_box () =
  (* Setup test helpers *)
  ...
  let node4 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.None }) in
  ...
  let node6 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.None }) in
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node6" 0.0 layout.size.width;
...
let test_grid_hidden_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  let _ = Toffee.add_child tree node node3 |> Result.get_ok in
  let node4 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.None; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node4 |> Result.get_ok in
  let node5 = Toffee.new_leaf tree ({ Toffee.Style.default with box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node5 |> Result.get_ok in
  let node6 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.None; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node6 |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee grid_hidden Test" [
    "grid_grid_hidden", [
      test_case "grid_hidden (border-box)" `Quick test_grid_hidden_border_box;
      test_case "grid_hidden (content-box)" `Quick test_grid_hidden_content_box;
    ];
  ]
