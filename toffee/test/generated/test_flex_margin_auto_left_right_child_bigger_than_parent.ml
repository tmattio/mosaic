...
let test_flex_margin_auto_left_right_child_bigger_than_parent_border_box () =
  (* Setup test helpers *)
...
let test_flex_margin_auto_left_right_child_bigger_than_parent_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "margin_auto_left_right_child_bigger_than_parent (border-box)"
      `Quick
      test_flex_margin_auto_left_right_child_bigger_than_parent_border_box;
    test_case "margin_auto_left_right_child_bigger_than_parent (content-box)"
      `Quick
      test_flex_margin_auto_left_right_child_bigger_than_parent_content_box;
  ]
