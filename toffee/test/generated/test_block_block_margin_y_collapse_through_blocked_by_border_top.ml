...
(* Generated test for block_margin_y_collapse_through_blocked_by_border_top in block layout *)
...
let test_block_margin_y_collapse_through_blocked_by_border_top_border_box () =
  (* Setup test helpers *)
...
let test_block_margin_y_collapse_through_blocked_by_border_top_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee block_margin_y_collapse_through_blocked_by_border_top Test" [
    "block_block_margin_y_collapse_through_blocked_by_border_top", [
      test_case "block_margin_y_collapse_through_blocked_by_border_top (border-box)" `Quick test_block_margin_y_collapse_through_blocked_by_border_top_border_box;
      test_case "block_margin_y_collapse_through_blocked_by_border_top (content-box)" `Quick test_block_margin_y_collapse_through_blocked_by_border_top_content_box;
    ];
  ]
