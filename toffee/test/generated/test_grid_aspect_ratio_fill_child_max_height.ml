...
let test_grid_aspect_ratio_fill_child_max_height_border_box () =
  ...
  let _ =
    set_node_context tree node1
      (Some
         (Gentest_helpers.ahem_text "HH​HH​HH​HH​HH​HH"
...
let tests =
  let open Alcotest in
  [
    test_case "aspect_ratio_fill_child_max_height (border-box)" `Quick
      test_grid_aspect_ratio_fill_child_max_height_border_box;
    test_case "aspect_ratio_fill_child_max_height (content-box)" `Quick
      test_grid_aspect_ratio_fill_child_max_height_content_box;
  ]
