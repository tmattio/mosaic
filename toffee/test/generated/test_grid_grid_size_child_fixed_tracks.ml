...
let test_grid_size_child_fixed_tracks_border_box () =
  ...
  in
  let _ =
    Toffee.set_node_context tree node0 (MeasureFunction.Text "HH​HH​HH​HH")
    |> Result.get_ok
  in
  ...
  in
  let _ =
    Toffee.set_node_context tree node1 (MeasureFunction.Text "HHH​HHH")
    |> Result.get_ok
  in
  ...
  in
  let _ =
    Toffee.set_node_context tree node2 (MeasureFunction.Text "HH​HHHH")
    |> Result.get_ok
  in
  ...
  in
  let _ =
    Toffee.set_node_context tree node3 (MeasureFunction.Text "HH​HH​HH​HH")
    |> Result.get_ok
  in
  ...
  in
  let _ =
    Toffee.set_node_context tree node4 (MeasureFunction.Text "HH​HH​HH​HH")
    |> Result.get_ok
  in
