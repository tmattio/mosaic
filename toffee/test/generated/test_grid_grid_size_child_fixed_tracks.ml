...
let test_grid_size_child_fixed_tracks_border_box () =
  ...
  let _ =
    Toffee.set_node_context tree node1
      (MeasureFunction.Fixed { width = 70.0; height = 10.0 })
    |> Result.get_ok
  in
  ...
  assert_eq ~msg:"height of node1" 36.0 layout.size.height;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 46.0 layout.size.width;
  assert_eq ~msg:"height of node2" 36.0 layout.size.height;
  ...
  assert_eq ~msg:"height of node3" 72.0 layout.size.height;
  ...
  assert_eq ~msg:"height of node4" 72.0 layout.size.height;
  ...
  run "Toffee grid_size_child_fixed_tracks Test"
    [
      ( "grid_grid_size_child_fixed_tracks",
        [
          test_case "grid_size_child_fixed_tracks (border-box)" `Quick
            test_grid_size_child_fixed_tracks_border_box;
          test_case "grid_size_child_fixed_tracks (content-box)" `Quick
