...
let test_grid_justify_content_end_with_padding_border_border_box () =
  ...
  assert_eq ~msg:"x of node0" 56.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node1" 96.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node2" 136.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node3" 56.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node4" 96.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node5" 136.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node6" 56.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node7" 96.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node8" 136.0 (Layout.location layout_result).x;
...
let test_grid_justify_content_end_with_padding_border_content_box () =
  ...
  assert_eq ~msg:"width of node0" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node0" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node0" 128.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node0" 12.0 (Layout.location layout_result).y;
  let layout_result = layout tree node1 |> Result.get_ok in
  assert_eq ~msg:"width of node1" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node1" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node1" 168.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node1" 12.0 (Layout.location layout_result).y;
  let layout_result = layout tree node2 |> Result.get_ok in
  assert_eq ~msg:"width of node2" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node2" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 208.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node2" 12.0 (Layout.location layout_result).y;
  let layout_result = layout tree node3 |> Result.get_ok in
  assert_eq ~msg:"width of node3" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 40.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"width of node4" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node4" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node4" 168.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node4" 52.0 (Layout.location layout_result).y;
  let layout_result = layout tree node5 |> Result.get_ok in
  assert_eq ~msg:"width of node5" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node5" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node5" 208.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node5" 52.0 (Layout.location layout_result).y;
  let layout_result = layout tree node6 |> Result.get_ok in
  assert_eq ~msg:"width of node6" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node6" 40.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"width of node7" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node7" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node7" 168.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node7" 92.0 (Layout.location layout_result).y;
  let layout_result = layout tree node8 |> Result.get_ok in
  assert_eq ~msg:"width of node8" 40.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node8" 40.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node8" 208.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node8" 92.0 (Layout.location layout_result).y;
  ()
