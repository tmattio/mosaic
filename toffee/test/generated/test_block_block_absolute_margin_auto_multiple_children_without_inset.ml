...
(* Generated test for block_absolute_margin_auto_multiple_children_without_inset in block layout *)
...
let test_block_absolute_margin_auto_multiple_children_without_inset_border_box () =
  (* Setup test helpers *)
...
let test_block_absolute_margin_auto_multiple_children_without_inset_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee block_absolute_margin_auto_multiple_children_without_inset Test" [
    "block_block_absolute_margin_auto_multiple_children_without_inset", [
      test_case "block_absolute_margin_auto_multiple_children_without_inset (border-box)" `Quick test_block_absolute_margin_auto_multiple_children_without_inset_border_box;
      test_case "block_absolute_margin_auto_multiple_children_without_inset (content-box)" `Quick test_block_absolute_margin_auto_multiple_children_without_inset_content_box;
    ];
  ]
