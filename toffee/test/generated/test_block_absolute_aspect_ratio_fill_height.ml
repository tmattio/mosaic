...
let tests =
  [
    Windtrap.test "absolute_aspect_ratio_fill_height (border-box)"
      test_block_absolute_aspect_ratio_fill_height_border_box;
    Windtrap.test "absolute_aspect_ratio_fill_height (content-box)"
      test_block_absolute_aspect_ratio_fill_height_content_box;
  ]
