...
let test_grid_max_width_greater_than_max_content_border_box () =
  ...
  assert_eq ~msg:"height of node" 18.0 layout.size.height;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 185.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 93.0 layout.size.width;
  assert_eq ~msg:"height of node2" 18.0 layout.size.height;
  assert_eq ~msg:"x of node2" 92.0 layout.location.x;
  ...
  run "Toffee grid_max_width_greater_than_max_content Test"
    [
      ( "grid_grid_max_width_greater_than_max_content",
        [
          test_case "grid_max_width_greater_than_max_content (border-box)"
            `Quick test_grid_max_width_greater_than_max_content_border_box;
          test_case "grid_max_width_greater_than_max_content (content-box)"
            `Quick test_grid_max_width_greater_than_max_content_content_box;
        ] );
    ]
