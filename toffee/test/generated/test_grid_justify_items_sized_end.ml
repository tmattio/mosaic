...
let tests =
  let open Alcotest in
  [
    test_case "justify_items_sized_end (border-box)" `Quick
      test_grid_justify_items_sized_end_border_box;
    test_case "justify_items_sized_end (content-box)" `Quick
      test_grid_justify_items_sized_end_content_box;
  ]
