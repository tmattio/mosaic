...
(* Generated test for bevy_issue_9530_reduced2 in flex layout *)
...
let test_bevy_issue_9530_reduced2_border_box () =
  (* Setup test helpers *)
  ...
  let _ = Toffee.set_node_context tree node1 (MeasureFunction.Fixed {width = 230.0; height = 10.0}) |> Result.get_ok in
...
let test_bevy_issue_9530_reduced2_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee bevy_issue_9530_reduced2 Test" [
    "flex_bevy_issue_9530_reduced2", [
      test_case "bevy_issue_9530_reduced2 (border-box)" `Quick test_bevy_issue_9530_reduced2_border_box;
      test_case "bevy_issue_9530_reduced2 (content-box)" `Quick test_bevy_issue_9530_reduced2_content_box;
    ];
  ]
