...
(* Generated test for grid_absolute_container_negative_position in grid layout *)
...
let test_grid_absolute_container_negative_position_border_box () =
  ...
  assert_eq ~msg:"x of node0" 195.0 layout.location.x;
  ...
  assert_eq ~msg:"y of node1" 185.0 layout.location.y;
...
let () =
  let open Alcotest in
  run "Toffee grid_absolute_container_negative_position Test" [
    "grid_grid_absolute_container_negative_position", [
      test_case "grid_absolute_container_negative_position (border-box)" `Quick test_grid_absolute_container_negative_position_border_box;
      test_case "grid_absolute_container_negative_position (content-box)" `Quick test_grid_absolute_container_negative_position_content_box;
    ];
  ]
