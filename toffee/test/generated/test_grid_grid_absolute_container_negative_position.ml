...
let test_grid_absolute_container_negative_position_border_box () =
  ...
  assert_eq ~msg:"x of node0" 1031.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node1" (-43.0) layout.location.x;
  assert_eq ~msg:"y of node1" 785.0 layout.location.y;
  ...
  run "Toffee grid_absolute_container_negative_position Test"
    [
      ( "grid_grid_absolute_container_negative_position",
        [
          test_case "grid_absolute_container_negative_position (border-box)"
            `Quick test_grid_absolute_container_negative_position_border_box;
          test_case "grid_absolute_container_negative_position (content-box)"
            `Quick test_grid_absolute_container_negative_position_content_box;
        ] );
    ]
