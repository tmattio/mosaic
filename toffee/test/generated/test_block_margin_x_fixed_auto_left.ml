...
let tests =
  let open Alcotest in
  [
    test_case "margin_x_fixed_auto_left (border-box)" `Quick
      test_block_margin_x_fixed_auto_left_border_box;
    test_case "margin_x_fixed_auto_left (content-box)" `Quick
      test_block_margin_x_fixed_auto_left_content_box;
  ]
