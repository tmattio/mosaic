...
(* Generated test for align_content_space_between_single_line in flex layout *)
...
let test_align_content_space_between_single_line_border_box () =
  (* Setup test helpers *)
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with flex_direction = Toffee.Style.Flex.Row; align_content = Some (Toffee.Style.Alignment.Space_between); size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.length 100.0 } }) in
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 } }) in
  ...
  let node2 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 } }) in
  let _ = Toffee.add_child tree node node2 |> Result.get_ok in
  let node3 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 } }) in
  ...
  let node5 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 } }) in
...
let test_align_content_space_between_single_line_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with flex_direction = Toffee.Style.Flex.Row; align_content = Some (Toffee.Style.Alignment.Space_between); size = { width = Toffee.Style.Dimension.length 100.0; height = Toffee.Style.Dimension.length 100.0 }; box_sizing = Toffee.Style.Content_box }) in
  let node0 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
  ...
  let _ = Toffee.add_child tree node node1 |> Result.get_ok in
  let node2 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node2 |> Result.get_ok in
  let node3 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node3 |> Result.get_ok in
  ...
  let _ = Toffee.add_child tree node node4 |> Result.get_ok in
  let node5 = Toffee.new_leaf tree ({ Toffee.Style.default with size = { width = Toffee.Style.Dimension.length 10.0; height = Toffee.Style.Dimension.length 10.0 }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node5 |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee align_content_space_between_single_line Test" [
    "flex_align_content_space_between_single_line", [
      test_case "align_content_space_between_single_line (border-box)" `Quick test_align_content_space_between_single_line_border_box;
      test_case "align_content_space_between_single_line (content-box)" `Quick test_align_content_space_between_single_line_content_box;
    ];
  ]
