...
let test_flex_single_flex_child_after_absolute_child_border_box () =
  ...
  assert_eq ~msg:"width of node" 428.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node" 845.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"height of node1" 671.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"height of node2" 174.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 0.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node2" 671.0 (Layout.location layout_result).y;
  ()
