...
let test_grid_margins_auto_margins_border_box () =
  ...
  assert_eq ~msg:"x of node0" 40.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node2" 130.0 (Layout.location layout_result).x;
...
let tests =
  let open Alcotest in
  [
    test_case "margins_auto_margins (border-box)" `Quick
      test_grid_margins_auto_margins_border_box;
    test_case "margins_auto_margins (content-box)" `Quick
      test_grid_margins_auto_margins_content_box;
  ]
