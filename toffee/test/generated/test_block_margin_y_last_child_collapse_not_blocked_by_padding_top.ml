...
let tests =
  [
    Windtrap.test
      "margin_y_last_child_collapse_not_blocked_by_padding_top (border-box)"
      test_block_margin_y_last_child_collapse_not_blocked_by_padding_top_border_box;
    Windtrap.test
      "margin_y_last_child_collapse_not_blocked_by_padding_top (content-box)"
      test_block_margin_y_last_child_collapse_not_blocked_by_padding_top_content_box;
  ]
