...
let test_block_margin_y_sibling_collapse_positive_and_negative_border_box () =
  ...
  assert_eq ~msg:"height of node" 90.0 (Layout.size layout_result).height;
...
let tests =
  let open Alcotest in
  [
    test_case "margin_y_sibling_collapse_positive_and_negative (border-box)"
      `Quick
      test_block_margin_y_sibling_collapse_positive_and_negative_border_box;
    test_case "margin_y_sibling_collapse_positive_and_negative (content-box)"
      `Quick
