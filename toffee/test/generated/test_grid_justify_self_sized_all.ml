...
let test_grid_justify_self_sized_all_border_box () =
  ...
  let node3 =
    new_leaf tree
      (Style.make ~justify_self:Style.Align_items.End
         ~size:
           {
             width = Style.Dimension.length 20.0;
             height = Style.Dimension.length 20.0;
  ...
  let node5 =
    new_leaf tree
      (Style.make ~justify_self:Style.Align_items.Center
         ~size:
           {
             width = Style.Dimension.length 20.0;
             height = Style.Dimension.length 20.0;
  ...
  let node7 =
    new_leaf tree
      (Style.make ~justify_self:Style.Align_items.Stretch
         ~size:
           {
             width = Style.Dimension.length 20.0;
             height = Style.Dimension.length 20.0;
  ...
  assert_eq ~msg:"height of node2" 60.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"x of node6" 70.0 (Layout.location layout_result).x;
