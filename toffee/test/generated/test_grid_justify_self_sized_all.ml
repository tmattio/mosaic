...
let test_grid_justify_self_sized_all_border_box () =
  ...
  assert_eq ~msg:"x of node5" 70.0 (Layout.location layout_result).x;
...
let tests =
  let open Alcotest in
  [
    test_case "justify_self_sized_all (border-box)" `Quick
      test_grid_justify_self_sized_all_border_box;
    test_case "justify_self_sized_all (content-box)" `Quick
      test_grid_justify_self_sized_all_content_box;
  ]
