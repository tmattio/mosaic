...
let test_grid_span_2_min_content_fit_content_30px_indefinite_hidden_border_box
  ...
  assert_eq ~msg:"width of node" 70.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"scroll_width of node2" 0.0 (Layout.scroll_width layout_result);
...
let tests =
  ...
  [
    test_case
      "span_2_min_content_fit_content_30px_indefinite_hidden (border-box)"
      `Quick (fun () ->
        test_grid_span_2_min_content_fit_content_30px_indefinite_hidden_border_box
          measure_function ());
    test_case
      "span_2_min_content_fit_content_30px_indefinite_hidden (content-box)"
      `Quick (fun () ->
        test_grid_span_2_min_content_fit_content_30px_indefinite_hidden_content_box
          measure_function ());
  ]
