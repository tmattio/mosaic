...
(* Generated test for grid_fit_content_percent_indefinite_min_content in grid layout *)
...
let test_grid_fit_content_percent_indefinite_min_content_border_box () =
  (* Setup test helpers *)
...
let test_grid_fit_content_percent_indefinite_min_content_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_fit_content_percent_indefinite_min_content Test" [
    "grid_grid_fit_content_percent_indefinite_min_content", [
      test_case "grid_fit_content_percent_indefinite_min_content (border-box)" `Quick test_grid_fit_content_percent_indefinite_min_content_border_box;
      test_case "grid_fit_content_percent_indefinite_min_content (content-box)" `Quick test_grid_fit_content_percent_indefinite_min_content_content_box;
    ];
  ]
