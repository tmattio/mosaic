...
let test_flex_multiline_min_max_13_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"x of node2" 305.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node3" 405.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node4" 505.0 (Layout.location layout_result).x;
...
let test_flex_multiline_min_max_13_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "multiline_min_max_13 (border-box)" `Quick
      test_flex_multiline_min_max_13_border_box;
    test_case "multiline_min_max_13 (content-box)" `Quick
      test_flex_multiline_min_max_13_content_box;
  ]
