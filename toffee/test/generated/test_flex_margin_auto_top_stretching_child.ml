...
let test_flex_margin_auto_top_stretching_child_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"y of node1" 200.0 (Layout.location layout_result).y;
...
let test_flex_margin_auto_top_stretching_child_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "margin_auto_top_stretching_child (border-box)" `Quick
      test_flex_margin_auto_top_stretching_child_border_box;
    test_case "margin_auto_top_stretching_child (content-box)" `Quick
      test_flex_margin_auto_top_stretching_child_content_box;
  ]
