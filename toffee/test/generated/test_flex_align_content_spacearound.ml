...
let test_flex_align_content_spacearound_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"y of node5" 95.0 (Layout.location layout_result).y;
...
let test_flex_align_content_spacearound_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "align_content_spacearound (border-box)" `Quick
      test_flex_align_content_spacearound_border_box;
    test_case "align_content_spacearound (content-box)" `Quick
      test_flex_align_content_spacearound_content_box;
  ]
