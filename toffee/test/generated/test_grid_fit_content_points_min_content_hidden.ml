...
let tests =
  let open Alcotest in
  [
    test_case "fit_content_points_min_content_hidden (border-box)" `Quick
      test_grid_fit_content_points_min_content_hidden_border_box;
    test_case "fit_content_points_min_content_hidden (content-box)" `Quick
      test_grid_fit_content_points_min_content_hidden_content_box;
  ]
