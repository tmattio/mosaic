...
let tests =
  let open Alcotest in
  [
    test_case "margin_y_collapse_through_blocked_by_border_bottom (border-box)"
      `Quick
      test_block_margin_y_collapse_through_blocked_by_border_bottom_border_box;
    test_case "margin_y_collapse_through_blocked_by_border_bottom (content-box)"
      `Quick
      test_block_margin_y_collapse_through_blocked_by_border_bottom_content_box;
  ]
