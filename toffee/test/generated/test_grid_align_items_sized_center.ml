...
let tests =
  let open Alcotest in
  [
    test_case "align_items_sized_center (border-box)" `Quick
      test_grid_align_items_sized_center_border_box;
    test_case "align_items_sized_center (content-box)" `Quick
      test_grid_align_items_sized_center_content_box;
  ]
