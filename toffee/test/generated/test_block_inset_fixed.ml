...
let test_block_inset_fixed_border_box () =
  ...
  assert_eq ~msg:"x of node1" (-6.0) (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"y of node2" 24.0 (Layout.location layout_result).y;
  ()
...
let tests =
  let open Alcotest in
  [
    test_case "inset_fixed (border-box)" `Quick
      test_block_inset_fixed_border_box;
    test_case "inset_fixed (content-box)" `Quick
      test_block_inset_fixed_content_box;
  ]
