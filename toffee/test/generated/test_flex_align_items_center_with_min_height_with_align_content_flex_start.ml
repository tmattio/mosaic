...
let test_flex_align_items_center_with_min_height_with_align_content_flex_start_border_box
    () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"y of node0" 45.0 (Layout.location layout_result).y;
...
let test_flex_align_items_center_with_min_height_with_align_content_flex_start_content_box
    () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
  ...
  [
    test_case
      "align_items_center_with_min_height_with_align_content_flex_start \
       (border-box)"
      `Quick
      test_flex_align_items_center_with_min_height_with_align_content_flex_start_border_box;
    test_case
      "align_items_center_with_min_height_with_align_content_flex_start \
       (content-box)"
      `Quick
      test_flex_align_items_center_with_min_height_with_align_content_flex_start_content_box;
  ]
