...
let test_grid_auto_columns_fixed_width_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Auto }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Auto }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Auto }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Auto }]; size = { width = Toffee.Style.Dimension.length 200.0; height = Toffee.Style.Dimension.length 200.0 } }) in
...
let test_grid_auto_columns_fixed_width_content_box () =
  ...
  let _ = Toffee.add_child tree node node13 |> Result.get_ok in
  let node14 = Toffee.new_leaf tree ({ Toffee.Style.default with box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node14 |> Result.get_ok in
  let node15 = Toffee.new_leaf tree ({ Toffee.Style.default with box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node15 |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee grid_auto_columns_fixed_width Test" [
    "grid_grid_auto_columns_fixed_width", [
      test_case "grid_auto_columns_fixed_width (border-box)" `Quick test_grid_auto_columns_fixed_width_border_box;
      test_case "grid_auto_columns_fixed_width (content-box)" `Quick test_grid_auto_columns_fixed_width_content_box;
    ];
  ]
