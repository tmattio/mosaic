...
let test_grid_relayout_vertical_text_border_box () =
  ...
  let _ =
    Toffee.set_node_context tree node0
      (MeasureFunction.Fixed { width = 200.0; height = 10.0 })
    |> Result.get_ok
  in
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 126.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 126.0 layout.size.width;
  ...
  run "Toffee grid_relayout_vertical_text Test"
    [
      ( "grid_grid_relayout_vertical_text",
        [
          test_case "grid_relayout_vertical_text (border-box)" `Quick
            test_grid_relayout_vertical_text_border_box;
          test_case "grid_relayout_vertical_text (content-box)" `Quick
            test_grid_relayout_vertical_text_content_box;
        ] );
    ]
