...
let test_flex_gap_column_gap_justify_space_around_border_box () =
  (* Setup test helpers *)
  ...
  let node =
    new_leaf tree
      (Style.make ~display:Style.Display.Flex
         ~flex_direction:Style.Flex_direction.Row ~justify_content:Space_around
         ~size:
           {
  ...
  assert_eq ~msg:"x of node0" 3.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node2" 77.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node2" 0.0 (Layout.location layout_result).y;
  ()

let test_flex_gap_column_gap_justify_space_around_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "gap_column_gap_justify_space_around (border-box)" `Quick
      test_flex_gap_column_gap_justify_space_around_border_box;
    test_case "gap_column_gap_justify_space_around (content-box)" `Quick
      test_flex_gap_column_gap_justify_space_around_content_box;
  ]
