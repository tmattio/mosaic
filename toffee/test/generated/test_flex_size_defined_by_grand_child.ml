...
let test_flex_size_defined_by_grand_child_border_box () =
  (* Setup test helpers *)
  ...
  in
  let node1 =
    new_with_children tree Style.default [| node2 |] |> Result.get_ok
  in
  let node0 =
...
let test_flex_size_defined_by_grand_child_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "size_defined_by_grand_child (border-box)" `Quick
      test_flex_size_defined_by_grand_child_border_box;
    test_case "size_defined_by_grand_child (content-box)" `Quick
      test_flex_size_defined_by_grand_child_content_box;
  ]
