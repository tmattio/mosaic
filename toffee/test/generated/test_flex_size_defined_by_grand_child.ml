...
(* Generated test for size_defined_by_grand_child in flex layout *)
...
let test_size_defined_by_grand_child_border_box () =
  (* Setup test helpers *)
...
let test_size_defined_by_grand_child_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee size_defined_by_grand_child Test" [
    "flex_size_defined_by_grand_child", [
      test_case "size_defined_by_grand_child (border-box)" `Quick test_size_defined_by_grand_child_border_box;
      test_case "size_defined_by_grand_child (content-box)" `Quick test_size_defined_by_grand_child_content_box;
    ];
  ]
