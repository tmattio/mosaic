  ...
  run "Toffee grid_fit_content_percent_indefinite_argument Test"
    [
      ( "grid_grid_fit_content_percent_indefinite_argument",
        [
          test_case "grid_fit_content_percent_indefinite_argument (border-box)"
            `Quick test_grid_fit_content_percent_indefinite_argument_border_box;
          test_case "grid_fit_content_percent_indefinite_argument (content-box)"
            `Quick test_grid_fit_content_percent_indefinite_argument_content_box;
        ] );
    ]
