  ...
  run "Toffee margin_auto_bottom_and_top_justify_center Test"
    [
      ( "flex_margin_auto_bottom_and_top_justify_center",
        [
          test_case "margin_auto_bottom_and_top_justify_center (border-box)"
            `Quick test_margin_auto_bottom_and_top_justify_center_border_box;
          test_case "margin_auto_bottom_and_top_justify_center (content-box)"
            `Quick test_margin_auto_bottom_and_top_justify_center_content_box;
        ] );
    ]
