...
let test_flex_percentage_flex_basis_border_box () =
  ...
  assert_eq ~msg:"width of node0" 125.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node1" 75.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node1" 200.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node1" 125.0 (Layout.location layout_result).x;
