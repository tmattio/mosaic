...
let test_flex_percentage_flex_basis_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"width of node1" 125.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node2" 75.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node2" 200.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 125.0 (Layout.location layout_result).x;
...
let test_flex_percentage_flex_basis_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "percentage_flex_basis (border-box)" `Quick
      test_flex_percentage_flex_basis_border_box;
    test_case "percentage_flex_basis (content-box)" `Quick
      test_flex_percentage_flex_basis_content_box;
  ]
