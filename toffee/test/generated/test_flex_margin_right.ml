...
let test_flex_margin_right_border_box () =
  (* Setup test helpers *)
...
let test_flex_margin_right_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "margin_right (border-box)" `Quick
      test_flex_margin_right_border_box;
    test_case "margin_right (content-box)" `Quick
      test_flex_margin_right_content_box;
  ]
