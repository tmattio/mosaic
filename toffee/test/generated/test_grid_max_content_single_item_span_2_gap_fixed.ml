...
let test_grid_max_content_single_item_span_2_gap_fixed_border_box
  ...
  in
  let _ =
    set_node_context tree node2 (Some (MeasureFunction.Text "HH​HH​HH"))
    |> Result.get_ok
  in
  ...
  assert_eq ~msg:"x of node7" 60.0 (Layout.location layout_result).x;
  ...
  assert_eq ~msg:"x of node8" 100.0 (Layout.location layout_result).x;
