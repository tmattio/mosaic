...
let tests =
  let open Alcotest in
  [
    test_case "max_content_single_item_span_2_gap_fixed (border-box)" `Quick
      (fun () ->
        test_grid_max_content_single_item_span_2_gap_fixed_border_box
          measure_function ());
    test_case "max_content_single_item_span_2_gap_fixed (content-box)" `Quick
      (fun () ->
        test_grid_max_content_single_item_span_2_gap_fixed_content_box
          measure_function ());
  ]
