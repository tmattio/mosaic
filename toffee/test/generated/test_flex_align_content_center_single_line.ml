...
let test_flex_align_content_center_single_line_border_box () =
  (* Setup test helpers *)
  ...
  let node0 =
    new_with_children tree
      (Style.make ~flex_direction:Style.Flex_direction.Row ~align_content:Center
         ~size:
           {
  ...
  assert_eq ~msg:"x of node4" 60.0 (Layout.location layout_result).x;
...
let test_flex_align_content_center_single_line_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "align_content_center_single_line (border-box)" `Quick
      test_flex_align_content_center_single_line_border_box;
    test_case "align_content_center_single_line (content-box)" `Quick
      test_flex_align_content_center_single_line_content_box;
  ]
