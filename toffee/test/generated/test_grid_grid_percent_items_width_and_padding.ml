...
let () =
  ...
  run "Toffee grid_percent_items_width_and_padding Test" [
    "grid_grid_percent_items_width_and_padding", [
      test_case "grid_percent_items_width_and_padding (border-box)" `Quick test_grid_percent_items_width_and_padding_border_box;
      test_case "grid_percent_items_width_and_padding (content-box)" `Quick test_grid_percent_items_width_and_padding_content_box;
    ];
  ]
