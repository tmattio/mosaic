...
let test_flex_absolute_layout_align_items_center_border_box () =
  (* Setup test helpers *)
...
let test_flex_absolute_layout_align_items_center_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  ...
  [
    test_case "absolute_layout_align_items_center (border-box)" `Quick
      test_flex_absolute_layout_align_items_center_border_box;
    test_case "absolute_layout_align_items_center (content-box)" `Quick
      test_flex_absolute_layout_align_items_center_content_box;
  ]
