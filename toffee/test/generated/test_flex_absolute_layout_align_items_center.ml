  ...
  run "Toffee absolute_layout_align_items_center Test"
    [
      ( "flex_absolute_layout_align_items_center",
        [
          test_case "absolute_layout_align_items_center (border-box)" `Quick
            test_absolute_layout_align_items_center_border_box;
          test_case "absolute_layout_align_items_center (content-box)" `Quick
            test_absolute_layout_align_items_center_content_box;
        ] );
    ]
