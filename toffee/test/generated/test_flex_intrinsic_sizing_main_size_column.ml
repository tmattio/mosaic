...
let test_intrinsic_sizing_main_size_column_border_box () =
  ...
  assert_eq ~msg:"width of node" 18.0 layout.size.width;
  ...
  run "Toffee intrinsic_sizing_main_size_column Test"
    [
      ( "flex_intrinsic_sizing_main_size_column",
        [
          test_case "intrinsic_sizing_main_size_column (border-box)" `Quick
            test_intrinsic_sizing_main_size_column_border_box;
          test_case "intrinsic_sizing_main_size_column (content-box)" `Quick
            test_intrinsic_sizing_main_size_column_content_box;
        ] );
    ]
