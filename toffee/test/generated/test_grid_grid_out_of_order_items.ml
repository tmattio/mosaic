    ...
    Toffee.new_leaf tree
      {
        ...
        grid_auto_flow = Toffee.Style.Grid.Row_dense;
        size =
          {
        ...
        size =
          {
            ...
            height = Toffee.Style.Dimension.length 35.0;
          };
      }
  in
  ...
  run "Toffee grid_out_of_order_items Test"
    [
      ( "grid_grid_out_of_order_items",
        [
          test_case "grid_out_of_order_items (border-box)" `Quick
            test_grid_out_of_order_items_border_box;
          test_case "grid_out_of_order_items (content-box)" `Quick
