...
(* Generated test for grid_max_content_single_item_margin_auto in grid layout *)
...
let test_grid_max_content_single_item_margin_auto_border_box () =
  (* Setup test helpers *)
  ...
  let node1 = Toffee.new_leaf tree ({ Toffee.Style.default with margin = { left = Toffee.Style.Length_percentage_auto.Auto; right = Toffee.Style.Length_percentage_auto.Auto; top = Toffee.Style.Length_percentage_auto.Auto; bottom = Toffee.Style.Length_percentage_auto.Auto } }) in
...
let test_grid_max_content_single_item_margin_auto_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
  ...
  let _ = Toffee.add_child tree node node0 |> Result.get_ok in
  let node1 = Toffee.new_leaf tree ({ Toffee.Style.default with margin = { left = Toffee.Style.Length_percentage_auto.Auto; right = Toffee.Style.Length_percentage_auto.Auto; top = Toffee.Style.Length_percentage_auto.Auto; bottom = Toffee.Style.Length_percentage_auto.Auto }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.set_node_context tree node1 (MeasureFunction.Fixed {width = 50.0; height = 10.0}) |> Result.get_ok in
  let _ = Toffee.add_child tree node node1 |> Result.get_ok in
...
let () =
  let open Alcotest in
  run "Toffee grid_max_content_single_item_margin_auto Test" [
    "grid_grid_max_content_single_item_margin_auto", [
      test_case "grid_max_content_single_item_margin_auto (border-box)" `Quick test_grid_max_content_single_item_margin_auto_border_box;
      test_case "grid_max_content_single_item_margin_auto (content-box)" `Quick test_grid_max_content_single_item_margin_auto_content_box;
    ];
  ]
