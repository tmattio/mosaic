  ...
  run "Toffee grid_max_content_single_item_margin_auto Test"
    [
      ( "grid_grid_max_content_single_item_margin_auto",
        [
          test_case "grid_max_content_single_item_margin_auto (border-box)"
            `Quick test_grid_max_content_single_item_margin_auto_border_box;
          test_case "grid_max_content_single_item_margin_auto (content-box)"
            `Quick test_grid_max_content_single_item_margin_auto_content_box;
        ] );
    ]
