  ...
  run "Toffee aspect_ratio_flex_row_stretch_fill_max_width Test"
    [
      ( "flex_aspect_ratio_flex_row_stretch_fill_max_width",
        [
          test_case "aspect_ratio_flex_row_stretch_fill_max_width (border-box)"
            `Quick test_aspect_ratio_flex_row_stretch_fill_max_width_border_box;
          test_case "aspect_ratio_flex_row_stretch_fill_max_width (content-box)"
            `Quick test_aspect_ratio_flex_row_stretch_fill_max_width_content_box;
        ] );
    ]
