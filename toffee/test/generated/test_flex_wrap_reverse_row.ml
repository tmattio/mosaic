...
let test_flex_wrap_reverse_row_border_box () =
  ...
  assert_eq ~msg:"width of node1" 31.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node2" 32.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"x of node3" 63.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node3" 30.0 (Layout.location layout_result).y;
  let layout_result = layout tree node4 |> Result.get_ok in
  assert_eq ~msg:"width of node4" 34.0 (Layout.size layout_result).width;
...
let tests =
  [
    Windtrap.test "wrap_reverse_row (border-box)"
      test_flex_wrap_reverse_row_border_box;
    Windtrap.test "wrap_reverse_row (content-box)"
