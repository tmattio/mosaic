...
(* Generated test for grid_absolute_container_bottom_left in grid layout *)
...
let test_grid_absolute_container_bottom_left_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"y of node0" 160.0 layout.location.y;
...
let test_grid_absolute_container_bottom_left_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_absolute_container_bottom_left Test" [
    "grid_grid_absolute_container_bottom_left", [
      test_case "grid_absolute_container_bottom_left (border-box)" `Quick test_grid_absolute_container_bottom_left_border_box;
      test_case "grid_absolute_container_bottom_left (content-box)" `Quick test_grid_absolute_container_bottom_left_content_box;
    ];
  ]
