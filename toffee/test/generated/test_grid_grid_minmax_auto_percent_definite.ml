...
(* Generated test for grid_minmax_auto_percent_definite in grid layout *)
...
let test_grid_minmax_auto_percent_definite_border_box () =
  (* Setup test helpers *)
...
let test_grid_minmax_auto_percent_definite_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_minmax_auto_percent_definite Test" [
    "grid_grid_minmax_auto_percent_definite", [
      test_case "grid_minmax_auto_percent_definite (border-box)" `Quick test_grid_minmax_auto_percent_definite_border_box;
      test_case "grid_minmax_auto_percent_definite (content-box)" `Quick test_grid_minmax_auto_percent_definite_content_box;
    ];
  ]
