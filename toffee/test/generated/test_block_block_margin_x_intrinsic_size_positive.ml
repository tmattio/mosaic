...
let test_block_margin_x_intrinsic_size_positive_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 993.0 layout.size.width;
  ...
  run "Toffee block_margin_x_intrinsic_size_positive Test"
    [
      ( "block_block_margin_x_intrinsic_size_positive",
        [
          test_case "block_margin_x_intrinsic_size_positive (border-box)" `Quick
            test_block_margin_x_intrinsic_size_positive_border_box;
          test_case "block_margin_x_intrinsic_size_positive (content-box)"
            `Quick test_block_margin_x_intrinsic_size_positive_content_box;
        ] );
    ]
