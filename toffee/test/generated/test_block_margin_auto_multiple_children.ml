...
let tests =
  let open Alcotest in
  [
    test_case "margin_auto_multiple_children (border-box)" `Quick
      test_block_margin_auto_multiple_children_border_box;
    test_case "margin_auto_multiple_children (content-box)" `Quick
      test_block_margin_auto_multiple_children_content_box;
  ]
