...
(* Generated test for absolute_layout_within_border in flex layout *)
...
let test_absolute_layout_within_border_border_box () =
  (* Setup test helpers *)
...
let test_absolute_layout_within_border_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee absolute_layout_within_border Test" [
    "flex_absolute_layout_within_border", [
      test_case "absolute_layout_within_border (border-box)" `Quick test_absolute_layout_within_border_border_box;
      test_case "absolute_layout_within_border (content-box)" `Quick test_absolute_layout_within_border_content_box;
    ];
  ]
