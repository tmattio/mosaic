...
(* Generated test for percentage_margin_should_calculate_based_only_on_width in flex layout *)
...
let () =
  ...
  run "Toffee percentage_margin_should_calculate_based_only_on_width Test" [
    "flex_percentage_margin_should_calculate_based_only_on_width", [
      test_case "percentage_margin_should_calculate_based_only_on_width (border-box)" `Quick test_percentage_margin_should_calculate_based_only_on_width_border_box;
      test_case "percentage_margin_should_calculate_based_only_on_width (content-box)" `Quick test_percentage_margin_should_calculate_based_only_on_width_content_box;
    ];
  ]
