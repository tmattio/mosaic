...
let test_block_absolute_minmax_bottom_right_min_max_preferred_border_box () =
  ...
  assert_eq ~msg:"x of node0" 956.0 layout.location.x;
  assert_eq ~msg:"y of node0" 690.0 layout.location.y;
  ()
  ...
  run "Toffee block_absolute_minmax_bottom_right_min_max_preferred Test"
    [
      ( "block_block_absolute_minmax_bottom_right_min_max_preferred",
        [
          test_case
            "block_absolute_minmax_bottom_right_min_max_preferred (border-box)"
            `Quick
            test_block_absolute_minmax_bottom_right_min_max_preferred_border_box;
          test_case
            "block_absolute_minmax_bottom_right_min_max_preferred (content-box)"
            `Quick
            test_block_absolute_minmax_bottom_right_min_max_preferred_content_box;
        ] );
    ]
