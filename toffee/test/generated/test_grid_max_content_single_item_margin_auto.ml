...
let test_grid_max_content_single_item_margin_auto_border_box measure_function ()
    =
  (* Setup test helpers *)
...
let test_grid_max_content_single_item_margin_auto_content_box measure_function
    () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
...
let tests =
  let open Alcotest in
  [
    test_case "max_content_single_item_margin_auto (border-box)" `Quick
      (fun () ->
        test_grid_max_content_single_item_margin_auto_border_box
          measure_function ());
    test_case "max_content_single_item_margin_auto (content-box)" `Quick
      (fun () ->
        test_grid_max_content_single_item_margin_auto_content_box
          measure_function ());
  ]
