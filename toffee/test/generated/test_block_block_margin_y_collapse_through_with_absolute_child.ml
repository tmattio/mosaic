...
let test_block_margin_y_collapse_through_with_absolute_child_border_box () =
  ...
  let node2 = Toffee.new_leaf tree ({ Toffee.Style.default with position = Toffee.Style.Absolute }) in
  let _ = Toffee.set_node_context tree node2 (MeasureFunction.Fixed {width = 20.0; height = 10.0}) |> Result.get_ok in
  let _ = Toffee.add_child tree node1 node2 |> Result.get_ok in
  let node3 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block; size = { width = Toffee.Style.Dimension.auto; height = Toffee.Style.Dimension.length 10.0 }; margin = { left = Toffee.Style.Length_percentage_auto.Length (0.0); right = Toffee.Style.Length_percentage_auto.Length (0.0); top = Toffee.Style.Length_percentage_auto.Length (10.0); bottom = Toffee.Style.Length_percentage_auto.Length (0.0) } }) in
...
let test_block_margin_y_collapse_through_with_absolute_child_content_box () =
  ...
  let node1 = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Block; margin = { left = Toffee.Style.Length_percentage_auto.Length (0.0); right = Toffee.Style.Length_percentage_auto.Length (0.0); top = Toffee.Style.Length_percentage_auto.Length (10.0); bottom = Toffee.Style.Length_percentage_auto.Length (10.0) }; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.add_child tree node node1 |> Result.get_ok in
  let node2 = Toffee.new_leaf tree ({ Toffee.Style.default with position = Toffee.Style.Absolute; box_sizing = Toffee.Style.Content_box }) in
  let _ = Toffee.set_node_context tree node2 (MeasureFunction.Fixed {width = 20.0; height = 10.0}) |> Result.get_ok in
  let _ = Toffee.add_child tree node1 node2 |> Result.get_ok in
...
let () =
  ...
  run "Toffee block_margin_y_collapse_through_with_absolute_child Test" [
    "block_block_margin_y_collapse_through_with_absolute_child", [
      test_case "block_margin_y_collapse_through_with_absolute_child (border-box)" `Quick test_block_margin_y_collapse_through_with_absolute_child_border_box;
      test_case "block_margin_y_collapse_through_with_absolute_child (content-box)" `Quick test_block_margin_y_collapse_through_with_absolute_child_content_box;
    ];
  ]
