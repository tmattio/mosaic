...
(* Generated test for absolute_minmax_bottom_right_min_max_preferred in flex layout *)
...
let () =
  ...
  run "Toffee absolute_minmax_bottom_right_min_max_preferred Test" [
    "flex_absolute_minmax_bottom_right_min_max_preferred", [
      test_case "absolute_minmax_bottom_right_min_max_preferred (border-box)" `Quick test_absolute_minmax_bottom_right_min_max_preferred_border_box;
      test_case "absolute_minmax_bottom_right_min_max_preferred (content-box)" `Quick test_absolute_minmax_bottom_right_min_max_preferred_content_box;
    ];
  ]
