(* Generated test for block_absolute_margin_auto_left_with_inset *)
...
let tests =
  let open Alcotest in
  [
    test_case "block_absolute_margin_auto_left_with_inset (border-box)" `Quick
      test_block_absolute_margin_auto_left_with_inset_border_box;
    test_case "block_absolute_margin_auto_left_with_inset (content-box)" `Quick
