...
let test_block_absolute_margin_auto_left_with_inset_border_box () =
  ...
  assert_eq ~msg:"x of node1" 130.0 (Layout.location layout_result).x;
...
let tests =
  let open Alcotest in
  [
    test_case "absolute_margin_auto_left_with_inset (border-box)" `Quick
      test_block_absolute_margin_auto_left_with_inset_border_box;
    test_case "absolute_margin_auto_left_with_inset (content-box)" `Quick
      test_block_absolute_margin_auto_left_with_inset_content_box;
  ]
