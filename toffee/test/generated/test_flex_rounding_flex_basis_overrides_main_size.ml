         ...
         ~size:
           {
             ...
             height = Style.Dimension.length 113.0;
           }
         ~box_sizing:Style.Box_sizing.Border_box ())
      [| node1; node2; node3 |]
    |> Result.get_ok
...
let tests =
  [
    Windtrap.test "rounding_flex_basis_overrides_main_size (border-box)"
      test_flex_rounding_flex_basis_overrides_main_size_border_box;
    Windtrap.test "rounding_flex_basis_overrides_main_size (content-box)"
