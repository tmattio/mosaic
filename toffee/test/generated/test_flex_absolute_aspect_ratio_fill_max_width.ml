...
(* Generated test for absolute_aspect_ratio_fill_max_width in flex layout *)
...
let () =
  ...
  run "Toffee absolute_aspect_ratio_fill_max_width Test" [
    "flex_absolute_aspect_ratio_fill_max_width", [
      test_case "absolute_aspect_ratio_fill_max_width (border-box)" `Quick test_absolute_aspect_ratio_fill_max_width_border_box;
      test_case "absolute_aspect_ratio_fill_max_width (content-box)" `Quick test_absolute_aspect_ratio_fill_max_width_content_box;
    ];
  ]
