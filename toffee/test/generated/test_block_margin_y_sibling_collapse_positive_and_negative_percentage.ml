...
let test_block_margin_y_sibling_collapse_positive_and_negative_percentage_border_box
  ...
  assert_eq ~msg:"y of node2" 28.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node5" 53.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node6" 65.0 (Layout.location layout_result).y;
  ()
