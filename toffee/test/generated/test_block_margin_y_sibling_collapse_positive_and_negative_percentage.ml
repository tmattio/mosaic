...
let test_block_margin_y_sibling_collapse_positive_and_negative_percentage_border_box
  ...
  assert_eq ~msg:"y of node2" 15.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node3" 28.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node6" 53.0 (Layout.location layout_result).y;
  ...
  assert_eq ~msg:"y of node7" 65.0 (Layout.location layout_result).y;
