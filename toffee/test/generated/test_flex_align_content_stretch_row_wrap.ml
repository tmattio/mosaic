...
let test_flex_align_content_stretch_row_wrap_border_box () =
  (* Setup test helpers *)
...
let test_flex_align_content_stretch_row_wrap_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "align_content_stretch_row_wrap (border-box)" `Quick
      test_flex_align_content_stretch_row_wrap_border_box;
    test_case "align_content_stretch_row_wrap (content-box)" `Quick
      test_flex_align_content_stretch_row_wrap_content_box;
  ]
