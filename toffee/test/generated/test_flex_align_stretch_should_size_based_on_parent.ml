  ...
  run "Toffee align_stretch_should_size_based_on_parent Test"
    [
      ( "flex_align_stretch_should_size_based_on_parent",
        [
          test_case "align_stretch_should_size_based_on_parent (border-box)"
            `Quick test_align_stretch_should_size_based_on_parent_border_box;
          test_case "align_stretch_should_size_based_on_parent (content-box)"
            `Quick test_align_stretch_should_size_based_on_parent_content_box;
        ] );
    ]
