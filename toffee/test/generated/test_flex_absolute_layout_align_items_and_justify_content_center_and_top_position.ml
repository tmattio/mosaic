...
let test_flex_absolute_layout_align_items_and_justify_content_center_and_top_position_border_box
    () =
  (* Setup test helpers *)
...
let test_flex_absolute_layout_align_items_and_justify_content_center_and_top_position_content_box
    () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
  ...
  [
    test_case
      "absolute_layout_align_items_and_justify_content_center_and_top_position \
       (border-box)"
      `Quick
      test_flex_absolute_layout_align_items_and_justify_content_center_and_top_position_border_box;
    test_case
      "absolute_layout_align_items_and_justify_content_center_and_top_position \
       (content-box)"
      `Quick
      test_flex_absolute_layout_align_items_and_justify_content_center_and_top_position_content_box;
  ]
