...
let test_grid_align_content_space_between_negative_space_gap_border_box () =
  ...
  let node9 =
    new_leaf tree (Style.make ~display:Style.Display.Flex ()) |> Result.get_ok
  in
  let _ = add_child tree node0 node9 |> Result.get_ok in
  ...
  assert_eq ~msg:"y of node7" 100.0 (Layout.location layout_result).y;
...
let test_grid_align_content_space_between_negative_space_gap_content_box () =
  ...
  (* Verify layout *)
  let layout_result = layout tree node |> Result.get_ok in
  assert_eq ~msg:"width of node" 360.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node" 360.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node" 0.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node0 |> Result.get_ok in
  assert_eq ~msg:"width of node0" 120.0 (Layout.size layout_result).width;
