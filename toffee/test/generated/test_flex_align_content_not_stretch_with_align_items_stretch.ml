...
let test_flex_align_content_not_stretch_with_align_items_stretch_border_box () =
  ...
  assert_eq ~msg:"width of node" 328.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"height of node0" 44.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"width of node2" 56.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node2" 44.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node2" 272.0 (Layout.location layout_result).x;
