...
let test_flex_align_content_not_stretch_with_align_items_stretch_border_box () =
  ...
  assert_eq ~msg:"width of node2" 272.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node2" 44.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"width of node1" 272.0 (Layout.size layout_result).width;
  ...
  assert_eq ~msg:"width of node4" 56.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node4" 44.0 (Layout.size layout_result).height;
  ...
  assert_eq ~msg:"width of node3" 56.0 (Layout.size layout_result).width;
  assert_eq ~msg:"height of node3" 44.0 (Layout.size layout_result).height;
  assert_eq ~msg:"x of node3" 272.0 (Layout.location layout_result).x;
  assert_eq ~msg:"y of node3" 0.0 (Layout.location layout_result).y;
  let layout_result = layout tree node0 |> Result.get_ok in
  assert_eq ~msg:"width of node0" 328.0 (Layout.size layout_result).width;
