...
let test_grid_span_2_min_content_auto_indefinite_border_box measure_function ()
    =
  (* Setup test helpers *)
...
let test_grid_span_2_min_content_auto_indefinite_content_box measure_function ()
    =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
...
let tests =
  let open Alcotest in
  [
    test_case "span_2_min_content_auto_indefinite (border-box)" `Quick
      (fun () ->
        test_grid_span_2_min_content_auto_indefinite_border_box measure_function
          ());
    test_case "span_2_min_content_auto_indefinite (content-box)" `Quick
      (fun () ->
        test_grid_span_2_min_content_auto_indefinite_content_box
          measure_function ());
  ]
