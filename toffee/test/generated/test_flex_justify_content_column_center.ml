...
let test_flex_justify_content_column_center_border_box () =
  (* Setup test helpers *)
...
let test_flex_justify_content_column_center_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "justify_content_column_center (border-box)" `Quick
      test_flex_justify_content_column_center_border_box;
    test_case "justify_content_column_center (content-box)" `Quick
      test_flex_justify_content_column_center_content_box;
  ]
