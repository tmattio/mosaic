...
let test_block_margin_x_percentage_fixed_size_positive_border_box () =
  ...
  assert_eq ~msg:"width of node0" 35.0 (Layout.size layout_result).width;
...
let tests =
  let open Alcotest in
  [
    test_case "margin_x_percentage_fixed_size_positive (border-box)" `Quick
      test_block_margin_x_percentage_fixed_size_positive_border_box;
    test_case "margin_x_percentage_fixed_size_positive (content-box)" `Quick
      test_block_margin_x_percentage_fixed_size_positive_content_box;
  ]
