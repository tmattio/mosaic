...
let test_grid_span_6_all_non_flex_indefinite_hidden_border_box () =
  ...
  let _ =
    Toffee.set_node_context tree node0
      (MeasureFunction.Fixed { width = 170.0; height = 10.0 })
    |> Result.get_ok
  in
  ...
  run "Toffee grid_span_6_all_non_flex_indefinite_hidden Test"
    [
      ( "grid_grid_span_6_all_non_flex_indefinite_hidden",
        [
          test_case "grid_span_6_all_non_flex_indefinite_hidden (border-box)"
            `Quick test_grid_span_6_all_non_flex_indefinite_hidden_border_box;
          test_case "grid_span_6_all_non_flex_indefinite_hidden (content-box)"
            `Quick test_grid_span_6_all_non_flex_indefinite_hidden_content_box;
        ] );
    ]
