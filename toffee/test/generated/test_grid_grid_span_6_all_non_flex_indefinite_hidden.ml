...
let test_grid_span_6_all_non_flex_indefinite_hidden_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Min_content; max = Toffee.Style.Grid.Min_content }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Max_content; max = Toffee.Style.Grid.Max_content }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Auto }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Auto; max = Toffee.Style.Grid.Auto }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (10.0); max = Toffee.Style.Grid.Length (10.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.2); max = Toffee.Style.Grid.Percent (0.2) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }] }) in
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node1" 19.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 99.0 layout.size.width;
  assert_eq ~msg:"height of node2" 40.0 layout.size.height;
  assert_eq ~msg:"x of node2" 19.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node3" 118.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node4" 118.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node5" 118.0 layout.location.x;
...
let () =
  let open Alcotest in
  run "Toffee grid_span_6_all_non_flex_indefinite_hidden Test" [
    "grid_grid_span_6_all_non_flex_indefinite_hidden", [
      test_case "grid_span_6_all_non_flex_indefinite_hidden (border-box)" `Quick test_grid_span_6_all_non_flex_indefinite_hidden_border_box;
      test_case "grid_span_6_all_non_flex_indefinite_hidden (content-box)" `Quick test_grid_span_6_all_non_flex_indefinite_hidden_content_box;
    ];
  ]
