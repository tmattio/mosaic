...
let test_grid_overflow_rows_border_box () =
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node0" 370.0 layout.size.width;
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 158.0 layout.size.width;
  ...
  assert_eq ~msg:"x of node3" 158.0 layout.location.x;
  assert_eq ~msg:"y of node3" 40.0 layout.location.y;
  let layout = Toffee.layout tree node4 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 202.0 layout.size.width;
