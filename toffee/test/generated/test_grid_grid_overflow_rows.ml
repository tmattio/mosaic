...
let test_grid_overflow_rows_border_box () =
  ...
  (* Create nodes *)
  let node = Toffee.new_leaf tree ({ Toffee.Style.default with display = Toffee.Style.Grid; grid_template_columns = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Min_content; max = Toffee.Style.Grid.Min_content }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Max_content; max = Toffee.Style.Grid.Max_content }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (10.0); max = Toffee.Style.Grid.Length (10.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Percent (0.2); max = Toffee.Style.Grid.Percent (0.2) }]; grid_template_rows = [Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }; Toffee.Style.Grid.Single { min = Toffee.Style.Grid.Length (40.0); max = Toffee.Style.Grid.Length (40.0) }] }) in
...
let () =
  ...
  run "Toffee grid_overflow_rows Test" [
    "grid_grid_overflow_rows", [
      test_case "grid_overflow_rows (border-box)" `Quick test_grid_overflow_rows_border_box;
      test_case "grid_overflow_rows (content-box)" `Quick test_grid_overflow_rows_content_box;
    ];
  ]
