...
let tests =
  [
    Windtrap.test "display_none_with_position_absolute (border-box)"
      test_block_display_none_with_position_absolute_border_box;
    Windtrap.test "display_none_with_position_absolute (content-box)"
      test_block_display_none_with_position_absolute_content_box;
  ]
