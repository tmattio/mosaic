...
let test_grid_span_13_most_non_flex_with_minmax_indefinite_hidden_border_box ()
  ...
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node2" 75.0 layout.size.width;
  ...
  assert_eq ~msg:"x of node3" 75.0 layout.location.x;
  assert_eq ~msg:"y of node3" 40.0 layout.location.y;
  let layout = Toffee.layout tree node4 in
  let layout = layout |> Result.get_ok in
  assert_eq ~msg:"width of node4" 159.0 layout.size.width;
  assert_eq ~msg:"height of node4" 40.0 layout.size.height;
  assert_eq ~msg:"x of node4" 75.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node8" 607.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node9" 611.0 layout.location.x;
  ...
  assert_eq ~msg:"x of node10" 613.0 layout.location.x;
  ...
  run "Toffee grid_span_13_most_non_flex_with_minmax_indefinite_hidden Test"
    [
      ( "grid_grid_span_13_most_non_flex_with_minmax_indefinite_hidden",
        [
          test_case
            "grid_span_13_most_non_flex_with_minmax_indefinite_hidden \
             (border-box)"
            `Quick
