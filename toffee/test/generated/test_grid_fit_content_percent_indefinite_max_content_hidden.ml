           ...
           [
             Style.Grid.Template_component.single
               (Style.Grid.Track_sizing_function.fit_content
                  (Style.Length_percentage.percent 0.5));
           ]
         ~grid_template_rows:
           [
             Style.Grid.Template_component.single
...
let tests =
  let open Alcotest in
  [
    test_case "fit_content_percent_indefinite_max_content_hidden (border-box)"
      `Quick (fun () ->
        test_grid_fit_content_percent_indefinite_max_content_hidden_border_box
          measure_function ());
    test_case "fit_content_percent_indefinite_max_content_hidden (content-box)"
      `Quick (fun () ->
        test_grid_fit_content_percent_indefinite_max_content_hidden_content_box
          measure_function ());
  ]
