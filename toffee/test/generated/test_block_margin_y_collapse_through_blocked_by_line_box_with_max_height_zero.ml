...
let tests =
  [
    Windtrap.test
      "margin_y_collapse_through_blocked_by_line_box_with_max_height_zero \
       (border-box)"
      test_block_margin_y_collapse_through_blocked_by_line_box_with_max_height_zero_border_box;
    Windtrap.test
      "margin_y_collapse_through_blocked_by_line_box_with_max_height_zero \
       (content-box)"
      test_block_margin_y_collapse_through_blocked_by_line_box_with_max_height_zero_content_box;
  ]
