...
let test_block_absolute_margin_auto_left_right_child_bigger_than_parent_with_inset_border_box
  ...
  assert_eq ~msg:"x of node0" 463.0 layout.location.x;
...
let () =
  ...
  run
    "Toffee \
     block_absolute_margin_auto_left_right_child_bigger_than_parent_with_inset \
     Test"
    [
        ...
        [
          test_case
            "block_absolute_margin_auto_left_right_child_bigger_than_parent_with_inset \
             (border-box)"
            `Quick
            test_block_absolute_margin_auto_left_right_child_bigger_than_parent_with_inset_border_box;
          test_case
            "block_absolute_margin_auto_left_right_child_bigger_than_parent_with_inset \
             (content-box)"
            `Quick
            test_block_absolute_margin_auto_left_right_child_bigger_than_parent_with_inset_content_box;
        ] );
    ]
