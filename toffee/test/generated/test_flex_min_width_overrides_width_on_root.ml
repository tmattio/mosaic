...
let test_flex_min_width_overrides_width_on_root_border_box () =
  (* Setup test helpers *)
...
let tests =
  ...
  [
    test_case "min_width_overrides_width_on_root (border-box)" `Quick
      test_flex_min_width_overrides_width_on_root_border_box;
    test_case "min_width_overrides_width_on_root (content-box)" `Quick
      test_flex_min_width_overrides_width_on_root_content_box;
  ]
