...
(* Generated test for grid_minmax_column_with_auto_fixed in grid layout *)
...
let test_grid_minmax_column_with_auto_fixed_border_box () =
  (* Setup test helpers *)
...
let test_grid_minmax_column_with_auto_fixed_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let () =
  let open Alcotest in
  run "Toffee grid_minmax_column_with_auto_fixed Test" [
    "grid_grid_minmax_column_with_auto_fixed", [
      test_case "grid_minmax_column_with_auto_fixed (border-box)" `Quick test_grid_minmax_column_with_auto_fixed_border_box;
      test_case "grid_minmax_column_with_auto_fixed (content-box)" `Quick test_grid_minmax_column_with_auto_fixed_content_box;
    ];
  ]
