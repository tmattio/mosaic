...
(* Generated test for grid_auto_fill_fixed_size in grid layout *)
...
let () =
  let open Alcotest in
  run "Toffee grid_auto_fill_fixed_size Test" [
    "grid_grid_auto_fill_fixed_size", [
      test_case "grid_auto_fill_fixed_size (border-box)" `Quick test_grid_auto_fill_fixed_size_border_box;
      test_case "grid_auto_fill_fixed_size (content-box)" `Quick test_grid_auto_fill_fixed_size_content_box;
    ];
  ]
