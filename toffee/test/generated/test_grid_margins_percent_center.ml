(* Generated test for grid_margins_percent_center in grid layout *)
(* Do not edit this file directly. It is generated by gentest.js *)

open Toffee

let test_grid_margins_percent_center_border_box () =
  (* Setup test helpers *)
  ...
  assert_eq ~msg:"y of node1" 9.0 (Layout.location layout_result).y;
...
let test_grid_margins_percent_center_content_box () =
  (* Setup test helpers *)
  let assert_eq ~msg expected actual =
    let open Alcotest in
    check (float 0.001) msg expected actual
...
let tests =
  let open Alcotest in
  [
    test_case "margins_percent_center (border-box)" `Quick
      test_grid_margins_percent_center_border_box;
    test_case "margins_percent_center (content-box)" `Quick
      test_grid_margins_percent_center_content_box;
  ]
