              ...
              box ~flex_direction:Row ~gap:(gap 1)
                [
                  box ~border:true ~padding:(padding 1)
                    ...
                    [
                      text
                        ~text_style:(Ansi.Style.make ~bold:true ~fg:Ansi.Color.green ())
                        "Start";
                    ];
                  box ~border:true ~padding:(padding 1)
                    ~on_mouse:(fun ev ->
                    ...
                    [
                      text
                        ~text_style:(Ansi.Style.make ~bold:true ~fg:Ansi.Color.red ())
                        "Stop";
                    ];
                  box ~border:true ~padding:(padding 1)
                    ~on_mouse:(fun ev ->
                    ...
                    [
                      text
                        ~text_style:(Ansi.Style.make ~bold:true ~fg:Ansi.Color.yellow ())
                        "Reset";
                    ];
                ];
              ];
